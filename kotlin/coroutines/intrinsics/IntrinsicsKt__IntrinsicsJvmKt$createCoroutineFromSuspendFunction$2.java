...
public final class IntrinsicsKt__IntrinsicsJvmKt$createCoroutineFromSuspendFunction$2 extends ContinuationImpl {
    final /* synthetic */ rul<kotlin.coroutines.a<? super T>, Object> $block;
    private int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public IntrinsicsKt__IntrinsicsJvmKt$createCoroutineFromSuspendFunction$2(kotlin.coroutines.a<? super T> aVar, kotlin.coroutines.c cVar, rul<? super kotlin.coroutines.a<? super T>, ? extends Object> rulVar) {
        super(aVar, cVar);
        this.$block = rulVar;
    ...
    protected Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            this.label = 1;
            i.a(obj);
            return this.$block.mo2421invoke(this);
        } else if (i != 1) {
