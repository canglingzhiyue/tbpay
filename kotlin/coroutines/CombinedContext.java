...
public final class CombinedContext implements Serializable, c {
    ...
    private final boolean containsAll(CombinedContext combinedContext) {
        while (contains(combinedContext.element)) {
            ...
            if (!(cVar instanceof CombinedContext)) {
                q.e(cVar, "null cannot be cast to non-null type kotlin.coroutines.CoroutineContext.Element");
    ...
    private final Object writeReplace() {
        ...
        fold(t.INSTANCE, new CombinedContext$writeReplace$1(cVarArr, intRef));
    ...
    public <R> R fold(R r, ruw<? super R, ? super c.b, ? extends R> operation) {
        ...
        return operation.mo2423invoke((Object) this.left.fold(r, operation), this.element);
    }
