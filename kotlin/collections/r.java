...
public class r extends q {
    ...
    public static final rwb a(Collection<?> collection) {
        kotlin.jvm.internal.q.d(collection, "<this>");
        return new rwb(0, collection.size() - 1);
    }
    ...
    public static final <T> List<T> b(List<? extends T> list) {
        kotlin.jvm.internal.q.d(list, "<this>");
        int size = list.size();
        return size != 0 ? size != 1 ? list : p.a(list.get(0)) : p.a();
    }

    public static final <T> List<T> b(T... elements) {
        kotlin.jvm.internal.q.d(elements, "elements");
        return elements.length > 0 ? g.a(elements) : p.a();
    }
