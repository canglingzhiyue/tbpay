...
public class ap {
    ...
    public static final <T> Set<T> a(T t) {
        ...
        kotlin.jvm.internal.q.b(singleton, "singleton(...)");
        return singleton;
    }

    public static final <E> Set<E> b(Set<E> builder) {
