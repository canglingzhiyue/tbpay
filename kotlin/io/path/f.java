...
public final class f {
    ...
    private static final LinkOption[] f24932a = {LinkOption.NOFOLLOW_LINKS};
    private static final LinkOption[] b = new LinkOption[0];
    private static final Set<FileVisitOption> c = ao.a();
    private static final Set<FileVisitOption> d = ao.a(FileVisitOption.FOLLOW_LINKS);
