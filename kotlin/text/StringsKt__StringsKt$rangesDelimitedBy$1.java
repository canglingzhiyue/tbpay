...
public final class StringsKt__StringsKt$rangesDelimitedBy$1 extends Lambda implements ruw<CharSequence, Integer, Pair<? extends Integer, ? extends Integer>> {
    ...
    public final Pair<Integer, Integer> invoke(CharSequence $receiver, int i) {
        ...
        int a2 = n.a($receiver, this.$delimiters, i, this.$ignoreCase);
        if (a2 < 0) {
            return null;
        }
        return kotlin.j.a(Integer.valueOf(a2), 1);
    }
}
