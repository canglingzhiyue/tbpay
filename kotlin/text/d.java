...
public final class d {
    ...
    static {
        ...
        kotlin.jvm.internal.q.b(forName, "forName(...)");
        UTF_8 = forName;
        Charset forName2 = Charset.forName("UTF-16");
        kotlin.jvm.internal.q.b(forName2, "forName(...)");
        UTF_16 = forName2;
        Charset forName3 = Charset.forName("UTF-16BE");
        kotlin.jvm.internal.q.b(forName3, "forName(...)");
        UTF_16BE = forName3;
        Charset forName4 = Charset.forName("UTF-16LE");
        kotlin.jvm.internal.q.b(forName4, "forName(...)");
        UTF_16LE = forName4;
        Charset forName5 = Charset.forName(EncodingUtils.US_ASCII);
        kotlin.jvm.internal.q.b(forName5, "forName(...)");
        US_ASCII = forName5;
        Charset forName6 = Charset.forName(android.taobao.util.b.ISO88591);
        kotlin.jvm.internal.q.b(forName6, "forName(...)");
        ISO_8859_1 = forName6;
    }
