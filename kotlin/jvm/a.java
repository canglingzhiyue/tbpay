...
public final class a {
    public static final <T> Class<T> a(T t) {
        ...
        q.e(cls, "null cannot be cast to non-null type java.lang.Class<T of kotlin.jvm.JvmClassMappingKt.<get-javaClass>>");
        return cls;
    }
    ...
    public static final <T> Class<T> a(c<T> cVar) {
        ...
        q.e(cls, "null cannot be cast to non-null type java.lang.Class<T of kotlin.jvm.JvmClassMappingKt.<get-java>>");
        return cls;
    }
    ...
    public static final <T> Class<T> b(c<T> cVar) {
        ...
        Class<T> cls = (Class<T>) ((l) cVar).a();
        if (!cls.isPrimitive()) {
            q.e(cls, "null cannot be cast to non-null type java.lang.Class<T of kotlin.jvm.JvmClassMappingKt.<get-javaObjectType>>");
            return cls;
        }
        ...
        if (name != null) {
            switch (name.hashCode()) {
                ...
                case 3327612:
                    ...
                    break;
                case 3625364:
                    if (name.equals(com.taobao.android.weex_framework.util.a.ATOM_void)) {
                        cls = (Class<T>) Void.class;
                        break;
                    }
                    break;
                case 64711720:
                    if (name.equals(com.taobao.android.weex_framework.util.a.ATOM_boolean)) {
                        cls = (Class<T>) Boolean.class;
                        break;
                    }
                    break;
                case 97526364:
                    if (name.equals(PopStrategy.IDENTIFIER_FLOAT)) {
