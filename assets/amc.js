...
//半屏返回按钮
amc.res.arrowLeft = flybird.local && flybird.local.agednessVersion ? amc.path + 'alipay_msp_arrow_left_black' : amc.path + 'alipay_msp_arrow_left';
amc.res.close = flybird.local && flybird.local.agednessVersion ? amc.path + 'alipay_msp_close_black' : amc.path + 'alipay_msp_close';
amc.res.arrowRight = flybird.local && flybird.local.agednessVersion ? amc.path + 'alipay_msp_arrow_right_black' :  amc.path + 'alipay_msp_arrow_right';
// 菊花
...
amc.fn.updateBodyHeight = function() {
    amc.specs.bodyHeight = window.innerHeight - amc.specs.navHeight;
...
amc.fn.iOSNav = function(lImg, lTxt, mTxt, rTxt, rImg, onLeft, onRight, option) {
    ...
    if (lImg) {
        ...
        //voice over
        if (lImg === amc.res.navBack || lImg === amc.fn.revertImgPath(amc.res.navBack)) {
            _lBox.alt = '{{return}}';
            _lBox.accessibilityTraits = 'Button';
            if (amc.fn.getTplId() === 'QUICKPAY@cashier-setting-payments-flex') {
...
amc.fn.androidNav = function(lImg, lTxt, mTxt, rTxt, rImg, onLeft, onRight) {
    ...
    if (lImg) {
        ...
        if (lImg === amc.res.navBack || lImg === amc.fn.revertImgPath(amc.res.navBack)) {
            _lImg.alt = '{{return}}';
            _lImg.accessibilityTraits = 'Button';
        } else if (lImg === amc.res.navClose || lImg === amc.fn.revertImgPath(amc.res.navClose)) {
            _lImg.alt = '{{exit}}';
            _lImg.accessibilityTraits = 'Button';
        }
    }
