...
public class BottomNavigationMenuView extends ViewGroup implements k {
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attributeSet) {
        ...
        this.mOnClickListener = new View.OnClickListener() { // from class: android.support.design.internal.BottomNavigationMenuView.1
            ...
            public void onClick(View view) {
                ...
                if (!BottomNavigationMenuView.this.mMenu.a(itemData, BottomNavigationMenuView.this.mPresenter, 0)) {
    ...
    public void buildMenuView() {
        ...
        for (int i = 0; i < this.mMenu.size(); i++) {
            ...
            newItem.initialize((g) this.mMenu.getItem(i), 0);
    ...
    public void updateMenuView() {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            this.mPresenter.a(true);
            this.mButtons[i3].initialize((g) this.mMenu.getItem(i3), 0);
            this.mPresenter.a(false);
        }
    }
}
