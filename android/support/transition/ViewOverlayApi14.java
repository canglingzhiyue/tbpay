...
public class ViewOverlayApi14 implements as {

    /* renamed from: a  reason: collision with root package name */
    protected OverlayViewGroup f1265a;
    ...
    public ViewOverlayApi14(Context context, ViewGroup viewGroup, View view) {
        this.f1265a = new OverlayViewGroup(context, viewGroup, view, this);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static ViewOverlayApi14 d(View view) {
        ViewGroup c = c(view);
        if (c != null) {
    ...
    public void a(Drawable drawable) {
        this.f1265a.add(drawable);
    }

    @Override // android.support.transition.as
    public void b(Drawable drawable) {
        this.f1265a.remove(drawable);
    }
}
