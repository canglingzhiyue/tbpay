...
import android.support.v4.app.debug.UiDescriptionSnapshot;
...
public class Fragment implements LifecycleOwner, ViewModelStoreOwner, ComponentCallbacks, View.OnCreateContextMenuListener {
    ...
    public final Object getHost() {
        ...
        return fragmentHostCallback.mo24onGetHost();
    }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (sparseArray != null) {
            try {
                ...
                String takeSnapshot = new UiDescriptionSnapshot().takeSnapshot(this.mInnerView);
                UncaughtCrashHeader crashCaughtHeaderByType = TCrashSDK.instance().getCrashCaughtHeaderByType(UncaughtCrashType.JAVA_ONLY);
                crashCaughtHeaderByType.addHeaderInfo("fragment_simple_ui", takeSnapshot);
                crashCaughtHeaderByType.addHeaderInfo("fragment_saved_view_state", this.mSavedViewState.toString());
                throw th;
            }
        }
        this.mCalled = false;
