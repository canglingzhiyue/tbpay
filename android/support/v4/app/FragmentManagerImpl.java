    ...
    public void restoreAllState(Parcelable parcelable, FragmentManagerNonConfig fragmentManagerNonConfig) {
        ...
        while (i3 < fragmentManagerState.mActive.length) {
            ...
            if (fragmentState2 != null) {
                ...
                if (DEBUG) {
                    String str2 = "restoreAllState: active #" + i3 + ResponseProtocolType.COMMENT + instantiate;
                }
        ...
        if (fragmentManagerState.mAdded != null) {
            for (int i5 = 0; i5 < fragmentManagerState.mAdded.length; i5++) {
                ...
                if (DEBUG) {
                    String str4 = "restoreAllState: added #" + i5 + ResponseProtocolType.COMMENT + fragment3;
                }
        ...
        if (fragmentManagerState.mBackStack != null) {
            ...
            for (int i6 = 0; i6 < fragmentManagerState.mBackStack.length; i6++) {
                ...
                if (DEBUG) {
                    String str5 = "restoreAllState: back stack #" + i6 + " (index " + instantiate2.mIndex + "): " + instantiate2;
                    PrintWriter printWriter = new PrintWriter(new LogWriter(TAG));
    ...
    public Parcelable saveAllState() {
        ...
        for (int i = 0; i < size2; i++) {
            ...
            if (valueAt != null) {
                ...
                if (DEBUG) {
                    String str = "Saved state of " + valueAt + ResponseProtocolType.COMMENT + fragmentState.mSavedFragmentState;
                }
                z = true;
            }
        }
        ...
        if (size3 > 0) {
            ...
            for (int i2 = 0; i2 < size3; i2++) {
                ...
                if (DEBUG) {
                    String str2 = "saveAllState: adding fragment #" + i2 + ResponseProtocolType.COMMENT + this.mAdded.get(i2);
                }
            }
        } else {
            iArr = null;
        ...
        if (arrayList != null && (size = arrayList.size()) > 0) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (DEBUG) {
                    String str3 = "saveAllState: adding back stack #" + i3 + ResponseProtocolType.COMMENT + this.mBackStack.get(i3);
                }
            }
        }
