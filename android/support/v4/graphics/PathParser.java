...
public class PathParser {
    ...
    public static class PathDataNode {
                ...
                if (c3 != 'A') {
                    if (c3 == 'C') {
                        ...
                        if (c3 != 'c') {
                            if (c3 == 'h') {
                                ...
                                if (c3 == 'v') {
                                    ...
                                    if (i3 > 0) {
                                        ...
                                        path.moveTo(fArr2[i3], fArr2[i12]);
                                        f18 = f16;
                                        f17 = f15;
                                    }
                                } else if (c3 == 'S') {
                                    ...
                                    int i14 = i3 + 2;
                                    int i15 = i3 + 3;
                                    path.cubicTo(f24, f16, fArr2[i3], fArr2[i13], fArr2[i14], fArr2[i15]);
                                    f = fArr2[i3];
                                    f2 = fArr2[i13];
                                    f15 = fArr2[i14];
                                    f16 = fArr2[i15];
                                    ...
                                    int i16 = i3 + 1;
                                    path.quadTo(f15, f16, fArr2[i3], fArr2[i16]);
                                    f12 = f16;
                                    f11 = f15;
                                    i2 = i3;
                                    f15 = fArr2[i3];
                                    ...
                                    f16 += fArr2[i18];
                                    if (i3 > 0) {
                                        path.rLineTo(fArr2[i3], fArr2[i18]);
                                    } else {
                                        path.rMoveTo(fArr2[i3], fArr2[i18]);
                                        f18 = f16;
                                        f17 = f15;
                                    }
                                } else if (c3 == 's') {
                                    ...
                                    int i20 = i3 + 2;
                                    int i21 = i3 + 3;
                                    path.rCubicTo(f6, f5, fArr2[i3], fArr2[i19], fArr2[i20], fArr2[i21]);
                                    f = fArr2[i3] + f15;
                                    f2 = fArr2[i19] + f16;
                                    f15 += fArr2[i20];
                                    f3 = fArr2[i21];
                                    ...
                                    int i22 = i3 + 1;
                                    path.rQuadTo(f7, f8, fArr2[i3], fArr2[i22]);
                                    float f26 = f7 + f15;
                                    float f27 = f8 + f16;
                                    f15 += fArr2[i3];
                                    f16 += fArr2[i22];
                                ...
                                int i24 = i3 + 2;
                                int i25 = i3 + 3;
                                path.rQuadTo(fArr2[i3], fArr2[i23], fArr2[i24], fArr2[i25]);
                                f = fArr2[i3] + f15;
                                f2 = fArr2[i23] + f16;
                                f15 += fArr2[i24];
                                f3 = fArr2[i25];
                            ...
                            int i28 = i3 + 4;
                            int i29 = i3 + 5;
                            path.rCubicTo(fArr2[i3], fArr2[i3 + 1], fArr2[i26], fArr2[i27], fArr2[i28], fArr2[i29]);
                            f = fArr2[i26] + f15;
                            f2 = fArr2[i27] + f16;
                            f15 += fArr2[i28];
                            f3 = fArr2[i29];
                        ...
                        int i30 = i3 + 5;
                        float f28 = fArr2[i30] + f15;
                        int i31 = i3 + 6;
                        float f29 = fArr2[i31] + f16;
                        float f30 = fArr2[i3];
                        ...
                        i2 = i3;
                        drawArc(path, f15, f16, f28, f29, f30, f31, f32, z, fArr2[i3 + 4] != 0.0f);
                        f15 = f33 + fArr2[i30];
                        f16 += fArr2[i31];
                    }
                    i3 = i2 + i;
                    ...
                    int i32 = i2 + 5;
                    int i33 = i2 + 6;
                    drawArc(path, f15, f16, fArr2[i32], fArr2[i33], fArr2[i2], fArr2[i2 + 1], fArr2[i2 + 2], fArr2[i2 + 3] != 0.0f, fArr2[i2 + 4] != 0.0f);
                    f15 = fArr2[i32];
                    f16 = fArr2[i33];
                }
                f12 = f16;
        ...
        private static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d17 == mto.a.GEO_NOT_SUPPORT) {
                return;
            }
            double d18 = (1.0d / d17) - 0.25d;
            if (d18 < mto.a.GEO_NOT_SUPPORT) {
            ...
            int i = (atan22 > mto.a.GEO_NOT_SUPPORT ? 1 : (atan22 == mto.a.GEO_NOT_SUPPORT ? 0 : -1));
            if (z2 != (i >= 0)) {
     ...
     */
    /* JADX WARN: Removed duplicated region for block: B:23:0x0037 A[LOOP:0: B:3:0x0007->B:23:0x0037, LOOP_END] */
