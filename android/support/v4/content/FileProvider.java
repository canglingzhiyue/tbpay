...
public class FileProvider extends ContentProvider {
    ...
    public static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            try {
                ...
                return new Uri.Builder().scheme("content").authority(this.mAuthority).encodedPath(Uri.encode(entry.getKey()) + fxb.DIR + Uri.encode(substring, "/")).build();
            } catch (IOException unused) {
    ...
    public String getType(Uri uri) {
        ...
        if (lastIndexOf >= 0) {
            ...
            return mimeTypeFromExtension != null ? mimeTypeFromExtension : UploadConstants.FILE_CONTENT_TYPE;
        }
