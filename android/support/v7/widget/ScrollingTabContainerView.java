...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public class TabAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            if (view == null) {
                return ScrollingTabContainerView.this.createTabView((ActionBar.b) getItem(i), true);
            }
            ((TabView) view).bindTab((ActionBar.b) getItem(i));
            return view;
        }
    }
    ...
    public class TabView extends LinearLayout {
        ...
        private ActionBar.b mTab;
        private TextView mTextView;

        public TabView(Context context, ActionBar.b bVar, boolean z) {
    ...
    TabView createTabView(ActionBar.b bVar, boolean z) {
        TabView tabView = new TabView(getContext(), bVar, z);
        if (z) {
