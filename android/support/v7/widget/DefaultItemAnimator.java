...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public static class a {
        ...
        public RecyclerView.ViewHolder f1407a;
        ...
        public String toString() {
            return "ChangeInfo{oldHolder=" + this.f1407a + ", newHolder=" + this.b + ", fromX=" + this.c + ", fromY=" + this.d + ", toX=" + this.e + ", toY=" + this.f + '}';
        }
    }
    ...
    public static class b {
        ...
        /* renamed from: a  reason: collision with root package name */
        public RecyclerView.ViewHolder f1408a;
        public int b;
        public int c;
        public int d;
        public int e;
    ...
    private void endChangeAnimation(List<a> list, RecyclerView.ViewHolder viewHolder) {
        for (int size = list.size() - 1; size >= 0; size--) {
            ...
            if (endChangeAnimationIfNecessary(aVar, viewHolder) && aVar.f1407a == null && aVar.b == null) {
                list.remove(aVar);
            }
        }
    }
    ...
    private void endChangeAnimationIfNecessary(a aVar) {
        if (aVar.f1407a != null) {
            endChangeAnimationIfNecessary(aVar, aVar.f1407a);
        }
        if (aVar.b != null) {
    ...
    private boolean endChangeAnimationIfNecessary(a aVar, RecyclerView.ViewHolder viewHolder) {
        ...
        if (aVar.b == viewHolder) {
            aVar.b = null;
        } else if (aVar.f1407a != viewHolder) {
            return false;
        } else {
            aVar.f1407a = null;
            z = true;
    ...
    void animateChangeImpl(final a aVar) {
        RecyclerView.ViewHolder viewHolder = aVar.f1407a;
        ...
        if (view2 != null) {
            ...
            this.mChangeAnimations.add(aVar.f1407a);
            ...
            duration.alpha(0.0f).setListener(new AnimatorListenerAdapter() { // from class: android.support.v7.widget.DefaultItemAnimator.7
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    DefaultItemAnimator.this.dispatchChangeFinished(aVar.f1407a, true);
                    DefaultItemAnimator.this.mChangeAnimations.remove(aVar.f1407a);
                    DefaultItemAnimator.this.dispatchFinishedWhenDone();
                }

                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationStart(Animator animator) {
                    DefaultItemAnimator.this.dispatchChangeStarting(aVar.f1407a, true);
                }
            }).start();
        }
        if (view != null) {
    ...
    public void endAnimation(RecyclerView.ViewHolder viewHolder) {
        ...
        while (true) {
            ...
            if (size < 0) {
                break;
            } else if (this.mPendingMoves.get(size).f1408a == viewHolder) {
                view.setTranslationY(0.0f);
                view.setTranslationX(0.0f);
                dispatchMoveFinished(viewHolder);
        ...
        for (int size3 = this.mMovesList.size() - 1; size3 >= 0; size3--) {
            ...
            while (true) {
                if (size4 < 0) {
                    break;
                } else if (arrayList2.get(size4).f1408a == viewHolder) {
                    view.setTranslationY(0.0f);
                    view.setTranslationX(0.0f);
                    dispatchMoveFinished(viewHolder);
    ...
    public void endAnimations() {
        ...
        while (true) {
            ...
            View view = bVar.f1408a.itemView;
            view.setTranslationY(0.0f);
            view.setTranslationX(0.0f);
            dispatchMoveFinished(bVar.f1408a);
            this.mPendingMoves.remove(size);
        }
        ...
        for (int size5 = this.mMovesList.size() - 1; size5 >= 0; size5--) {
            ...
            for (int size6 = arrayList.size() - 1; size6 >= 0; size6--) {
                ...
                View view2 = bVar2.f1408a.itemView;
                view2.setTranslationY(0.0f);
                view2.setTranslationX(0.0f);
                dispatchMoveFinished(bVar2.f1408a);
    ...
    public void runPendingAnimations() {
        ...
        if (z || z2 || z4 || z3) {
            ...
            if (z2) {
                ...
                Runnable runnable = new Runnable() { // from class: android.support.v7.widget.DefaultItemAnimator.1
                    ...
                    public void run() {
                        ...
                        while (it2.hasNext()) {
                            b bVar = (b) it2.next();
                            DefaultItemAnimator.this.animateMoveImpl(bVar.f1408a, bVar.b, bVar.c, bVar.d, bVar.e);
                        }
                        arrayList.clear();
                ...
                if (z) {
                    ViewCompat.postOnAnimationDelayed(arrayList.get(0).f1408a.itemView, runnable, getRemoveDuration());
                } else {
                    runnable.run();
                }
            }
            if (z3) {
                ...
                if (z) {
                    ViewCompat.postOnAnimationDelayed(arrayList2.get(0).f1407a.itemView, runnable2, getRemoveDuration());
                } else {
                    runnable2.run();
                }
            }
