...
public class SwitchCompat extends CompoundButton {
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.mThumbWidth = Math.max(this.mShowText ? Math.max(this.mOnLayout.getWidth(), this.mOffLayout.getWidth()) + (this.mThumbTextPadding << 1) : 0, i3);
        Drawable drawable2 = this.mTrackDrawable;
        if (drawable2 != null) {
            drawable2.getPadding(rect);
    ...
    */
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        this.mSwitchTransformationMethod = obtainStyledAttributes.getBoolean(R.styleable.TextAppearance_textAllCaps, false) ? new ach(getContext()) : null;
        obtainStyledAttributes.recycle();
    }
    ...
    public void setThumbResource(int i) {
        setThumbDrawable(ace.b(getContext(), i));
    }
    ...
    public void setTrackResource(int i) {
        setTrackDrawable(ace.b(getContext(), i));
    }
