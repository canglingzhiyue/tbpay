...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2, ScrollingView {
    ...
    private final ae.b mViewInfoProcessCallback;
    final ae mViewInfoStore;
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final VH createViewHolder(ViewGroup viewGroup, int i) {
            ...
            VH mo1596onCreateViewHolder = mo1596onCreateViewHolder(viewGroup, i);
            mo1596onCreateViewHolder.mItemViewType = i;
            TraceCompat.endSection();
        ...
        public abstract VH mo1596onCreateViewHolder(ViewGroup viewGroup, int i);
    ...
    public static class RecycledViewPool {
        ...
        public static class a {
            ...
            ArrayList<ViewHolder> f1438a = new ArrayList<>();
            int b = 5;
            long c = 0;
            long d = 0;
        ...
        public void clear() {
            for (int i = 0; i < this.mScrap.size(); i++) {
                this.mScrap.valueAt(i).f1438a.clear();
            }
        }
        ...
        public ViewHolder getRecycledView(int i) {
            a aVar = this.mScrap.get(i);
            if (aVar == null || aVar.f1438a.isEmpty()) {
                return null;
            }
            ArrayList<ViewHolder> arrayList = aVar.f1438a;
            return arrayList.remove(arrayList.size() - 1);
        }

        public int getRecycledViewCount(int i) {
            return getScrapDataForType(i).f1438a.size();
        }
        ...
        public void putRecycledView(ViewHolder viewHolder) {
            ...
            ArrayList<ViewHolder> arrayList = getScrapDataForType(itemViewType).f1438a;
        ...
        public void setMaxRecycledViews(int i, int i2) {
            ...
            ArrayList<ViewHolder> arrayList = scrapDataForType.f1438a;
            if (arrayList != null) {
        ...
        int size() {
            ...
            for (int i2 = 0; i2 < this.mScrap.size(); i2++) {
                ArrayList<ViewHolder> arrayList = this.mScrap.valueAt(i2).f1438a;
                if (arrayList != null) {
                    i += arrayList.size();
                }
            }
        ...
        */
        public void bindViewToPosition(android.view.View r7, int r8) {
            /*
                ...
                android.support.v7.widget.c r0 = r0.mAdapterHelper
                int r2 = r0.b(r8)
                if (r2 < 0) goto L5e
                android.support.v7.widget.RecyclerView r0 = android.support.v7.widget.RecyclerView.this
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            ...
            if (!isRecyclable()) {
                sb.append(" not recyclable(" + this.mIsRecyclableCount + riy.BRACKET_END_STR);
            }
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mPrefetchRegistry = ALLOW_THREAD_GAP_WORK ? new r.a() : null;
        ...
        this.mViewInfoProcessCallback = new ae.b() { // from class: android.support.v7.widget.RecyclerView.4
    ...
    */
    public void onAttachedToWindow() {
        ...
        L1e:
            ...
            if (r0 == 0) goto L69
            java.lang.ThreadLocal<android.support.v7.widget.r> r0 = android.support.v7.widget.r.f1503a
            java.lang.Object r0 = r0.get()
            android.support.v7.widget.r r0 = (android.support.v7.widget.r) r0
            r4.mGapWorker = r0
            android.support.v7.widget.r r0 = r4.mGapWorker
            if (r0 != 0) goto L64
        ...
        L54:
            android.support.v7.widget.r r1 = r4.mGapWorker
    ...
    */
    ...
    public void smoothScrollBy(int i, int i2, Interpolator interpolator) {
        ...
        if (layoutManager == null) {
            ...
            this.mViewFlinger.a(i, i2, interpolator);
        }
    }
