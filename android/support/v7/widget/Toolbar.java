...
public class Toolbar extends ViewGroup {
    ...
    public class a implements android.support.v7.view.menu.j {
        ...
        android.support.v7.view.menu.e f1464a;
        ...
        public boolean collapseItemActionView(android.support.v7.view.menu.e eVar, android.support.v7.view.menu.g gVar) {
            if (Toolbar.this.mExpandedActionView instanceof aco) {
                ((aco) Toolbar.this.mExpandedActionView).onActionViewCollapsed();
            }
        ...
        public boolean expandItemActionView(android.support.v7.view.menu.e eVar, android.support.v7.view.menu.g gVar) {
            ...
            if (parent2 != toolbar3) {
                ...
                LayoutParams mo66generateDefaultLayoutParams = Toolbar.this.mo66generateDefaultLayoutParams();
                mo66generateDefaultLayoutParams.gravity = 8388611 | (Toolbar.this.mButtonGravity & 112);
                mo66generateDefaultLayoutParams.mViewType = 2;
                Toolbar.this.mExpandedActionView.setLayoutParams(mo66generateDefaultLayoutParams);
            ...
            gVar.e(true);
            if (Toolbar.this.mExpandedActionView instanceof aco) {
                ((aco) Toolbar.this.mExpandedActionView).onActionViewExpanded();
            }
            return true;
        }
        ...
        public void initForMenu(Context context, android.support.v7.view.menu.e eVar) {
            ...
            android.support.v7.view.menu.e eVar2 = this.f1464a;
        ...
        public void updateMenuView(boolean z) {
            if (this.b != null) {
                android.support.v7.view.menu.e eVar = this.f1464a;
                boolean z2 = false;
                if (eVar != null) {
                    int size = eVar.size();
                    int i = 0;
                    while (true) {
                        if (i >= size) {
                            break;
                        } else if (this.f1464a.getItem(i) == this.b) {
                            z2 = true;
                            break;
                        } else {
                            i++;
                ...
                collapseItemActionView(this.f1464a, this.b);
            }
        }
    }
    ...
    private void addSystemView(View view, boolean z) {
        ...
        LayoutParams mo66generateDefaultLayoutParams = layoutParams == null ? mo66generateDefaultLayoutParams() : !checkLayoutParams(layoutParams) ? mo68generateLayoutParams(layoutParams) : (LayoutParams) layoutParams;
        mo66generateDefaultLayoutParams.mViewType = 1;
        if (!z || this.mExpandedActionView == null) {
            addView(view, mo66generateDefaultLayoutParams);
            return;
        }
        view.setLayoutParams(mo66generateDefaultLayoutParams);
    ...
    private void ensureMenu() {
        ...
        if (this.mMenuView.peekMenu() == null) {
            android.support.v7.view.menu.e eVar = (android.support.v7.view.menu.e) this.mMenuView.getMenu();
            if (this.mExpandedMenuPresenter == null) {
                this.mExpandedMenuPresenter = new a();
            }
            this.mMenuView.setExpandedActionViewsExclusive(true);
            eVar.a(this.mExpandedMenuPresenter, this.mPopupContext);
        }
    }
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            LayoutParams mo66generateDefaultLayoutParams = mo66generateDefaultLayoutParams();
            mo66generateDefaultLayoutParams.gravity = 8388613 | (this.mButtonGravity & 112);
            this.mMenuView.setLayoutParams(mo66generateDefaultLayoutParams);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            LayoutParams mo66generateDefaultLayoutParams = mo66generateDefaultLayoutParams();
            mo66generateDefaultLayoutParams.gravity = 8388611 | (this.mButtonGravity & 112);
            this.mNavButtonView.setLayoutParams(mo66generateDefaultLayoutParams);
        }
    }
    ...
    public void collapseActionView() {
        ...
        android.support.v7.view.menu.g gVar = aVar == null ? null : aVar.b;
        if (gVar != null) {
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            ...
            mo66generateDefaultLayoutParams.gravity = 8388611 | (this.mButtonGravity & 112);
            mo66generateDefaultLayoutParams.mViewType = 2;
            this.mCollapseButtonView.setLayoutParams(mo66generateDefaultLayoutParams);
    ...
    public LayoutParams mo66generateDefaultLayoutParams() {
        return new LayoutParams(-2, -2);
    }

    @Override // android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public LayoutParams mo67generateLayoutParams(AttributeSet attributeSet) {
    ...
    @Override // android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public LayoutParams mo68generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
    ...
    public int getCurrentContentInsetEnd() {
        android.support.v7.view.menu.e peekMenu;
        ActionMenuView actionMenuView = this.mMenuView;
    ...
    */
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        ActionMenuView actionMenuView = this.mMenuView;
        android.support.v7.view.menu.e peekMenu = actionMenuView != null ? actionMenuView.peekMenu() : null;
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        if (aVar != null && aVar.b != null) {
            savedState.expandedMenuItemId = this.mExpandedMenuPresenter.b.getItemId();
        }
    ...
    public void setMenu(android.support.v7.view.menu.e eVar, ActionMenuPresenter actionMenuPresenter) {
        if (eVar == null && this.mMenuView == null) {
            return;
        }
        ensureMenuView();
        android.support.v7.view.menu.e peekMenu = this.mMenuView.peekMenu();
        if (peekMenu == eVar) {
            return;
        }
        if (peekMenu != null) {
        ...
        if (eVar != null) {
            eVar.a(actionMenuPresenter, this.mPopupContext);
            eVar.a(this.mExpandedMenuPresenter, this.mPopupContext);
        } else {
    ...
    public void setNavigationIcon(int i) {
        setNavigationIcon(ace.b(getContext(), i));
    }
