...
class v extends Drawable {
    ...
    public v(ColorStateList colorStateList, float f) {
        this.f1509a = f;
        b(colorStateList);
        this.c = new RectF();
        this.d = new Rect();
    ...
    private void a(Rect rect) {
        ...
        this.d.set(rect);
        if (this.f) {
            float a2 = w.a(this.e, this.f1509a, this.g);
            this.d.inset((int) Math.ceil(w.b(this.e, this.f1509a, this.g)), (int) Math.ceil(a2));
            this.c.set(this.d);
        }
    }
    ...
    public void getOutline(Outline outline) {
        outline.setRoundRect(this.d, this.f1509a);
    }
