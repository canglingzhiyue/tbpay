...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider, ItemTouchHelper.ViewDropHandler {
    ...
    public class a {
        ...
        public void a(View view) {
            ...
            this.f1414a = LinearLayoutManager.this.getPosition(view);
            if (this.c) {
                ...
                this.b = LinearLayoutManager.this.mOrientationHelper.getEndAfterPadding() - endAfterPadding;
                if (endAfterPadding <= 0) {
                    return;
                }
                int decoratedMeasurement = this.b - LinearLayoutManager.this.mOrientationHelper.getDecoratedMeasurement(view);
        ...
        void b() {
            this.b = this.c ? LinearLayoutManager.this.mOrientationHelper.getEndAfterPadding() : LinearLayoutManager.this.mOrientationHelper.getStartAfterPadding();
        }

        public void b(View view) {
            this.b = this.c ? LinearLayoutManager.this.mOrientationHelper.getDecoratedEnd(view) + LinearLayoutManager.this.mOrientationHelper.getTotalSpaceChange() : LinearLayoutManager.this.mOrientationHelper.getDecoratedStart(view);
            this.f1414a = LinearLayoutManager.this.getPosition(view);
        }

        public String toString() {
            return "AnchorInfo{mPosition=" + this.f1414a + ", mCoordinate=" + this.b + ", mLayoutFromEnd=" + this.c + ", mValid=" + this.d + '}';
        }
    }
    ...
    public static class b {
        ...
        public void a(View view) {
            View b = b(view);
            this.d = b == null ? -1 : ((RecyclerView.LayoutParams) b.getLayoutParams()).getViewLayoutPosition();
        }
    ...
    private int computeScrollOffset(RecyclerView.State state) {
        ...
        ensureLayoutState();
        return y.a(state, this.mOrientationHelper, findFirstVisibleChildClosestToStart(!this.mSmoothScrollbarEnabled, true), findFirstVisibleChildClosestToEnd(!this.mSmoothScrollbarEnabled, true), this, this.mSmoothScrollbarEnabled, this.mShouldReverseLayout);
    }
    ...
    private int computeScrollRange(RecyclerView.State state) {
        ...
        ensureLayoutState();
        return y.b(state, this.mOrientationHelper, findFirstVisibleChildClosestToStart(!this.mSmoothScrollbarEnabled, true), findFirstVisibleChildClosestToEnd(!this.mSmoothScrollbarEnabled, true), this, this.mSmoothScrollbarEnabled);
    }
    ...
    private boolean updateAnchorFromPendingData(RecyclerView.State state, a aVar) {
        ...
        if (!state.isPreLayout() && (i = this.mPendingScrollPosition) != -1) {
            if (i >= 0 && i < state.getItemCount()) {
                aVar.f1414a = this.mPendingScrollPosition;
    ...
    private void updateAnchorInfoForLayout(RecyclerView.Recycler recycler, RecyclerView.State state, a aVar) {
        if (!updateAnchorFromPendingData(state, aVar) && !updateAnchorFromChildren(recycler, state, aVar)) {
            aVar.b();
            aVar.f1414a = this.mStackFromEnd ? state.getItemCount() - 1 : 0;
        }
    }
    ...
    private void updateLayoutStateToFillEnd(a aVar) {
        updateLayoutStateToFillEnd(aVar.f1414a, aVar.b);
    }
    ...
    private void updateLayoutStateToFillStart(a aVar) {
        updateLayoutStateToFillStart(aVar.f1414a, aVar.b);
    }
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        ensureLayoutState();
        this.mLayoutState.f1415a = false;
        resolveShouldLayoutReverse();
        View focusedChild = getFocusedChild();
        ...
        if (this.mAnchorInfo.c) {
            ...
            if (this.mLayoutState.c > 0) {
                startAfterPadding += this.mLayoutState.c;
            }
            updateLayoutStateToFillStart(this.mAnchorInfo);
            b bVar5 = this.mLayoutState;
            bVar5.h = startAfterPadding;
            bVar5.d += this.mLayoutState.e;
            fill(recycler, this.mLayoutState, state, false);
            i3 = this.mLayoutState.b;
            if (this.mLayoutState.c > 0) {
                int i13 = this.mLayoutState.c;
