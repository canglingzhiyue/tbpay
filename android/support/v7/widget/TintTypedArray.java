...
public class TintTypedArray {
    ...
    public ColorStateList getColorStateList(int i) {
        int resourceId;
        ColorStateList a2;
        return (!this.mWrapped.hasValue(i) || (resourceId = this.mWrapped.getResourceId(i, 0)) == 0 || (a2 = ace.a(this.mContext, resourceId)) == null) ? this.mWrapped.getColorStateList(i) : a2;
    }
    ...
    public Drawable getDrawable(int i) {
        int resourceId;
        return (!this.mWrapped.hasValue(i) || (resourceId = this.mWrapped.getResourceId(i, 0)) == 0) ? this.mWrapped.getDrawable(i) : ace.b(this.mContext, resourceId);
    }
