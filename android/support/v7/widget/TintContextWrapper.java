...
public class TintContextWrapper extends ContextWrapper {
    ...
    private TintContextWrapper(Context context) {
        ...
        if (!VectorEnabledTintResources.shouldBeUsed()) {
            this.mResources = new ab(this, context.getResources());
            this.mTheme = null;
            return;
        }
    ...
    private static boolean shouldWrap(Context context) {
        if ((context instanceof TintContextWrapper) || (context.getResources() instanceof ab) || (context.getResources() instanceof VectorEnabledTintResources)) {
            return false;
        }
