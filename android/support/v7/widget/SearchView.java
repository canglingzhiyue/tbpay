...
public class SearchView extends LinearLayoutCompat implements aco {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "SearchView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " isIconified=" + this.isIconified + riy.BLOCK_END_STR;
        }
    ...
    public static class a {
        ...
        private Method f1451a;
        private Method b;
        private Method c;

        a() {
            try {
                this.f1451a = AutoCompleteTextView.class.getDeclaredMethod("doBeforeTextChanged", new Class[0]);
                this.f1451a.setAccessible(true);
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (z) {
                if (!z2 || this.c.contains(x, y)) {
                    ...
                    f = this.f1452a.getWidth() / 2;
                    i = this.f1452a.getHeight() / 2;
                }
                motionEvent.setLocation(f, i);
                return this.f1452a.dispatchTouchEvent(motionEvent);
            }
            return false;
        }
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mTextKeyListener = new View.OnKeyListener() { // from class: android.support.v7.widget.SearchView.10
    ...
    private Intent createVoiceAppSearchIntent(Intent intent, SearchableInfo searchableInfo) {
        ...
        PendingIntent a2 = com.android.taobao.aop.a.a(getContext(), 0, intent2, 1073741824);
