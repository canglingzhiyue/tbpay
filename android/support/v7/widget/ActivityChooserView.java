...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public int getCount() {
            int a2 = this.mDataModel.a();
            if (!this.mShowDefaultActivity && this.mDataModel.b() != null) {
                a2--;
            }
            int min = Math.min(a2, this.mMaxActivityCount);
    ...
    public class Callbacks implements View.OnClickListener, View.OnLongClickListener, AdapterView.OnItemClickListener, PopupWindow.OnDismissListener {
        ...
        public void onClick(View view) {
            ...
            Intent b = ActivityChooserView.this.mAdapter.getDataModel().b(ActivityChooserView.this.mAdapter.getDataModel().a(ActivityChooserView.this.mAdapter.getDefaultActivity()));
            if (b == null) {
                return;
            }
            b.addFlags(524288);
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
            ...
            if (ActivityChooserView.this.mIsSelectingDefaultActivity) {
                ...
                ActivityChooserView.this.mAdapter.getDataModel().c(i);
                return;
            }
            if (!ActivityChooserView.this.mAdapter.getShowDefaultActivity()) {
                i++;
            }
            Intent b = ActivityChooserView.this.mAdapter.getDataModel().b(i);
            if (b == null) {
                return;
            }
            b.addFlags(524288);
