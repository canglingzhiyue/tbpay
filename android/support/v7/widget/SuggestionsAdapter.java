...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getDrawable(Uri uri) {
        try {
            ...
            String str = "Icon not found: " + uri + ", " + e2.getMessage();
            return null;
        }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (aVar.f1460a != null) {
            setViewText(aVar.f1460a, getStringOrNull(cursor, this.mText1Col));
        }
        if (aVar.b != null) {
            ...
            setViewText(aVar.b, formatUrl);
        }
        if (aVar.c != null) {
            setViewDrawable(aVar.c, getIcon1(cursor), 4);
        }
        if (aVar.d != null) {
            setViewDrawable(aVar.d, getIcon2(cursor), 8);
        }
    ...
    public View getDropDownView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            if (newDropDownView != null) {
                ((a) newDropDownView.getTag()).f1460a.setText(e.toString());
            }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            if (newView != null) {
                ((a) newView.getTag()).f1460a.setText(e.toString());
            }
            return newView;
        }
    }
