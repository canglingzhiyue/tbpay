...
public class ErrorConstant {
    ...
    public static HashMap<String, String> errCodeMappingMap;
    public static HashMap<String, String> mtopSdkErrCodeMappingMap;
    ...
    static {
        ...
        mtopServerErrCodeMappingMap.put(ERRCODE_FAIL_SYS_UNIT_PROTECT, MAPPING_CODE_FAIL_SYS_UNIT_PROTECT);
    ...
    public static String getMappingCodeByErrorCode(String str) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("95289a76", new Object[]{str}) : errCodeMappingMap.get(str);
    }

    public static boolean isSystemError(String str) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("a10226e4", new Object[]{str})).booleanValue() : mtopServerErrCodeMappingMap.containsKey(str);
    }

    public static boolean isMtopSdkError(String str) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("c7aef8b5", new Object[]{str})).booleanValue() : StringUtils.isBlank(str) || mtopSdkErrCodeMappingMap.containsKey(str);
    }

    public static boolean isNetworkError(String str) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("35bab659", new Object[]{str})).booleanValue() : "ANDROID_SYS_NETWORK_ERROR".equals(str) || ERRCODE_NO_NETWORK.equals(str);
    }

    public static boolean isNoNetwork(String str) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("45be4978", new Object[]{str})).booleanValue() : ERRCODE_NO_NETWORK.equals(str);
    }

    public static boolean isSessionInvalid(String str) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("8af13aa0", new Object[]{str})).booleanValue() : "FAIL_SYS_SESSION_EXPIRED".equals(str) || ERRCODE_ANDROID_SYS_LOGIN_FAIL.equals(str);
    }

    public static boolean isUnitProtect(String str) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("baea70f6", new Object[]{str})).booleanValue() : ERRCODE_FAIL_SYS_UNIT_PROTECT.equals(str);
    }

    public static boolean isIllegelSign(String str) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("cf40821a", new Object[]{str})).booleanValue() : ERRCODE_FAIL_SYS_ILEGEL_SIGN.equals(str);
    }

    public static boolean isSuccess(String str) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("bdc3f14e", new Object[]{str})).booleanValue() : "SUCCESS".equals(str);
    }

    public static boolean is41XResult(String str) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("239553a3", new Object[]{str})).booleanValue() : ERRCODE_API_41X_ANTI_ATTACK.equals(str);
    }

    public static boolean isApiLockedResult(String str) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("7b9057cc", new Object[]{str})).booleanValue() : "ANDROID_SYS_API_FLOW_LIMIT_LOCKED".equals(str);
    }

    public static boolean isExpiredRequest(String str) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("2537309", new Object[]{str})).booleanValue() : ERRCODE_FAIL_SYS_EXPIRED_REQUEST.equals(str) || ERRCODE_FAIL_SYS_REQUEST_EXPIRED.equals(str);
    }

    public static boolean isMtopServerError(String str) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("f19fd68", new Object[]{str})).booleanValue() : str != null && (mtopServerErrCodeMappingMap.containsKey(str) || str.startsWith(FAIL_SYS_PREFIX));
    }
