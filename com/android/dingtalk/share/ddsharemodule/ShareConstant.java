...
public class ShareConstant {
    public static String ACTION_APP_REGISTER = null;
    public static String ACTION_APP_UNREGISTER = null;
    ...
    public static String PERMISSION_ACTION_HANDLE_APP_REGISTER = null;
    public static String PERMISSION_ACTION_HANDLE_APP_UNREGISTER = null;
    public static final int SDK_SUPPORT_DING_VERSION = 20160214;
    public static final int SDK_VERSION = 20160101;

    static {
        kge.a(1155461784);
        PERMISSION_ACTION_HANDLE_APP_REGISTER = "com.dd.plugin.openapi.Intent.ACTION_HANDLE_APP_REGISTER";
        ACTION_APP_REGISTER = "dd://registerapp?appid=";
        PERMISSION_ACTION_HANDLE_APP_UNREGISTER = "com.dd.plugin.openapi.Intent.ACTION_HANDLE_APP_UNREGISTER";
        ACTION_APP_UNREGISTER = "dd://unregisterapp?appid=";
    }
}
