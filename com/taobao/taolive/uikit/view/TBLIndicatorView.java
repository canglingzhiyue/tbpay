...
public class TBLIndicatorView extends IndicatorView {
    ...
    public TBLIndicatorView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            ...
            this.mStrokeWidth = obtainStyledAttributes.getDimension(R.styleable.TBLIndicatorView_uik_strokeWidth, this.mStrokeWidth);
            ...
            this.mRadius = obtainStyledAttributes.getDimensionPixelSize(R.styleable.TBLIndicatorView_uik_indicatorRadius, this.mRadius);
            ...
            this.mGapMargin = obtainStyledAttributes.getDimensionPixelSize(R.styleable.TBLIndicatorView_uik_gapMargin, this.mGapMargin);
            this.mFocusWidth = this.mRadius << 1;
            this.mFocusWidth = obtainStyledAttributes.getDimensionPixelSize(R.styleable.TBLIndicatorView_focusWidth, this.mFocusWidth);
