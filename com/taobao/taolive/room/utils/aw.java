...
public class aw {
    public static final String ALLOW_GIFT_EFFECT = "已打开其他用户的礼物特效";
    ...
    public static final String DISALLOW_GIFT_EFFECT = "已屏蔽其他用户的礼物特效";
    ...
    public static final String[] TRACK_ORANGES;
    ...
    static {
        kge.a(686277553);
        TRACK_ORANGES = new String[]{"tblive"};
    }
}
