...
public final class MediaInfoType extends Enum<MediaInfoType> {
    ...
    public static final MediaInfoType MEDIA_INFO_STREAM_ABNORMAL_VIDEO = new MediaInfoType("MEDIA_INFO_STREAM_ABNORMAL_VIDEO", 10, IMediaPlayer.MEDIA_INFO_STREAM_ABNORMAL_VIDEO);
    public static final MediaInfoType MEDIA_INFO_STREAM_ABNORMAL_AUDIO = new MediaInfoType("MEDIA_INFO_STREAM_ABNORMAL_AUDIO", 11, IMediaPlayer.MEDIA_INFO_STREAM_ABNORMAL_AUDIO);
    ...
    public static final MediaInfoType MEDIA_INFO_FRAME_QUEUE_NULL = new MediaInfoType("MEDIA_INFO_FRAME_QUEUE_NULL", 17, 713);
    ...
    public static a<MediaInfoType> getEntries() {
        return $ENTRIES;
    }
