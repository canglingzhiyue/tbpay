...
public class WebMaskView extends RelativeLayout {
    ...
    public static /* synthetic */ VesselView access$000(WebMaskView webMaskView) {
        ...
        return ipChange instanceof IpChange ? (VesselView) ipChange.ipc$dispatch("9508b486", new Object[]{webMaskView}) : webMaskView.mVesselView;
    }

    public static /* synthetic */ String access$100(WebMaskView webMaskView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("47fe4543", new Object[]{webMaskView}) : webMaskView.mWebUrl;
    }
    ...
    private void loadView() {
        ...
        this.mTextViewRefresh.setOnClickListener(new View.OnClickListener() { // from class: com.taobao.share.ui.engine.weex.WebMaskView.1
