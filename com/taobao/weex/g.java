...
public class g {
    ...
    public static volatile long f23505a;
    ...
    public void a(Application application, HashMap<String, Object> hashMap) {
        ...
        if (com.taobao.android.weex_framework.util.f.k()) {
            ...
            rtc.a().c().b();
            f23505a = System.currentTimeMillis();
        }
        WXSDKManager.getInstance().setInitListener(new WXSDKManager.a() { // from class: com.taobao.weex.g.1
            public static volatile transient /* synthetic */ IpChange $ipChange;
