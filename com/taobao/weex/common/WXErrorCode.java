...
public enum WXErrorCode {
    WX_ERR_LOAD_SO(UMFConstants.ErrorCode.WORKFLOW_CONTAIN_NO_EXECUTOR, "load so error", ErrorType.NATIVE_ERROR, ErrorGroup.NATIVE),
    ...
    WX_ERR_JS_REINIT_FRAMEWORK(DispatchCore.CHECK_SIGN_FAIL, "js reinit framework error", ErrorType.NATIVE_ERROR, ErrorGroup.NATIVE),
    WX_ERR_SINGLE_PROCESS_DLOPEN_FILE_NOT_EXIST(DispatchCore.RESOLVE_ANSWER_FAIL, "so file does not exist", ErrorType.NATIVE_ERROR, ErrorGroup.NATIVE),
    ...
    WX_DEGRAD_ERR_NETWORK_CHECK_CONTENT_LENGTH_FAILED(DispatchCore.CHECK_SIGN_FAIL, "degradeToH5|wx_network_error|js bundle content-length check failed", ErrorType.DEGRAD_ERROR, ErrorGroup.NATIVE),
    WX_DEGRAD_ERR_BUNDLE_CONTENTTYPE_ERROR(DispatchCore.RESOLVE_ANSWER_FAIL, "degradeToH5|wx_user_intercept_error |Content-Type is not application/javascript, Weex render template must be javascript, please check your request!", ErrorType.DEGRAD_ERROR, ErrorGroup.NATIVE),
    ...
    WX_DEGRAD_REMOTE_INSTALL_FAIL("-10011", "degradeToH5|remoteInitFail", ErrorType.RENDER_ERROR, ErrorGroup.NATIVE),
    WX_USER_CANCEL_REMOTE_INSTALL("-10012", "userCancel while remoteInit", ErrorType.RENDER_ERROR, ErrorGroup.NATIVE),
    WX_DEGRAD_FORCE_DOWNGRADE("-10013", "degradeToH5|forceDowngrade", ErrorType.RENDER_ERROR, ErrorGroup.NATIVE),
    WX_ERR_HASH_MAP_TMP(Constant.CODE_ERROR_FUNCTION_LIMIT, "WX_ERR_HASH_MAP_TMP", ErrorType.NATIVE_ERROR, ErrorGroup.NATIVE),
