...
public final class ShopInfoItemBean$iconWidth$2 extends Lambda implements ruk<Integer> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public final /* synthetic */ Map $props;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ShopInfoItemBean$iconWidth$2(Map map) {
        super(0);
        this.$props = map;
    }
    ...
    public final Integer mo2427invoke() {
        ...
        Object obj = this.$props.get("iconWidth");
