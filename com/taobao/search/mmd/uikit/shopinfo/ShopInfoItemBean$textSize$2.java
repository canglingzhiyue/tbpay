...
public final class ShopInfoItemBean$textSize$2 extends Lambda implements ruk<Integer> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public final /* synthetic */ Map $props;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ShopInfoItemBean$textSize$2(Map map) {
        super(0);
        this.$props = map;
    }
    ...
    public final Integer mo2427invoke() {
        ...
        Object obj = this.$props.get("textSize");
        if (!(obj instanceof String)) {
            obj = null;
        }
        return d.b((String) obj, 12);
    }
}
