...
public class a extends ContextWrapper {
    ...
    private WeakReference<Context> f18941a;
    ...
    public a(Context context) {
        super(c(context));
        this.f18941a = new WeakReference<>(context);
    }
    ...
    public Context a() {
        ...
        WeakReference<Context> weakReference = this.f18941a;
    ...
    private static Context c(Context context) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (Context) ipChange.ipc$dispatch("db91a096", new Object[]{context}) : context instanceof Application ? context : context.getApplicationContext();
    }
}
