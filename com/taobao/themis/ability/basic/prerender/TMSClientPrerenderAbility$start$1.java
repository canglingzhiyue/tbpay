...
public final class TMSClientPrerenderAbility$start$1 extends Lambda implements rul<Boolean, t> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public final /* synthetic */ gml $callback;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TMSClientPrerenderAbility$start$1(gml gmlVar) {
        super(1);
        this.$callback = gmlVar;
    }
    ...
    public final void invoke(boolean z) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            this.$callback.a(a$a.b("start prerender failed"));
        }
    }
}
