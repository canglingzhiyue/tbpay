...
public class PtrExpandableListView extends ExpandableListView implements AbsListView.OnScrollListener, d, g, h {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        public static final /* synthetic */ int[] f18961a = new int[PullBase.Mode.values().length];

        static {
            try {
                f18961a[PullBase.Mode.PULL_FROM_END.ordinal()] = 1;
    ...
    public int getReadyToRefreshingValue(PtrBase ptrBase, PullBase.Mode mode, int i) {
        ...
        if (AnonymousClass1.f18961a[mode.ordinal()] == 1 && i != 1 && (view = this.mEndView) != null) {
    ...
    public int getReleaseTargetValue(PtrBase ptrBase, PullBase.Mode mode, int i) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("9c4b782a", new Object[]{this, ptrBase, mode, new Integer(i)})).intValue() : AnonymousClass1.f18961a[mode.ordinal()] != 1 ? -1 : 0;
    }
