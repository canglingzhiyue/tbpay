...
public class MusicLoveBusiness extends BaseMaterialBusiness<Object> {
    ...
    public static /* synthetic */ Object ipc$super(MusicLoveBusiness musicLoveBusiness, String str, Object... objArr) {
    ...
    public String getUtRequestKey() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("8a583454", new Object[]{this}) : "music_love";
    }
    ...
    public void requestNet() {
        ...
        musicLoveRequest.setId(this.mParams.h());
        musicLoveRequest.setVendorType(this.mParams.i());
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        } else if (baseOutDo instanceof MusicLoveResponse) {
            bVar.a();
        } else {
