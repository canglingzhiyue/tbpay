...
public @interface MaterialNewCategory {
    public static final int BEAUTY_TEMPLATE = 21;
    ...
    public static final int IMAGE_TEXT_TEMPLATE = 20;
    public static final int MUSIC = 3;
    public static final int NEW_STICKER = 4;
    public static final int NEW_USER_TEMPLATE = 19;
    public static final int STICKER = 2;
    public static final int TEXT_IMAGE = 6;
    public static final int TEXT_TEMPLATE = 18;
