...
public class t {
    ...
    private static AliNavServiceInterface f15279a;
    ...
    public static <T> T a(Class<T> cls) {
        ...
        T t2 = (T) b(cls);
        if (t2 != null) {
            f15279a = (AliNavServiceInterface) t2;
        }
        return t2;
    }

    public static AliNavServiceInterface a() {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (AliNavServiceInterface) ipChange.ipc$dispatch("9497d1d", new Object[0]);
        }
