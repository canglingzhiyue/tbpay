...
public final class MetaListView$applyListProperties$1 extends Lambda implements rul<Integer, t> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public final /* synthetic */ PartnerRecyclerView $rv;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MetaListView$applyListProperties$1(PartnerRecyclerView partnerRecyclerView) {
        super(1);
    ...
    public final void invoke2(Integer num) {
        ...
        PartnerRecyclerView partnerRecyclerView = this.$rv;
        if (num == null) {
            q.a();
        }
