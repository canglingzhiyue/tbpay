...
public final class GlobalMenuAbilityWrapper extends AbsAbilityWrapper<AbsGlobalMenuAbility> {
    ...
    public GlobalMenuAbilityWrapper(AbsGlobalMenuAbility impl) {
        super(impl);
    ...
    public ExecuteResult execute(String api, als context, Map<String, ? extends Object> params, aln callback) {
        ...
        try {
            getAbilityImpl().show(context, new ay(params), new a(callback));
            return null;
        } catch (Throwable th) {
    ...
    public static final class a implements bw {
        ...
        public final /* synthetic */ aln f8684a;

        public a(aln alnVar) {
            this.f8684a = alnVar;
        }

        @Override // com.taobao.android.abilityidl.ability.bw
        public void a(GlobalMenuMenuClickResult result) {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                ipChange.ipc$dispatch("5bfb246f", new Object[]{this, result});
                return;
            }
            ...
            this.f8684a.a(new FinishResult((JSONObject) json, "onResult"));
        }
