...
public class n extends DXWidgetNode {
    ...
    private String C;
    private double D;
    private com.taobao.android.live.plugin.proxy.debugPanel.a F;
    private String G;
    private String H;
    private boolean I;
    private Object J;
    ...
    private String z = AliSDetailScaleType.centerCrop;
    private TBLiveOpenCardView E = null;
    ...
    public static class a implements ak {
        ...
        public DXWidgetNode build(Object obj) {
            ...
            return ipChange instanceof IpChange ? (DXWidgetNode) ipChange.ipc$dispatch("966917b0", new Object[]{this, obj}) : new n();
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        } else if (dXWidgetNode == null || !(dXWidgetNode instanceof n)) {
        } else {
            super.onClone(dXWidgetNode, z);
            n nVar = (n) dXWidgetNode;
            this.f14175a = nVar.f14175a;
            this.J = nVar.J;
            this.G = nVar.G;
            this.H = nVar.H;
            this.I = nVar.I;
    ...
    public void onRenderView(Context context, View view) {
        ...
        if (frameLayout.getChildCount() > 1 && (frameLayout.getChildAt(1) instanceof com.taobao.android.live.plugin.proxy.debugPanel.a)) {
            frameLayout.removeViewAt(1);
        }
        this.E = (TBLiveOpenCardView) frameLayout.findViewById(10);
        if (this.E == null) {
            this.E = new TBLiveOpenCardView(context);
            this.E.setId(10);
            this.E.setEnableConsumePlayer(false);
            frameLayout.addView(this.E, 0, new FrameLayout.LayoutParams(-1, -1));
        }
        a(frameLayout);
        if (!com.taobao.taolive.sdk.utils.b.d(context)) {
            return;
        }
        com.taobao.android.live.plugin.proxy.f.C().destroyDisplayView(context, this.F);
        this.F = com.taobao.android.live.plugin.proxy.f.C().createDisplayView(context, frameLayout, false);
        JSONObject jSONObject = this.w;
        if (jSONObject == null || this.F == null) {
            return;
        }
        this.F.refreshData((Map) JSONObject.toJavaObject(jSONObject.getJSONObject("modelDebugInfo"), Map.class), (Map) JSONObject.toJavaObject(this.w.getJSONObject("explainDebugInfo"), Map.class));
    }

    private boolean a() {
        int i;
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("56c6c6c", new Object[]{this})).booleanValue() : tee.a() && (i = getDXRuntimeContext().i()) >= 0 && i <= 5;
    }
    ...
    private void a(FrameLayout frameLayout) {
        ...
        if (a5 && tBLiveOpenCardView.getCover() != null && tBLiveOpenCardView.getCover().getDrawable() != null) {
            tBLiveOpenCardView.getCover().setWhenNullClearImg(false);
        }
        if (!this.I) {
            tBLiveOpenCardView.setPlayVideo(this.v);
            tBLiveOpenCardView.setLiveVideo(this.q);
            tBLiveOpenCardView.setEnableConsumePlayer(false);
            tBLiveOpenCardView.setPlayUrl(this.u);
            tBLiveOpenCardView.setVideoLoop(this.B);
            int i = this.d;
            if (i > 0) {
            ...
            if (prr.w() && !pro.e(this.K)) {
                tBLiveOpenCardView.setViewInfoLifeCycleSyncOpenCard(getEngine(), getParentWidget(), this.K);
            }
        }
        if (!pro.e(this.G) && !pro.e(this.H) && tBLiveOpenCardView.getCover() != null) {
            tBLiveOpenCardView.getCover().setStrategyConfig(ImageStrategyConfig.a(this.H, this.G));
        }
        tBLiveOpenCardView.setScaleType(pbh.c(this.z));
    ...
    private void a(TBLiveOpenCardView tBLiveOpenCardView) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            int a2 = pbh.a(this.A);
            if (a2 != -1) {
                tBLiveOpenCardView.setImageResource(pbh.a(this.A));
                return;
            }
            Resources resources = tBLiveOpenCardView.getContext().getResources();
            if (resources != null) {
                a2 = resources.getIdentifier(this.A, com.taobao.share.ui.engine.friend.a.CONTACTS_INFO_NOT_EMPTY_STATUS, tBLiveOpenCardView.getContext().getPackageName());
            }
            if (a2 == -1 || a2 == 0) {
                return;
            }
    ...
    private void c(TBLiveOpenCardView tBLiveOpenCardView) {
        ...
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("ce48168c", new Object[]{this, tBLiveOpenCardView});
        } else if (this.D <= mto.a.GEO_NOT_SUPPORT) {
        } else {
            ...
            ratioFeature.setRatio((float) this.D);
        }
    }
    ...
    public void onSetIntAttribute(long j, int i) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            this.I = z;
        } else if (j == 4881218296263318520L) {
            if (i == 0) {
                z = false;
            }
            this.b = z;
        } else if (j == 3517744115322646514L) {
            if (i == 0) {
                z = false;
            }
            this.c = z;
        } else if (j == 5291123061236748602L) {
            if (i == 0) {
                z = false;
            }
            this.L = z;
            ...
            this.d = i;
        } else if (j == 7153269919816174219L) {
            this.e = i;
        } else if (j == 5266419815834493443L) {
            this.n = i;
    ...
    public String b() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("367c9fd7", new Object[]{this}) : this.m;
    }
}
