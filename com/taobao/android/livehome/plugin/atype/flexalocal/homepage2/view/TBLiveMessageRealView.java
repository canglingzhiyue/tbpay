...
public class TBLiveMessageRealView extends LinearLayout {
    ...
    public static /* synthetic */ int access$000(TBLiveMessageRealView tBLiveMessageRealView) {
        ...
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("a128f47b", new Object[]{tBLiveMessageRealView})).intValue() : tBLiveMessageRealView.maxItem;
    }

    public static /* synthetic */ Handler access$100(TBLiveMessageRealView tBLiveMessageRealView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (Handler) ipChange.ipc$dispatch("70e3f9d", new Object[]{tBLiveMessageRealView}) : tBLiveMessageRealView.handler;
    }

    public static /* synthetic */ JSONObject access$200(TBLiveMessageRealView tBLiveMessageRealView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (JSONObject) ipChange.ipc$dispatch("3ab15faa", new Object[]{tBLiveMessageRealView}) : tBLiveMessageRealView.mShowMaidian;
    }

    public static /* synthetic */ int access$300(TBLiveMessageRealView tBLiveMessageRealView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("304e907e", new Object[]{tBLiveMessageRealView})).intValue() : tBLiveMessageRealView.index;
    }

    public static /* synthetic */ int access$302(TBLiveMessageRealView tBLiveMessageRealView, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("9a878389", new Object[]{tBLiveMessageRealView, new Integer(i)})).intValue();
        }
    ...
    public static /* synthetic */ int access$308(TBLiveMessageRealView tBLiveMessageRealView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("72809286", new Object[]{tBLiveMessageRealView})).intValue();
        }
    ...
    public static /* synthetic */ JSONArray access$400(TBLiveMessageRealView tBLiveMessageRealView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (JSONArray) ipChange.ipc$dispatch("2b23c432", new Object[]{tBLiveMessageRealView}) : tBLiveMessageRealView.mCommentInfos;
    }

    public static /* synthetic */ int access$500(TBLiveMessageRealView tBLiveMessageRealView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("8fbcf880", new Object[]{tBLiveMessageRealView})).intValue() : tBLiveMessageRealView.mShowBarrageTime;
    }
    ...
    public TBLiveMessageRealView(Context context) {
        ...
        this.index = 0;
        this.handler = new Handler() { // from class: com.taobao.android.livehome.plugin.atype.flexalocal.homepage2.view.TBLiveMessageRealView.2
            public static volatile transient /* synthetic */ IpChange $ipChange;
    ...
    public void setAnimateView(View view) {
        ...
        ofFloat.addListener(new AnimatorListenerAdapter() { // from class: com.taobao.android.livehome.plugin.atype.flexalocal.homepage2.view.TBLiveMessageRealView.1
            public static volatile transient /* synthetic */ IpChange $ipChange;
