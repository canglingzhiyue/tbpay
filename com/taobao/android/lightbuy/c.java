...
public class c implements g {
    ...
    private final WeakReference<FragmentActivity> f13283a;
    ...
    public c(FragmentActivity fragmentActivity) {
        this.f13283a = new WeakReference<>(fragmentActivity);
    }
    ...
    public void onRenderFailed(p pVar, int i, String str, boolean z) {
        ...
        } else if (this.f13283a.get() == null) {
        } else {
            String valueOf = String.valueOf(i);
            b.a(this.f13283a.get(), valueOf, "onRenderFailed" + str);
        }
    }
    ...
    public void onRefreshFailed(p pVar, int i, String str, boolean z) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            String valueOf = String.valueOf(i);
            b.a(this.f13283a.get(), valueOf, "onRefreshFailed" + str);
        }
    }
    ...
    public void onFatalException(p pVar, int i, String str) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            String valueOf = String.valueOf(i);
            b.a(this.f13283a.get(), valueOf, "onFatalException" + str);
        }
    }
}
