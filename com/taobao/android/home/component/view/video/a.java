...
public class a extends AsyncTask<String, Void, Boolean> {
    ...
    private final String f12761a = "DownloadVideoTask";
    ...
    public Boolean a(String... strArr) {
        ...
        if (syncSend.getStatusCode() == 200 && syncSend.getBytedata() != null && syncSend.getBytedata().length > 0) {
            try {
                ...
                com.taobao.android.home.component.utils.e.e("DownloadVideoTask", "DownloadVideoTask downLoadVideo saveResult:" + a3 + " isEnableHVideoViewOptimise:" + j.k() + " filePath:" + a2 + " success; url:" + this.c);
                if (!a3) {
                    File file = new File(a2);
                    if (file.exists()) {
                        com.taobao.android.home.component.utils.e.e("DownloadVideoTask", "DownloadVideoTask", "ErrorDownloadFile");
                ...
                com.taobao.android.home.component.utils.e.a("DownloadVideoTask", "DownloadVideoTask", th);
            }
        }
        return false;
    }
    ...
    public void a(Boolean bool) {
        ...
        com.taobao.android.home.component.utils.e.e("DownloadVideoTask", "DownloadVideoTask onPostExecute ret:" + bool + "  url:" + this.c);
        b bVar = this.b.get();
        if (bVar == null) {
            com.taobao.android.home.component.utils.e.e("DownloadVideoTask", "onPostExecute videoDownLoadListener is null");
