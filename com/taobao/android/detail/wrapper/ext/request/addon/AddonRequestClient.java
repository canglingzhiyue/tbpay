...
public class AddonRequestClient extends AbsMtopRequestClient<AddonParams, AddonModel> {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    private static final String TAG = "AddonRequestClient";

    static {
        kge.a(-943912418);
    }

    public static /* synthetic */ Object ipc$super(AddonRequestClient addonRequestClient, String str, Object... objArr) {
    ...
    public String getApiName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("8523c6ca", new Object[]{this}) : "mtop.tmall.detail.addon";
    }
    ...
    public AddonRequestClient() {
        emu.a("com.taobao.android.detail.wrapper.ext.request.addon.AddonRequestClient");
    }
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        AddonModelOutDo_ addonModelOutDo_ = baseOutDo != null ? (AddonModelOutDo_) baseOutDo : null;
        a aVar = (a) this.mRequestListenerRef.get();
        if (aVar == null) {
            return;
        }
        try {
            if (addonModelOutDo_ != null) {
                aVar.onSuccess(addonModelOutDo_.mo2429getData());
            } else {
                aVar.onSuccess(null);
            }
        } catch (Throwable th) {
    ...
    public void sendRequest(RemoteBusiness remoteBusiness) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            remoteBusiness.startRequest(AddonModelOutDo_.class);
        }
    }
}
