...
public class TouchImageView extends DetailImageView {
    ...
    public static class c extends TimerTask {
        ...
        private WeakReference<Handler> f10206a;

        public c(Handler handler) {
            this.f10206a = new WeakReference<>(handler);
        }
        ...
        public void run() {
            ...
            Handler handler = this.f10206a.get();
            if (handler == null) {
                return;
            }
    ...
    public static class d extends Handler {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final WeakReference<TouchImageView> f10207a;

        public d(TouchImageView touchImageView) {
            this.f10207a = new WeakReference<>(touchImageView);
        }
        ...
        public void handleMessage(Message message) {
            ...
            } else if (message.what != 10 || this.f10207a.get() == null) {
            } else {
                this.f10207a.get().performClick();
                if (TouchImageView.access$1700(this.f10207a.get()) == null) {
                    return;
                }
                TouchImageView.access$1700(this.f10207a.get()).onClick(this.f10207a.get());
            }
        }
    }
    ...
    public static /* synthetic */ Object access$100(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ipChange.ipc$dispatch("58239cec", new Object[]{touchImageView}) : touchImageView.mScaleDetector;
    }

    public static /* synthetic */ void access$1000(TouchImageView touchImageView, float f, float f2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("8ed6b6d8", new Object[]{touchImageView, new Float(f), new Float(f2)});
        } else {
            touchImageView.checkAndSetTranslate(f, f2);
        }
    }

    public static /* synthetic */ Handler access$1100(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (Handler) ipChange.ipc$dispatch("899054af", new Object[]{touchImageView}) : touchImageView.mTimerHandler;
    }

    public static /* synthetic */ void access$1200(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("f41d9c96", new Object[]{touchImageView});
        } else {
            touchImageView.scaleMatrixToBounds();
        }
    }

    public static /* synthetic */ float access$1300(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("727ea065", new Object[]{touchImageView})).floatValue() : touchImageView.mTouchSlop;
    }

    public static /* synthetic */ double access$1400(TouchImageView touchImageView, PointF pointF, PointF pointF2) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("5eb71522", new Object[]{touchImageView, pointF, pointF2})).doubleValue() : touchImageView.distanceBetween(pointF, pointF2);
    }

    public static /* synthetic */ PointF access$1500(TouchImageView touchImageView, MotionEvent motionEvent) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (PointF) ipChange.ipc$dispatch("ed17b4bf", new Object[]{touchImageView, motionEvent}) : touchImageView.midPointF(motionEvent);
    }

    public static /* synthetic */ void access$1600(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("eda1ac12", new Object[]{touchImageView});
        } else {
            touchImageView.checkSiding();
        }
    }

    public static /* synthetic */ View.OnClickListener access$1700(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (View.OnClickListener) ipChange.ipc$dispatch("37e6271a", new Object[]{touchImageView}) : touchImageView.mOnClickListener;
    }

    public static /* synthetic */ int access$1800(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("ea63b3c3", new Object[]{touchImageView})).intValue() : touchImageView.getWindowAttachCount();
    }

    public static /* synthetic */ int access$1900(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("68c4b7a2", new Object[]{touchImageView})).intValue() : touchImageView.getWindowAttachCount();
    }

    public static /* synthetic */ void access$200(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("30c2aae5", new Object[]{touchImageView});
        } else {
    ...
    public static /* synthetic */ boolean access$300(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("af23aec8", new Object[]{touchImageView})).booleanValue() : touchImageView.mHasPerformedLongPress;
    }

    public static /* synthetic */ boolean access$302(TouchImageView touchImageView, boolean z) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("1c71e516", new Object[]{touchImageView, new Boolean(z)})).booleanValue();
        }
    ...
    public static /* synthetic */ void access$400(TouchImageView touchImageView, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("831214c0", new Object[]{touchImageView, new Integer(i)});
        } else {
            touchImageView.checkForLongClick(i);
        }
    }

    public static /* synthetic */ float access$500(TouchImageView touchImageView, MotionEvent motionEvent) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("b1843207", new Object[]{touchImageView, motionEvent})).floatValue() : touchImageView.spacing(motionEvent);
    }

    public static /* synthetic */ void access$600(TouchImageView touchImageView, PointF pointF, MotionEvent motionEvent) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("6e8e909b", new Object[]{touchImageView, pointF, motionEvent});
        } else {
            touchImageView.midPoint(pointF, motionEvent);
        }
    }

    public static /* synthetic */ boolean access$702(TouchImageView touchImageView, boolean z) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("536fc51a", new Object[]{touchImageView, new Boolean(z)})).booleanValue();
        }
        touchImageView.mEnableLongClick = z;
        return z;
    }

    public static /* synthetic */ Timer access$800(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (Timer) ipChange.ipc$dispatch("73aef40b", new Object[]{touchImageView}) : touchImageView.mClickTimer;
    }

    public static /* synthetic */ Timer access$802(TouchImageView touchImageView, Timer timer) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (Timer) ipChange.ipc$dispatch("e6c558eb", new Object[]{touchImageView, timer});
        }
        touchImageView.mClickTimer = timer;
        return timer;
    }

    public static /* synthetic */ void access$900(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("a569c5fe", new Object[]{touchImageView});
        } else {
    ...
    public void init() {
        ...
        setOnTouchListener(new View.OnTouchListener() { // from class: com.taobao.android.detail.mainpic.widget.TouchImageView.1
            public static volatile transient /* synthetic */ IpChange $ipChange;
            ...
            */
            public boolean onTouch(android.view.View r12, android.view.MotionEvent r13) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: com.taobao.android.detail.mainpic.widget.TouchImageView.AnonymousClass1.onTouch(android.view.View, android.view.MotionEvent):boolean");
            }
        });
    }
    ...
    */
    private void checkAndSetTranslate(float r6, float r7) {
        /*
            r5 = this;
            com.android.alibaba.ip.runtime.IpChange r0 = com.taobao.android.detail.mainpic.widget.TouchImageView.$ipChange
        ...
        La0:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.android.detail.mainpic.widget.TouchImageView.checkAndSetTranslate(float, float):void");
    }
    ...
    */
    private void checkSiding() {
        ...
        L76:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.android.detail.mainpic.widget.TouchImageView.checkSiding():void");
    }
    ...
    private PointF midPointF(MotionEvent motionEvent) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (PointF) ipChange.ipc$dispatch("1c57aab1", new Object[]{this, motionEvent}) : new PointF((motionEvent.getX(0) + motionEvent.getX(1)) / 2.0f, (motionEvent.getY(0) + motionEvent.getY(1)) / 2.0f);
    }
        ...
        */
        public boolean onScale(android.view.ScaleGestureDetector r10) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: com.taobao.android.detail.mainpic.widget.TouchImageView.b.onScale(android.view.ScaleGestureDetector):boolean");
        }
    }
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            if (ipChange instanceof IpChange) {
                ipChange.ipc$dispatch("5c510192", new Object[]{this});
            } else if (!TouchImageView.this.isPressed() || TouchImageView.this.getParent() == null || this.b != TouchImageView.access$1800(TouchImageView.this)) {
            } else {
        ...
        public void a() {
            ...
            if (ipChange instanceof IpChange) {
                ...
                this.b = TouchImageView.access$1900(TouchImageView.this);
            }
        }
    }
    ...
    public boolean enableLongClick() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("f52a8234", new Object[]{this})).booleanValue() : this.mEnableLongClick;
    }
}
