...
public class MarketBagPriceRequestClient extends AbsMtopRequestClient<Object, MarketBagPrice> {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    private static final String TAG = "MarketBagPriceRequestClient";

    static {
        kge.a(903799114);
    }

    public static /* synthetic */ Object ipc$super(MarketBagPriceRequestClient marketBagPriceRequestClient, String str, Object... objArr) {
    ...
    public String getApiName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("8523c6ca", new Object[]{this}) : "mtop.trade.queryBagPrice";
    }

    @Override // com.taobao.android.trade.boost.request.mtop.AbsMtopRequestClient
    public String getApiVersion() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("44c0ca25", new Object[]{this}) : "1.2";
    }
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        MarketBagPriceOutDo_ marketBagPriceOutDo_ = baseOutDo != null ? (MarketBagPriceOutDo_) baseOutDo : null;
        ...
        try {
            if (marketBagPriceOutDo_ != null) {
                aVar.onSuccess(marketBagPriceOutDo_.mo2429getData());
            } else {
                aVar.onSuccess(null);
            }
        } catch (Throwable th) {
    ...
    public void sendRequest(RemoteBusiness remoteBusiness) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            remoteBusiness.startRequest(MarketBagPriceOutDo_.class);
        }
    }
}
