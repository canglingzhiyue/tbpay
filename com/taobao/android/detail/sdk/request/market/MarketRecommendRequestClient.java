...
public class MarketRecommendRequestClient extends AbsMtopRequestClient<a, MarketRecommendData> {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    private static final String TAG = "MarketRecommendRequestClient";

    static {
        kge.a(-625582259);
    }

    public static /* synthetic */ Object ipc$super(MarketRecommendRequestClient marketRecommendRequestClient, String str, Object... objArr) {
    ...
    public String getApiName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("8523c6ca", new Object[]{this}) : "mtop.taobao.weitao.venue.recommend.tbosimrec";
    }
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        MarketRecommendDataOutDo_ marketRecommendDataOutDo_ = baseOutDo != null ? (MarketRecommendDataOutDo_) baseOutDo : null;
        ...
        try {
            if (marketRecommendDataOutDo_ != null) {
                aVar.onSuccess(marketRecommendDataOutDo_.mo2429getData());
            } else {
                aVar.onSuccess(null);
            }
        } catch (Throwable th) {
    ...
    public void sendRequest(RemoteBusiness remoteBusiness) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            remoteBusiness.startRequest(MarketRecommendDataOutDo_.class);
        }
    }
}
