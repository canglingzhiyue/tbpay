...
public class RemindJhsRequestClient extends AbsMtopRequestClient<RemindJhsRequestParams, RemindResult> {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    private static final String TAG = "RemindJhsRequestClient";

    static {
        kge.a(1220056804);
    }

    public static /* synthetic */ Object ipc$super(RemindJhsRequestClient remindJhsRequestClient, String str, Object... objArr) {
    ...
    public String getApiName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("8523c6ca", new Object[]{this}) : "mtop.ju.user.collection.add";
    }
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        RemindResultOutDo_ remindResultOutDo_ = baseOutDo != null ? (RemindResultOutDo_) baseOutDo : null;
        a aVar = (a) this.mRequestListenerRef.get();
        if (aVar == null) {
            return;
        }
        try {
            if (remindResultOutDo_ != null) {
                aVar.onSuccess(remindResultOutDo_.mo2429getData());
            } else {
                aVar.onSuccess(null);
            }
        } catch (Throwable th) {
    ...
    public void sendRequest(RemoteBusiness remoteBusiness) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            remoteBusiness.startRequest(RemindResultOutDo_.class);
        }
    }
}
