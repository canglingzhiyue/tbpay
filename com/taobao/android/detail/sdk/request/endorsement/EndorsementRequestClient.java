...
public class EndorsementRequestClient extends AbsMtopRequestClient<EndorsementRequestParams, EndorsementResult> {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    private static final String TAG = "EndorsementRequestClient";

    static {
        kge.a(-2112355955);
    }

    public static /* synthetic */ Object ipc$super(EndorsementRequestClient endorsementRequestClient, String str, Object... objArr) {
    ...
    public String getApiName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("8523c6ca", new Object[]{this}) : "mtop.tmall.hk.seller.endorsement.getShopEndorsement";
    }
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        EndorsementResultOutDo_ endorsementResultOutDo_ = baseOutDo != null ? (EndorsementResultOutDo_) baseOutDo : null;
        a aVar = (a) this.mRequestListenerRef.get();
        if (aVar == null) {
            return;
        }
        try {
            if (endorsementResultOutDo_ != null) {
                aVar.onSuccess(endorsementResultOutDo_.mo2429getData());
            } else {
                aVar.onSuccess(null);
            }
        } catch (Throwable th) {
    ...
    public void sendRequest(RemoteBusiness remoteBusiness) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            remoteBusiness.startRequest(EndorsementResultOutDo_.class);
        }
    }
}
