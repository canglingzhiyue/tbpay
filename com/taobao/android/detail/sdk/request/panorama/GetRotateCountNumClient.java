...
import com.taobao.android.detail.sdk.model.network.panorama.GetRotateCountNumModelOutDo_;
...
public class GetRotateCountNumClient extends AbsMtopRequestClient<Object, GetRotateCountNumModel> {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    private static final String TAG = "GetRotateCountNumClient";

    static {
        kge.a(-67852135);
    }

    public static /* synthetic */ Object ipc$super(GetRotateCountNumClient getRotateCountNumClient, String str, Object... objArr) {
    ...
    public String getApiName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("8523c6ca", new Object[]{this}) : "mtop.mediaplatform.panorama.rotate.get";
    }
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        GetRotateCountNumModelOutDo_ getRotateCountNumModelOutDo_ = baseOutDo != null ? (GetRotateCountNumModelOutDo_) baseOutDo : null;
        a aVar = (a) this.mRequestListenerRef.get();
        if (aVar == null) {
            return;
        }
        try {
            if (getRotateCountNumModelOutDo_ != null) {
                aVar.onSuccess(getRotateCountNumModelOutDo_.mo2429getData());
            } else {
                aVar.onSuccess(null);
            }
        } catch (Throwable th) {
    ...
    public void sendRequest(RemoteBusiness remoteBusiness) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            remoteBusiness.startRequest(GetRotateCountNumModelOutDo_.class);
        }
    }
}
