...
public class DivaExtraRelationRequestClient extends AbsMtopRequestClient<DivaExtraRelationRequest, DivaExtraRelation> {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    private static final String TAG = "DivaExtraRelationRequestClient";

    static {
        kge.a(-872698467);
    }

    public static /* synthetic */ Object ipc$super(DivaExtraRelationRequestClient divaExtraRelationRequestClient, String str, Object... objArr) {
    ...
    public String getApiName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("8523c6ca", new Object[]{this}) : "mtop.taobao.diva.extra.relation.query";
    }
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        DivaExtraRelationOutDo_ divaExtraRelationOutDo_ = baseOutDo != null ? (DivaExtraRelationOutDo_) baseOutDo : null;
        a aVar = (a) this.mRequestListenerRef.get();
        if (aVar == null) {
            return;
        }
        try {
            if (divaExtraRelationOutDo_ != null) {
                aVar.onSuccess(divaExtraRelationOutDo_.mo2429getData());
            } else {
                aVar.onSuccess(null);
            }
        } catch (Throwable th) {
    ...
    public void sendRequest(RemoteBusiness remoteBusiness) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            remoteBusiness.startRequest(DivaExtraRelationOutDo_.class);
        }
    }
}
