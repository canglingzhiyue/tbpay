...
public class CouponListRequestClient extends AbsMtopRequestClient<CouponListRequestParams, CouponListResult> {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    private static final String TAG = "CouponListRequestClient";

    static {
        kge.a(2063098285);
    }

    public static /* synthetic */ Object ipc$super(CouponListRequestClient couponListRequestClient, String str, Object... objArr) {
    ...
    public String getApiName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("8523c6ca", new Object[]{this}) : "mtop.shop.querybuyerbonus";
    }
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        CouponListResultOutDo_ couponListResultOutDo_ = baseOutDo != null ? (CouponListResultOutDo_) baseOutDo : null;
        a aVar = (a) this.mRequestListenerRef.get();
        if (aVar == null) {
            return;
        }
        try {
            if (couponListResultOutDo_ != null) {
                aVar.onSuccess(couponListResultOutDo_.mo2429getData());
            } else {
                aVar.onSuccess(null);
            }
        } catch (Throwable th) {
    ...
    public void sendRequest(RemoteBusiness remoteBusiness) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            remoteBusiness.startRequest(CouponListResultOutDo_.class);
        }
    }
}
