...
public abstract class AbsFactoryManager<T> {
    ...
    public FactoryComparator f10245a = new FactoryComparator();

    static {
        kge.a(878887950);
    }

    public AbsFactoryManager() {
        tpc.a("com.taobao.android.detail.sdk.factory.manager.AbsFactoryManager");
    }
    ...
    public <E> void a(E e, int i, ArrayList<Pair<Integer, E>> arrayList) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            Collections.sort(arrayList, this.f10245a);
        }
    }
