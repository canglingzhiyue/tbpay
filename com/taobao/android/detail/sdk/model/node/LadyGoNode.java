...
public class LadyGoNode extends DetailNode {
    ...
    public LadyGoNode(JSONObject jSONObject) {
        ...
        this.brandSupply = c.a(jSONObject.getString("brandSupply"));
        Integer integer = jSONObject.getInteger("status");
        if (integer != null) {
            this.status = integer.intValue();
        }
        this.mainPrice = c.a(jSONObject.getString("mainPrice"));
        this.tagPrice = c.a(jSONObject.getString("tagPrice"));
        this.tagPriceTitle = c.a(jSONObject.getString("tagPriceTitle"));
        this.tags = initTags();
        this.collection = jSONObject.getBooleanValue("collection");
        tpc.a("com.taobao.android.detail.sdk.model.node.LadyGoNode");
    }

    private ArrayList<String> initTags() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (ArrayList) ipChange.ipc$dispatch("4806d92a", new Object[]{this}) : c.a(this.root.getJSONArray("tags"), new g<String>() { // from class: com.taobao.android.detail.sdk.model.node.LadyGoNode.1
            public static volatile transient /* synthetic */ IpChange $ipChange;
