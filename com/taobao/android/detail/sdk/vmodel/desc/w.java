...
public class w extends e {
    ...
    public int getViewModelType() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("7e14bda2", new Object[]{this})).intValue() : ewy.T_SERVICE;
    }

    public w(ComponentModel componentModel) {
        super(componentModel);
        tpc.a("com.taobao.android.detail.sdk.vmodel.desc.ServiceViewModel");
    }
    ...
    public void a(JSONObject jSONObject) {
        ...
        this.f10397a = jSONObject.getString("iconUrl");
