...
public class ac extends e {
    ...
    public int getViewModelType() {
        ...
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("7e14bda2", new Object[]{this})).intValue() : ewy.T_VESSEL;
    }

    public ac(ComponentModel componentModel) {
        super(componentModel);
        tpc.a("com.taobao.android.detail.sdk.vmodel.desc.VesselViewModel");
    }
    ...
    public void a(JSONObject jSONObject) {
        ...
        this.f10361a = jSONObject.getString("url");
    ...
    public boolean a() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("56c6c6c", new Object[]{this})).booleanValue() : StringUtils.isEmpty(this.f10361a);
    }
}
