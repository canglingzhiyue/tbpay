...
public class s extends e {
    ...
    public int getViewModelType() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("7e14bda2", new Object[]{this})).intValue() : ewy.T_PICTURE_JUMPER;
    }

    public s(ComponentModel componentModel) {
        super(componentModel);
        tpc.a("com.taobao.android.detail.sdk.vmodel.desc.PictureJumperViewModel");
    }
    ...
    public void a(JSONObject jSONObject) {
        ...
        this.f10391a = jSONObject.getString("actPicUrl");
