...
public class TouchImageView extends DetailImageView {
    ...
    public static /* synthetic */ Object access$100(TouchImageView touchImageView) {
        ...
        return ipChange instanceof IpChange ? ipChange.ipc$dispatch("5d9c3e0d", new Object[]{touchImageView}) : touchImageView.mScaleDetector;
    }
    ...
    public static /* synthetic */ Handler access$1200(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (Handler) ipChange.ipc$dispatch("c356f871", new Object[]{touchImageView}) : touchImageView.mTimerHandler;
    }
    ...
    public static /* synthetic */ double access$1400(TouchImageView touchImageView, PointF pointF, PointF pointF2) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("5f6d645", new Object[]{touchImageView, pointF, pointF2})).doubleValue() : touchImageView.distanceBetween(pointF, pointF2);
    }

    public static /* synthetic */ PointF access$1500(TouchImageView touchImageView, e eVar) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (PointF) ipChange.ipc$dispatch("79dac65c", new Object[]{touchImageView, eVar}) : touchImageView.midPointF(eVar);
    }
    ...
    public static /* synthetic */ View.OnClickListener access$1800(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (View.OnClickListener) ipChange.ipc$dispatch("f7ff00e4", new Object[]{touchImageView}) : touchImageView.mOnClickListener;
    }

    public static /* synthetic */ int access$1900(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("c408722f", new Object[]{touchImageView})).intValue() : touchImageView.getWindowAttachCount();
    }
    ...
    public static /* synthetic */ View.OnLongClickListener access$2000(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (View.OnLongClickListener) ipChange.ipc$dispatch("31dbb0d7", new Object[]{touchImageView}) : touchImageView.mOnSinglePointLongClickListener;
    }

    public static /* synthetic */ int access$2100(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("eeef2c46", new Object[]{touchImageView})).intValue() : touchImageView.getWindowAttachCount();
    }

    public static /* synthetic */ boolean access$300(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("268de7cb", new Object[]{touchImageView})).booleanValue() : touchImageView.mHasPerformedLongPress;
    }
    ...
    public static /* synthetic */ PointF access$400(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (PointF) ipChange.ipc$dispatch("ff42b9ff", new Object[]{touchImageView}) : touchImageView.mDragDistance;
    }

    public static /* synthetic */ int access$500(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("e78093bc", new Object[]{touchImageView})).intValue() : touchImageView.mDownPointCount;
    }
    ...
    public static /* synthetic */ float access$700(TouchImageView touchImageView, e eVar) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("b7086462", new Object[]{touchImageView, eVar})).floatValue() : touchImageView.spacing(eVar);
    }

    public static /* synthetic */ void access$800(TouchImageView touchImageView, PointF pointF, e eVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("42093d42", new Object[]{touchImageView, pointF, eVar});
        } else {
            touchImageView.midPoint(pointF, eVar);
        }
    }

    public static /* synthetic */ Timer access$900(TouchImageView touchImageView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (Timer) ipChange.ipc$dispatch("640f01b9", new Object[]{touchImageView}) : touchImageView.mClickTimer;
    }
    ...
    public void init() {
        ...
        setOnTouchListener(new View.OnTouchListener() { // from class: com.taobao.android.detail.ttdetail.widget.desc.picgallery.TouchImageView.1
            ...
            */
            public boolean onTouch(android.view.View r10, android.view.MotionEvent r11) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: com.taobao.android.detail.ttdetail.widget.desc.picgallery.TouchImageView.AnonymousClass1.onTouch(android.view.View, android.view.MotionEvent):boolean");
            }
        });
    }
    ...
    */
    private void checkSiding() {
        ...
        L76:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.android.detail.ttdetail.widget.desc.picgallery.TouchImageView.checkSiding():void");
    }
    ...
    private float spacing(e eVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("efc2d543", new Object[]{this, eVar})).floatValue();
        }
    ...
    private void midPoint(PointF pointF, e eVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("d94a0fe5", new Object[]{this, pointF, eVar});
        } else {
            pointF.set((eVar.a(0) + eVar.a(1)) / 2.0f, (eVar.b(0) + eVar.b(1)) / 2.0f);
        }
    }

    private PointF midPointF(e eVar) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (PointF) ipChange.ipc$dispatch("c4c2e00f", new Object[]{this, eVar}) : new PointF((eVar.a(0) + eVar.a(1)) / 2.0f, (eVar.b(0) + eVar.b(1)) / 2.0f);
    }
    ...
    public static class c extends TimerTask {
        ...
        private WeakReference<Handler> f11014a;
        ...
        public c(Handler handler) {
            this.f11014a = new WeakReference<>(handler);
        }
        ...
        public void run() {
            ...
            Handler handler = this.f11014a.get();
            if (handler == null) {
                return;
            }
        ...
        */
        public boolean onScale(android.view.ScaleGestureDetector r10) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: com.taobao.android.detail.ttdetail.widget.desc.picgallery.TouchImageView.b.onScale(android.view.ScaleGestureDetector):boolean");
        }
    }
    ...
    public static class d extends Handler {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final WeakReference<TouchImageView> f11015a;
        ...
        public static /* synthetic */ void a(d dVar, TouchImageView touchImageView) {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                ipChange.ipc$dispatch("56315e42", new Object[]{dVar, touchImageView});
            } else {
        ...
        public d(TouchImageView touchImageView) {
            this.f11015a = new WeakReference<>(touchImageView);
        }
        ...
        public void handleMessage(Message message) {
            ...
            } else if (message.what != 10 || (touchImageView = this.f11015a.get()) == null) {
            } else {
                if (getLooper() == Looper.getMainLooper()) {
                    a(touchImageView);
                } else {
                    touchImageView.post(new Runnable() { // from class: com.taobao.android.detail.ttdetail.widget.desc.picgallery.TouchImageView.d.1
                        public static volatile transient /* synthetic */ IpChange $ipChange;
        ...
        private void a(TouchImageView touchImageView) {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                ipChange.ipc$dispatch("89e18975", new Object[]{this, touchImageView});
                return;
            }
