...
public class PhotoView extends AppCompatImageView {
    ...
    public k getAttacher() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (k) ipChange.ipc$dispatch("17093745", new Object[]{this}) : this.attacher;
    }

    @Override // android.widget.ImageView
    public ImageView.ScaleType getScaleType() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (ImageView.ScaleType) ipChange.ipc$dispatch("16d492db", new Object[]{this}) : this.attacher.h();
    }

    @Override // android.widget.ImageView
    public Matrix getImageMatrix() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (Matrix) ipChange.ipc$dispatch("83fe98d9", new Object[]{this}) : this.attacher.k();
    }
    ...
    public boolean isZoomable() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("73d17002", new Object[]{this})).booleanValue() : this.attacher.i();
    }
    ...
    public RectF getDisplayRect() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (RectF) ipChange.ipc$dispatch("c7965670", new Object[]{this}) : this.attacher.c();
    }
    ...
    public float getMinimumScale() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("ccdbffc9", new Object[]{this})).floatValue() : this.attacher.d();
    }

    public float getMediumScale() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("ad95ce96", new Object[]{this})).floatValue() : this.attacher.e();
    }

    public float getMaximumScale() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("d0aa8df7", new Object[]{this})).floatValue() : this.attacher.f();
    }

    public float getScale() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("8f6c4a0b", new Object[]{this})).floatValue() : this.attacher.g();
    }
    ...
    public void setOnMatrixChangeListener(d dVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("70d3a200", new Object[]{this, dVar});
        } else {
    ...
    public void setOnPhotoTapListener(f fVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("a2c9c8fe", new Object[]{this, fVar});
        } else {
    ...
    public void setOnOutsidePhotoTapListener(e eVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("35b1c61c", new Object[]{this, eVar});
        } else {
    ...
    public void setOnViewTapListener(j jVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("f7d44e0f", new Object[]{this, jVar});
        } else {
    ...
    public void setOnViewDragListener(i iVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("b5d08fb3", new Object[]{this, iVar});
        } else {
    ...
    public void setOnScaleChangeListener(g gVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("d828b016", new Object[]{this, gVar});
        } else {
    ...
    public void setOnSingleFlingListener(h hVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("891bc1db", new Object[]{this, hVar});
        } else {
