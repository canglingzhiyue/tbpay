...
public class b {
    ...
    public static /* synthetic */ c a(b bVar) {
        ...
        return ipChange instanceof IpChange ? (c) ipChange.ipc$dispatch("c9492c5", new Object[]{bVar}) : bVar.l;
    }
    ...
    public b(Context context, c cVar) {
        ...
        this.l = cVar;
        this.c = new ScaleGestureDetector(context, new ScaleGestureDetector.OnScaleGestureListener() { // from class: com.taobao.android.detail.ttdetail.widget.photoview.b.1
            public static volatile transient /* synthetic */ IpChange $ipChange;
    ...
    private boolean d(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            this.f11037a = motionEvent.getPointerId(0);
            ...
            if (motionEvent.getPointerId(a2) == this.f11037a) {
                int i = a2 == 0 ? 1 : 0;
                this.f11037a = motionEvent.getPointerId(i);
