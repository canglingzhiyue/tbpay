...
public class l {
    ...
    /* renamed from: com.taobao.android.detail.ttdetail.widget.photoview.l$1  reason: invalid class name */
    /* loaded from: classes5.dex */
    public static /* synthetic */ class AnonymousClass1 {

        /* renamed from: a  reason: collision with root package name */
        public static final /* synthetic */ int[] f11046a = new int[ImageView.ScaleType.values().length];

        static {
            try {
                f11046a[ImageView.ScaleType.MATRIX.ordinal()] = 1;
    ...
    public static boolean a(ImageView.ScaleType scaleType) {
        ...
        if (AnonymousClass1.f11046a[scaleType.ordinal()] == 1) {
