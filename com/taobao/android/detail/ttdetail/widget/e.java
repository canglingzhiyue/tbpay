...
public class e extends Drawable implements Animatable {
    ...
    private static final Interpolator f11026a;
    ...
    private Property<e, Float> m = new Property<e, Float>(Float.class, "angle") { // from class: com.taobao.android.detail.ttdetail.widget.e.1
        public static volatile transient /* synthetic */ IpChange $ipChange;

        /* JADX WARN: Type inference failed for: r4v4, types: [java.lang.Float, java.lang.Object] */
        @Override // android.util.Property
        public /* synthetic */ Float get(e eVar) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? ipChange.ipc$dispatch("83ba8cd9", new Object[]{this, eVar}) : a(eVar);
        }
        ...
        public /* synthetic */ void set(e eVar, Float f) {
            ...
            if (ipChange instanceof IpChange) {
                ipChange.ipc$dispatch("6f806021", new Object[]{this, eVar, f});
            } else {
                a(eVar, f);
            }
        }
        ...
        public Float a(e eVar) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? (Float) ipChange.ipc$dispatch("829bb395", new Object[]{this, eVar}) : Float.valueOf(eVar.a());
        }

        public void a(e eVar, Float f) {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                ipChange.ipc$dispatch("4dedee0d", new Object[]{this, eVar, f});
            } else {
                eVar.a(f.floatValue());
            }
        }
    };
    private Property<e, Float> n = new Property<e, Float>(Float.class, "arc") { // from class: com.taobao.android.detail.ttdetail.widget.e.2
        public static volatile transient /* synthetic */ IpChange $ipChange;
        ...
        public Float a(e eVar) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? (Float) ipChange.ipc$dispatch("829bb395", new Object[]{this, eVar}) : Float.valueOf(eVar.b());
        }
    ...
    public static /* synthetic */ void a(e eVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("89a9974c", new Object[]{eVar});
        } else {
            eVar.c();
        }
    }
    ...
    static {
        kge.a(-1465837520);
        kge.a(-310707797);
        f11026a = new LinearInterpolator();
    ...
    private void d() {
        ...
        this.e.setInterpolator(f11026a);
        ...
        this.d.addListener(new Animator.AnimatorListener() { // from class: com.taobao.android.detail.ttdetail.widget.e.3
            public static volatile transient /* synthetic */ IpChange $ipChange;
