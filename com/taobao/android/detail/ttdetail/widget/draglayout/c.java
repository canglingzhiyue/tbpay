...
public class c {
    ...
    private int c = -1;
    private final Runnable w = new Runnable() { // from class: com.taobao.android.detail.ttdetail.widget.draglayout.c.2
    ...
    public static abstract class a {
        ...
        public int b(int i) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("a9d66c2d", new Object[]{this, new Integer(i)})).intValue() : i;
        }
    ...
    static {
        kge.a(-1892518016);
        v = new Interpolator() { // from class: com.taobao.android.detail.ttdetail.widget.draglayout.c.1
            public static volatile transient /* synthetic */ IpChange $ipChange;
    ...
    public static c a(ViewGroup viewGroup, a aVar) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (c) ipChange.ipc$dispatch("8135d1ac", new Object[]{viewGroup, aVar}) : new c(y.a(viewGroup), viewGroup, aVar);
    }
    ...
    public void b() {
        ...
        if (this.f11024a == 2) {
            ...
            this.r.a(this.s, false, currX2, currY2, currX2 - currX, currY2 - currY);
        }
        b(0);
    }
    ...
    public boolean a(View view, int i, int i2) {
        ...
        if (!a2 && this.f11024a == 0 && this.s != null) {
            this.s = null;
        }
        return a2;
    }
    ...
    private boolean a(int i, int i2, int i3, int i4) {
        ...
        int left = (this.s.getLeft() + this.s.getRight()) >> 1;
        int top = (this.s.getTop() + this.s.getBottom()) >> 1;
        int i5 = i - left;
        int i6 = i2 - top;
        if (i5 == 0 && i6 == 0) {
            this.q.abortAnimation();
    ...
    private float a(float f) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("a8218848", new Object[]{this, new Float(f)})).floatValue() : (float) Math.sin((f - 0.5f) * 0.47123894f);
    }
    ...
    public boolean a(boolean z) {
        ...
        if (this.f11024a == 2) {
            ...
            int currX = this.q.getCurrX();
            int currY = this.q.getCurrY();
            int left = currX - ((this.s.getLeft() + this.s.getRight()) >> 1);
            int top = currY - ((this.s.getTop() + this.s.getBottom()) >> 1);
            if (left != 0) {
            ...
            if (left != 0 || top != 0) {
                this.r.a(this.s, false, currX, currY, left, top);
            }
    ...
    public boolean a(int i) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("a821939f", new Object[]{this, new Integer(i)})).booleanValue() : ((1 << i) & this.k) != 0;
    }
    ...
    */
    public boolean a(android.view.MotionEvent r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.android.detail.ttdetail.widget.draglayout.c.a(android.view.MotionEvent):boolean");
    }
    ...
    public void b(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (this.f11024a == 1) {
                ...
                b(((this.s.getLeft() + this.s.getRight()) >> 1) + i4, ((this.s.getTop() + this.s.getBottom()) >> 1) + i5, i4, i5);
                c(motionEvent);
                return;
            }
            int pointerCount = motionEvent.getPointerCount();
            ...
            if (this.f11024a == 1 && pointerId4 == this.c) {
                ...
                while (true) {
                    ...
                    if (pointerId5 != this.c) {
                        View c3 = c((int) motionEvent.getX(i2), (int) motionEvent.getY(i2));
                        View view = this.s;
                        if (c3 == view && b(view, pointerId5)) {
                            i = this.c;
                            break;
                        }
                    }
    ...
    private void b(int i, int i2, int i3, int i4) {
        ...
        if (i3 != 0) {
            ...
            ViewCompat.offsetLeftAndRight(this.s, i - left);
        }
        int i5 = i;
        if (i4 != 0) {
            i2 = this.r.a(this.s, i2, i4);
            ViewCompat.offsetTopAndBottom(this.s, i2 - top);
        }
        int i6 = i2;
        if (i3 == 0 && i4 == 0) {
            return;
        }
        this.r.a(this.s, true, i5, i6, i5 - left, i6 - top);
    }

    public boolean b(int i, int i2) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("90f78e0d", new Object[]{this, new Integer(i), new Integer(i2)})).booleanValue() : b(this.s, i, i2);
    }
    ...
    public View c(int i, int i2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (View) ipChange.ipc$dispatch("cb1c630c", new Object[]{this, new Integer(i), new Integer(i2)});
        }
    ...
    private int d(int i, int i2) {
        ...
        int i3 = 1;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("fac4047e", new Object[]{this, new Integer(i), new Integer(i2)})).intValue();
        }
