...
public class XRichTextViewByCouponV3 extends DXNativeTextView {
    ...
    public XRichTextViewByCouponV3(Context context) {
        ...
        this.linesNum = 1;
        this.ascent = 0;
        this.imageTextSpace = f.a(5.0f);
        this.textSpace = f.a(5.0f);
    ...
    public void setXIconHeight(int i) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            this.xIconHeight = fpr.b(y.a(this), i);
        }
    }
        ...
        if (ipChange instanceof IpChange) {
            ...
            while (i5 < split.length) {
                ...
                if (this.textBgDrawable != null) {
                    ...
                    if (!tbi.a(this.targetBgDrawable) && (bitmap = ((BitmapDrawable) this.textBgDrawable).getBitmap()) != null) {
                        this.targetBgDrawable = tbi.a(y.a(this), this.textBgDrawable, tbi.a(bitmap.getHeight(), rect3), bitmap.getWidth() / 2);
                    }
                    if (tbi.a(this.targetBgDrawable)) {
