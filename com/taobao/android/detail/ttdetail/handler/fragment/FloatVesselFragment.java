...
public class FloatVesselFragment extends FloatFragment {
    ...
    private String mOriginalAddressId;
    ...
    public static /* synthetic */ void access$000(FloatVesselFragment floatVesselFragment, Map map, com.taobao.vessel.base.a aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("77d509dc", new Object[]{floatVesselFragment, map, aVar});
        } else {
    ...
    public void setDetailContext(eyx eyxVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
    ...
    public static FloatVesselFragment newInstance(boolean z) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (FloatVesselFragment) ipChange.ipc$dispatch("235d28e", new Object[]{new Boolean(z)});
        }
    ...
    public void loadUrl(VesselType vesselType, String str, Object obj) {
        ...
        if (this.mVesselType == null) {
            this.mVesselType = com.taobao.vessel.utils.b.a(str);
        }
        this.mUri = str;
        ...
        this.mViewCallback = new rgw() { // from class: com.taobao.android.detail.ttdetail.handler.fragment.FloatVesselFragment.1
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.rootView = LayoutInflater.from(getActivity()).inflate(R.layout.tt_detail_float_vessel_fragment, (ViewGroup) null);
        this.llContainer = this.rootView.findViewById(R.id.ll_container);
        if (isShowByStdPop()) {
            this.llContainer.setBackgroundColor(-1);
            this.llContainer.setPadding(0, SystemBarDecorator.SystemBarConfig.getStatusBarHeight(y.a(this)), 0, 0);
        }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        this.llContainer.setOnClickListener(new View.OnClickListener() { // from class: com.taobao.android.detail.ttdetail.handler.fragment.FloatVesselFragment.2
            public static volatile transient /* synthetic */ IpChange $ipChange;
    ...
    private void onVesselViewCallBackInvoked(Map<String, Object> map, com.taobao.vessel.base.a aVar) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            if ("close_page".equals(str)) {
                ...
                if (obj2 == null || obj2.equals(this.mAddressId)) {
                    return;
                }
                this.mAddressId = obj2.toString();
            }
            if (!"get_detail_data".equals(str) || aVar == null || (eyxVar = this.mDetailContext) == null) {
                return;
            }
            aVar.invoke(eyxVar.a().a());
        }
    }
    ...
    public void onDestroyView() {
        ...
        if (eyxVar != null) {
            intent.putExtra("skuToken", eyxVar.e().a());
            intent.putExtra(fgl.ORIGINALITEMID, (String) this.mDetailContext.e().a("requestItemId"));
        }
