...
public class MiniAppEntranceView extends RelativeLayout {
    ...
    public void init() {
        ...
        View inflate = LayoutInflater.from(y.a(this)).inflate(R.layout.tt_detail_lightapp_entrance, (ViewGroup) this, true);
        this.rlContainer = (RelativeLayout) inflate.findViewById(R.id.rl_app);
        this.ivAppIcon = (TUrlImageView) inflate.findViewById(R.id.iv_app_icon);
    ...
    public void updateViewStatus(float f) {
        ...
        layoutParams.width = i - ((int) ((i - fpr.a(y.a(this), 31.0f)) * f));
