...
public class DescDynamicClient extends MtopRequestClient<DescDynamicParams, com.taobao.android.detail.ttdetail.skeleton.desc.natives.structure.g> {
    ...
    public static /* synthetic */ com.taobao.android.detail.ttdetail.skeleton.desc.natives.structure.g access$000(DescDynamicClient descDynamicClient) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (com.taobao.android.detail.ttdetail.skeleton.desc.natives.structure.g) ipChange.ipc$dispatch("c353bad", new Object[]{descDynamicClient}) : descDynamicClient.mDescStructure;
    }
    ...
    public static /* synthetic */ com.taobao.android.detail.ttdetail.skeleton.desc.natives.structure.g access$002(DescDynamicClient descDynamicClient, com.taobao.android.detail.ttdetail.skeleton.desc.natives.structure.g gVar) {
        ...
        if (ipChange instanceof IpChange) {
            return (com.taobao.android.detail.ttdetail.skeleton.desc.natives.structure.g) ipChange.ipc$dispatch("41b76c65", new Object[]{descDynamicClient, gVar});
        }
        descDynamicClient.mDescStructure = gVar;
        return gVar;
    }

    public static /* synthetic */ h access$100(DescDynamicClient descDynamicClient) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (h) ipChange.ipc$dispatch("f4c88bab", new Object[]{descDynamicClient}) : descDynamicClient.mEngine;
    }

    public static /* synthetic */ String access$200(DescDynamicClient descDynamicClient) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("bed6102f", new Object[]{descDynamicClient}) : descDynamicClient.TAG;
    }

    public DescDynamicClient(DescDynamicParams descDynamicParams, String str, f<com.taobao.android.detail.ttdetail.skeleton.desc.natives.structure.g> fVar, h hVar) {
        super(descDynamicParams, str, fVar);
        this.TAG = "DescDynamicClient";
        this.mEngine = hVar;
    }

    /* JADX WARN: Type inference failed for: r5v1, types: [com.taobao.android.detail.ttdetail.skeleton.desc.natives.request.DescDynamicClient$1] */
    ...
    public void onSuccess(int i, final MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            new AsyncTask<MtopResponse, Void, com.taobao.android.detail.ttdetail.skeleton.desc.natives.structure.g>() { // from class: com.taobao.android.detail.ttdetail.skeleton.desc.natives.request.DescDynamicClient.1
                public static volatile transient /* synthetic */ IpChange $ipChange;
