...
public class AvatarsAnimView extends DXNativeFrameLayout {
    ...
    public static /* synthetic */ void access$000(AvatarsAnimView avatarsAnimView) {
        ...
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("a8072b4", new Object[]{avatarsAnimView});
        } else {
    ...
    public static /* synthetic */ AnimatorSet access$100(AvatarsAnimView avatarsAnimView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (AnimatorSet) ipChange.ipc$dispatch("e7923cb6", new Object[]{avatarsAnimView}) : avatarsAnimView.animatorSet;
    }

    public static /* synthetic */ int access$1000(AvatarsAnimView avatarsAnimView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("7bd467d6", new Object[]{avatarsAnimView})).intValue() : avatarsAnimView.mFirstToLastDistance;
    }

    public static /* synthetic */ AnimatorSet access$102(AvatarsAnimView avatarsAnimView, AnimatorSet animatorSet) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (AnimatorSet) ipChange.ipc$dispatch("e82f4dfb", new Object[]{avatarsAnimView, animatorSet});
        }
    ...
    public static /* synthetic */ void access$1100(AvatarsAnimView avatarsAnimView) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("5f001b24", new Object[]{avatarsAnimView});
        } else {
    ...
    public static /* synthetic */ a access$202(AvatarsAnimView avatarsAnimView, a aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (a) ipChange.ipc$dispatch("5acdf71e", new Object[]{avatarsAnimView, aVar});
        }
    ...
    public static /* synthetic */ List access$300(AvatarsAnimView avatarsAnimView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (List) ipChange.ipc$dispatch("4646e8f0", new Object[]{avatarsAnimView}) : avatarsAnimView.mChildFrameLayout;
    }

    public static /* synthetic */ int access$400(AvatarsAnimView avatarsAnimView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("972f3fab", new Object[]{avatarsAnimView})).intValue() : avatarsAnimView.mCurLastInViewIndex;
    }

    public static /* synthetic */ int access$402(AvatarsAnimView avatarsAnimView, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("c079eb7c", new Object[]{avatarsAnimView, new Integer(i)})).intValue();
        }
    ...
    public static /* synthetic */ int access$500(AvatarsAnimView avatarsAnimView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("7a5af2ec", new Object[]{avatarsAnimView})).intValue() : avatarsAnimView.mLastToPreDistance;
    }

    public static /* synthetic */ double access$600(AvatarsAnimView avatarsAnimView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("5d86a628", new Object[]{avatarsAnimView})).doubleValue() : avatarsAnimView.animationDuration;
    }

    public static /* synthetic */ int access$700(AvatarsAnimView avatarsAnimView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("40b2596e", new Object[]{avatarsAnimView})).intValue() : avatarsAnimView.mLastDataIndex;
    }

    public static /* synthetic */ int access$702(AvatarsAnimView avatarsAnimView, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("475a0a19", new Object[]{avatarsAnimView, new Integer(i)})).intValue();
        }
    ...
    public static /* synthetic */ JSONArray access$800(AvatarsAnimView avatarsAnimView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (JSONArray) ipChange.ipc$dispatch("74e7602", new Object[]{avatarsAnimView}) : avatarsAnimView.avatarsData;
    }

    public static /* synthetic */ int access$900(AvatarsAnimView avatarsAnimView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("709bff0", new Object[]{avatarsAnimView})).intValue() : avatarsAnimView.isInfinite;
    }
    ...
    public AvatarsAnimView(Context context) {
        ...
        emu.a("com.taobao.android.detail.core.standard.widget.AvatarsAnimView");
    }
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            if (ipChange instanceof IpChange) {
                ...
                AvatarsAnimView.access$100(AvatarsAnimView.this).addListener(new Animator.AnimatorListener() { // from class: com.taobao.android.detail.core.standard.widget.AvatarsAnimView.a.1
                    public static volatile transient /* synthetic */ IpChange $ipChange;
    ...
    private void recycleTransImage() {
        ...
        if (ipChange instanceof IpChange) {
            ...
            i.a(TAG, "recycleTransImage orang isEnableAvatarAnimation fasle");
