...
public class d extends a {
    ...
    public d(Activity activity) {
        super(activity);
        emu.a("com.taobao.android.detail.core.aura.presenter.ProtocolParseAuraPresenter");
    }
    ...
    public Map<String, Object> f() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (Map) ipChange.ipc$dispatch("a4689162", new Object[]{this}) : new HashMap<String, Object>() { // from class: com.taobao.android.detail.core.aura.presenter.ProtocolParseAuraPresenter$1
            {
                d.this = this;
                put("instanceType", "UltronProtocolParse");
            }
        };
    }
}
