...
public abstract class AsynApiTask implements Handler.Callback {
    ...
    public final String f9814a = "Content-Type";
    ...
    public Future a(final ApiRequest apiRequest, final Map<String, String> map, final ApiRequestListener apiRequestListener) {
        ...
        return ipChange instanceof IpChange ? (Future) ipChange.ipc$dispatch("b104a3ef", new Object[]{this, apiRequest, map, apiRequestListener}) : b.a(new Callable() { // from class: com.taobao.android.detail.core.request.apicommon.AsynApiTask.1
            public static volatile transient /* synthetic */ IpChange $ipChange;
    ...
    public MtopResponseWrapper a(ApiRequest apiRequest, Map<String, String> map) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (MtopResponseWrapper) ipChange.ipc$dispatch("473c7286", new Object[]{this, apiRequest, map}) : new MtopResponseWrapper(a.a(apiRequest, this.b));
    }

    public void a(MtopResponseWrapper mtopResponseWrapper, ApiRequestListener apiRequestListener) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("326bf841", new Object[]{this, mtopResponseWrapper, apiRequestListener});
            return;
        }
    ...
    public void b(MtopResponseWrapper mtopResponseWrapper, ApiRequestListener apiRequestListener) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("cfa80fa0", new Object[]{this, mtopResponseWrapper, apiRequestListener});
    ...
    public Object a(MtopResponse mtopResponse) {
        ...
        if (jsonToOutputDO == null) {
            try {
                i.d("output do is empty , http result is ", new String(mtopResponse.getBytedata(), "UTF-8"));
