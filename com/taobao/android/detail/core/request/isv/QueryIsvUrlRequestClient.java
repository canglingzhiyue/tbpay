...
public class QueryIsvUrlRequestClient extends AbsMtopRequestClient<a, QueryIsvUrlRequestResult> {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    private static final String TAG = "QueryIsvUrlRequestClient";

    static {
        kge.a(-696567401);
    }

    public static /* synthetic */ Object ipc$super(QueryIsvUrlRequestClient queryIsvUrlRequestClient, String str, Object... objArr) {
    ...
    public String getApiName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("8523c6ca", new Object[]{this}) : "mtop.trade.customization.url";
    }
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        QueryIsvUrlRequestResultOutDo_ queryIsvUrlRequestResultOutDo_ = baseOutDo != null ? (QueryIsvUrlRequestResultOutDo_) baseOutDo : null;
        ...
        try {
            if (queryIsvUrlRequestResultOutDo_ != null) {
                aVar.onSuccess(queryIsvUrlRequestResultOutDo_.mo2429getData());
            } else {
                aVar.onSuccess(null);
            }
        } catch (Throwable th) {
    ...
    public void sendRequest(RemoteBusiness remoteBusiness) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            remoteBusiness.startRequest(QueryIsvUrlRequestResultOutDo_.class);
        }
    }
}
