...
public class RightListRequestClient extends AbsMtopRequestClient<RightListRequestParams, RightListModel> {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    private static final String TAG = "RightListRequestClient";

    static {
        kge.a(-1719055373);
    }

    public static /* synthetic */ Object ipc$super(RightListRequestClient rightListRequestClient, String str, Object... objArr) {
    ...
    public String getApiName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("8523c6ca", new Object[]{this}) : "mtop.order.query.multiorderservice";
    }
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        RightListModelOutDo_ rightListModelOutDo_ = baseOutDo != null ? (RightListModelOutDo_) baseOutDo : null;
        a aVar = (a) this.mRequestListenerRef.get();
        if (aVar == null) {
            return;
        }
        try {
            if (rightListModelOutDo_ != null) {
                aVar.onSuccess(rightListModelOutDo_.mo2429getData());
            } else {
                aVar.onSuccess(null);
            }
        } catch (Throwable th) {
    ...
    public void sendRequest(RemoteBusiness remoteBusiness) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            remoteBusiness.startRequest(RightListModelOutDo_.class);
        }
    }
}
