...
public class FetchShopCouponRequestClient extends AbsMtopRequestClient<FetchShopCouponRequestParams, FetchShopCouponRequestResult> {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    private static final String TAG = "FetchShopCouponRequestClient";

    static {
        kge.a(1421243144);
    }

    public static /* synthetic */ Object ipc$super(FetchShopCouponRequestClient fetchShopCouponRequestClient, String str, Object... objArr) {
    ...
    public String getApiName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("8523c6ca", new Object[]{this}) : "mtop.shop.getshopcoupon";
    }
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        FetchShopCouponRequestResultOutDo_ fetchShopCouponRequestResultOutDo_ = baseOutDo != null ? (FetchShopCouponRequestResultOutDo_) baseOutDo : null;
        a aVar = (a) this.mRequestListenerRef.get();
        if (aVar == null) {
            return;
        }
        try {
            if (fetchShopCouponRequestResultOutDo_ != null) {
                aVar.onSuccess(fetchShopCouponRequestResultOutDo_.mo2429getData());
            } else {
                aVar.onSuccess(null);
            }
        } catch (Throwable th) {
    ...
    public void sendRequest(RemoteBusiness remoteBusiness) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            remoteBusiness.startRequest(FetchShopCouponRequestResultOutDo_.class);
        }
    }
}
