...
public class JhsMarketingRequestClient extends AbsMtopRequestClient<JhsMarketingRequestParams, JhsMarkegingResult> {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    private static final String TAG = "JhsMarketingRequestClient";

    static {
        kge.a(790977921);
    }

    public static /* synthetic */ Object ipc$super(JhsMarketingRequestClient jhsMarketingRequestClient, String str, Object... objArr) {
    ...
    public String getApiName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("8523c6ca", new Object[]{this}) : "mtop.ju.detail.marketing.get";
    }
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        JhsMarkegingResultOutDo_ jhsMarkegingResultOutDo_ = baseOutDo != null ? (JhsMarkegingResultOutDo_) baseOutDo : null;
        a aVar = (a) this.mRequestListenerRef.get();
        if (aVar == null) {
            return;
        }
        try {
            if (jhsMarkegingResultOutDo_ != null) {
                aVar.onSuccess(jhsMarkegingResultOutDo_.mo2429getData());
            } else {
                aVar.onSuccess(null);
            }
        } catch (Throwable th) {
    ...
    public void sendRequest(RemoteBusiness remoteBusiness) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            remoteBusiness.startRequest(JhsMarkegingResultOutDo_.class);
        }
    }
}
