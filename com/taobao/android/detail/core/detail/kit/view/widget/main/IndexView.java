...
public class IndexView extends TextView {
    ...
    static {
        kge.a(1076415700);
        MAX_DOT_NUM = 6;
        DEFAULT_INDEX_WIDTH = epo.g;
        DEFAULT_INDEX_HEIGHT = epo.g;
        DEFAULT_INDEX_MARGIN = epo.g;
    }
    ...
    private void init() {
        ...
        setTextSize(1, 10.0f);
        emu.a("com.taobao.android.detail.core.detail.kit.view.widget.main.IndexView");
    }
    ...
    public void setSelectedIndexDrawable(int i) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            this.mSelectedIndexDrawable = epo.a().getResources().getDrawable(this.mSelectedIndexResId);
        }
    }
    ...
    public void setUnselectedIndexDrawable(int i) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            this.mUnselectedIndexDrawable = epo.a().getResources().getDrawable(this.mUnselectedIndexResId);
        }
    }
