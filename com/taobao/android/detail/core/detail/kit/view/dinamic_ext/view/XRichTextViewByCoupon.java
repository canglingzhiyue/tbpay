...
public class XRichTextViewByCoupon extends TextView {
    ...
    public static /* synthetic */ Object ipc$super(XRichTextViewByCoupon xRichTextViewByCoupon, String str, Object... objArr) {
        switch (str.hashCode()) {
            case 362446068:
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        emu.a("com.taobao.android.detail.core.detail.kit.view.dinamic_ext.view.XRichTextViewByCoupon");
    ...
    public void setTextBgPaddingH(int i) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            this.xTextBgPaddingH = fpr.a(getContext(), i);
        }
    }
    ...
    public void setTextBgPaddingV(int i) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            this.xTextBgPaddingV = fpr.a(getContext(), i);
        }
    }
