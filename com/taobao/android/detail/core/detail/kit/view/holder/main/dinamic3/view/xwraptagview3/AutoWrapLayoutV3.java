...
public class AutoWrapLayoutV3 extends RelativeLayout {
    ...
    public static /* synthetic */ Object ipc$super(AutoWrapLayoutV3 autoWrapLayoutV3, String str, Object... objArr) {
    ...
    public AutoWrapLayoutV3(Context context, AttributeSet attributeSet, int i, int i2) {
        super(context, attributeSet, i);
        this.DENSITY = 0.0f;
        this.mItemSpacing = 0;
        this.mLineSpacing = 0;
    ...
    private void initDefaultData() {
        ...
        emu.a("com.taobao.android.detail.core.detail.kit.view.holder.main.dinamic3.view.xwraptagview3.AutoWrapLayoutV3");
    }
