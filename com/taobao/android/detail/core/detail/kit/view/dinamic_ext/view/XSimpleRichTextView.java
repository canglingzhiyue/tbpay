...
public class XSimpleRichTextView extends TextView {
    ...
    public static /* synthetic */ Object ipc$super(XSimpleRichTextView xSimpleRichTextView, String str, Object... objArr) {
        str.hashCode();
    ...
    public XSimpleRichTextView(Context context) {
        ...
        this.imageSpace = epo.b(0);
        this.imageTextSpace = epo.b(6);
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        emu.a("com.taobao.android.detail.core.detail.kit.view.dinamic_ext.view.XSimpleRichTextView");
    ...
    private void reCaculateDrawBounds() {
        ...
        try {
            ...
            e.printStackTrace();
            i.a("MyLog", "Fail to serialize drawableArrayList");
        }
    }
    ...
    public static class DrawableHolder implements Serializable, Comparable<DrawableHolder> {
        ...
        public int compareTo(DrawableHolder drawableHolder) {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                return ((Number) ipChange.ipc$dispatch("c410d1df", new Object[]{this, drawableHolder})).intValue();
            }
