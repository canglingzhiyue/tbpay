...
public class XRichTextViewByCategoryCoupon extends TextView {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        emu.a("com.taobao.android.detail.core.detail.kit.view.dinamic_ext.view.XRichTextViewByCategoryCoupon");
    ...
    public static class Coupon implements Serializable {
        ...
        public void loadBgDrawable(final XRichTextViewByCategoryCoupon xRichTextViewByCategoryCoupon) {
            ...
            } else if (XRichTextViewByCategoryCoupon.access$000(this.bgDrawable)) {
            } else {
                dzv.a(this.bgImage, xRichTextViewByCategoryCoupon.getContext(), new c.a() { // from class: com.taobao.android.detail.core.detail.kit.view.dinamic_ext.view.XRichTextViewByCategoryCoupon.Coupon.1
                    public static volatile transient /* synthetic */ IpChange $ipChange;
