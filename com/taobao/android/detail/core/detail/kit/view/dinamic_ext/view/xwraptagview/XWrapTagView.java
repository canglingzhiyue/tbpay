...
public class XWrapTagView extends AutoWrapLayout implements View.OnClickListener {
    ...
    public static /* synthetic */ Object ipc$super(XWrapTagView xWrapTagView, String str, Object... objArr) {
    ...
    public XWrapTagView(Context context) {
        ...
        emu.a("com.taobao.android.detail.core.detail.kit.view.dinamic_ext.view.xwraptagview.XWrapTagView");
    }

    public XWrapTagView(Context context, AttributeSet attributeSet) {
    ...
    public void setTagList(ArrayList<a> arrayList) {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                String str2 = arrayList.get(i).f9566a;
    ...
    public void onClick(View view) {
        ...
        view.getId();
        if (TStudioHelper.a().a(null, view, this.tags, false)) {
            return;
        }
    ...
    private ModifiableRoundRadiusImageView createImageTag(int i, int i2, int i3, String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (ModifiableRoundRadiusImageView) ipChange.ipc$dispatch("d78b38ba", new Object[]{this, new Integer(i), new Integer(i2), new Integer(i3), str});
        }
