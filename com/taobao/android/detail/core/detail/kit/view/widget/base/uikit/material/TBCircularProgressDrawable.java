package com.taobao.android.detail.core.detail.kit.view.widget.base.uikit.material;
...
public class TBCircularProgressDrawable extends Drawable implements Animatable {
    ...
    private Property<TBCircularProgressDrawable, Float> mAngleProperty = new Property<TBCircularProgressDrawable, Float>(Float.class, "angle") { // from class: com.taobao.android.detail.core.detail.kit.view.widget.base.uikit.material.TBCircularProgressDrawable.1
        ...
        public Float a(TBCircularProgressDrawable tBCircularProgressDrawable) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? (Float) ipChange.ipc$dispatch("30de8a58", new Object[]{this, tBCircularProgressDrawable}) : Float.valueOf(tBCircularProgressDrawable.getCurrentGlobalAngle());
        }

        public void a(TBCircularProgressDrawable tBCircularProgressDrawable, Float f) {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                ipChange.ipc$dispatch("6805efaa", new Object[]{this, tBCircularProgressDrawable, f});
            } else {
                tBCircularProgressDrawable.setCurrentGlobalAngle(f.floatValue());
            }
        }
    };
    private Property<TBCircularProgressDrawable, Float> mSweepProperty = new Property<TBCircularProgressDrawable, Float>(Float.class, "arc") { // from class: com.taobao.android.detail.core.detail.kit.view.widget.base.uikit.material.TBCircularProgressDrawable.2
        public static volatile transient /* synthetic */ IpChange $ipChange;
        ...
        public Float a(TBCircularProgressDrawable tBCircularProgressDrawable) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? (Float) ipChange.ipc$dispatch("30de8a58", new Object[]{this, tBCircularProgressDrawable}) : Float.valueOf(tBCircularProgressDrawable.getCurrentSweepAngle());
        }
    ...
    public static /* synthetic */ void access$000(TBCircularProgressDrawable tBCircularProgressDrawable) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("848633de", new Object[]{tBCircularProgressDrawable});
        } else {
    ...
    public TBCircularProgressDrawable(int i, float f) {
        ...
        setupAnimations();
        emu.a("com.taobao.android.detail.core.detail.kit.view.widget.base.uikit.material.TBCircularProgressDrawable");
    }
    ...
    private void setupAnimations() {
        ...
        this.mObjectAnimatorSweep.addListener(new Animator.AnimatorListener() { // from class: com.taobao.android.detail.core.detail.kit.view.widget.base.uikit.material.TBCircularProgressDrawable.3
            public static volatile transient /* synthetic */ IpChange $ipChange;
