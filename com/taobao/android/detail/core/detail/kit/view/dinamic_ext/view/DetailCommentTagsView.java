...
public class DetailCommentTagsView extends AutoWrapLineLayoutForDinamic implements View.OnClickListener {
    ...
    public DetailCommentTagsView(Context context) {
        ...
        emu.a("com.taobao.android.detail.core.detail.kit.view.dinamic_ext.view.DetailCommentTagsView");
    }

    public DetailCommentTagsView(Context context, AttributeSet attributeSet) {
    ...
    public void onClick(View view) {
        ...
        try {
            ...
            ecg.a(fpz.c(this.mContext), th);
            i.a("DetailCommentTagsView", "onClick", th);
        }
    ...
    public void setTagBgColor(int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("31173f6", new Object[]{this, new Integer(i)});
        } else {
            this.tagBgColor = i;
        }
    }
