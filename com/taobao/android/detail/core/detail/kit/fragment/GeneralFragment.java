...
public class GeneralFragment extends FloatFragment {
    ...
    public static /* synthetic */ ArrayList access$000(GeneralFragment generalFragment) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (ArrayList) ipChange.ipc$dispatch("7be54db5", new Object[]{generalFragment}) : generalFragment.mInfoList;
    }
    ...
    public static void startFragment(FragmentActivity fragmentActivity, String str, ArrayList<Pair<String, String>> arrayList, a aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("59de45fd", new Object[]{fragmentActivity, str, arrayList, aVar});
    ...
    public GeneralFragment() {
        emu.a("com.taobao.android.detail.core.detail.kit.fragment.GeneralFragment");
    }

    public static GeneralFragment newInstance(String str, ArrayList<Pair<String, String>> arrayList, a aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (GeneralFragment) ipChange.ipc$dispatch("c452304f", new Object[]{str, arrayList, aVar});
        }
    ...
    public void setStyleInfo(a aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("c5a15b4b", new Object[]{this, aVar});
        } else {
            this.styleInfo = aVar;
        }
    }
    ...
    public class GeneralAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.x_detail_main_general_info_item, (ViewGroup) null);
                bVar = new b();
                bVar.f9516a = (TextView) view.findViewById(R.id.name);
        ...
        private void bindData(int i, Context context, b bVar) {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                ipChange.ipc$dispatch("2df349d9", new Object[]{this, new Integer(i), context, bVar});
                return;
            }
            ...
            if (pair.first != null && !StringUtils.isEmpty((CharSequence) pair.first)) {
                bVar.f9516a.setText((CharSequence) pair.first);
            } else {
                bVar.c.setVisibility(8);
                bVar.f9516a.setVisibility(8);
            }
            if (pair.second == null) {
                return;
            }
