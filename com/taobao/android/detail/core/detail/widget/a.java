...
public class a extends Drawable {
    ...
    private final Paint f9648a = new Paint();
    ...
    public a(int i) {
        this.f9648a.setColor(i);
        this.f9648a.setAntiAlias(true);
        this.b = new Path();
        emu.a("com.taobao.android.detail.core.detail.widget.ArrowDownDrawable");
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            canvas.drawPath(this.b, this.f9648a);
        }
    }
    ...
    public void setColorFilter(ColorFilter colorFilter) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            this.f9648a.setColorFilter(colorFilter);
        }
    }
}
