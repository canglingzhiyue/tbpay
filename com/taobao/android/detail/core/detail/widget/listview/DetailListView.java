...
public class DetailListView extends TListView {
    ...
    public static /* synthetic */ int access$000(DetailListView detailListView) {
        ...
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("13c1974b", new Object[]{detailListView})).intValue() : detailListView.getInnerTopY();
    }

    public static /* synthetic */ b access$100(DetailListView detailListView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (b) ipChange.ipc$dispatch("d95a3640", new Object[]{detailListView}) : detailListView.mOnScrollYDistanceChangeListener;
    }

    public static /* synthetic */ boolean access$202(DetailListView detailListView, boolean z) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("1aa3047c", new Object[]{detailListView, new Boolean(z)})).booleanValue();
        }
    ...
    static {
        kge.a(530142606);
        TAG = DetailListView.class.getSimpleName();
    }
    ...
    private void init() {
        ...
        setOverScrollMode(2);
        emu.a("com.taobao.android.detail.core.detail.widget.listview.DetailListView");
    }
