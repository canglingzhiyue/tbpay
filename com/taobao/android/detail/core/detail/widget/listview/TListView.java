...
public class TListView extends ListView implements AbsListView.OnScrollListener {
    ...
    public TListView(Context context, AttributeSet attributeSet, int i) {
        ...
        emu.a("com.taobao.android.detail.core.detail.widget.listview.TListView");
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        i.a("DetailTime", "onLayout end:" + (System.currentTimeMillis() - j) + "ms");
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        for (int size = this.mFeatureList.size() - 1; size >= 0; size--) {
            a aVar2 = this.mFeatureList.get(size);
    ...
    */
    public boolean onInterceptTouchEvent(android.view.MotionEvent r9) {
        /*
            r8 = this;
            com.android.alibaba.ip.runtime.IpChange r0 = com.taobao.android.detail.core.detail.widget.listview.TListView.$ipChange
        ...
        Lae:
            ...
            com.taobao.android.detail.core.detail.kit.view.widget.base.uikit.utils.FeatureList<android.widget.ListView> r1 = r8.mFeatureList
            int r1 = r1.size()
            int r1 = r1 - r4
        Lb9:
            if (r1 < 0) goto Ld1
            com.taobao.android.detail.core.detail.kit.view.widget.base.uikit.utils.FeatureList<android.widget.ListView> r2 = r8.mFeatureList
            ...
            boolean r3 = r2 instanceof tb.ecx
            if (r3 == 0) goto Lce
            tb.ecx r2 = (tb.ecx) r2
            boolean r2 = r2.a(r9)
            r0 = r0 | r2
    ...
    public a<? super ListView> findFeature(Class<? extends a<? super ListView>> cls) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (a) ipChange.ipc$dispatch("7cfce04a", new Object[]{this, cls}) : this.mFeatureList.findFeature(cls);
    }

    public int getFeatureSize() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("34f0d6db", new Object[]{this})).intValue() : this.mFeatureList.size();
    }
    ...
    public void setAdapter(ListAdapter listAdapter) {
        ...
        while (it.hasNext()) {
            a aVar = (a) it.next();
            if (aVar instanceof ecw) {
                listAdapter = ((ecw) aVar).a(listAdapter);
            }
        }
    ...
    public void removeDetachedView(View view, boolean z) {
        ...
        try {
            ...
            i.a("TListView", "removeDetachedView", th);
        }
    }
}
