...
public class PullToRefreshFeature extends com.taobao.android.detail.core.detail.kit.view.widget.base.uikit.feature.features.a<ListView> implements com.taobao.android.detail.core.detail.widget.listview.features.internal.pullrefresh.a, ecz, eda {
    ...
    public static /* synthetic */ b access$000(PullToRefreshFeature pullToRefreshFeature) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (b) ipChange.ipc$dispatch("3bf954f9", new Object[]{pullToRefreshFeature}) : pullToRefreshFeature.mRefreshController;
    }
    ...
    public PullToRefreshFeature(Context context) {
        ...
        emu.a("com.taobao.android.detail.core.detail.widget.listview.features.PullToRefreshFeature");
    }
    ...
    public void setHost(ListView listView) {
        ...
        listView.setOnScrollListener(new AbsListView.OnScrollListener() { // from class: com.taobao.android.detail.core.detail.widget.listview.features.PullToRefreshFeature.1
            public static volatile transient /* synthetic */ IpChange $ipChange;
            ...
            public void onScroll(AbsListView absListView, int i, int i2, int i3) {
                ...
                } else if (!PullToRefreshFeature.this.hasArrivedBottomEdge() || !PullToRefreshFeature.access$000(PullToRefreshFeature.this).d()) {
                } else {
                    PullToRefreshFeature.access$000(PullToRefreshFeature.this).c();
                }
            }
        });
    }
    ...
    public void setPullUpToRefreshAuto(boolean z) {
        ...
        getHost().setOnScrollListener(new AbsListView.OnScrollListener() { // from class: com.taobao.android.detail.core.detail.widget.listview.features.PullToRefreshFeature.2
            public static volatile transient /* synthetic */ IpChange $ipChange;
