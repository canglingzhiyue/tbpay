...
public abstract class BasePopupView extends FrameLayout {
    ...
    public void hide() {
        ...
        createTranslationOutAnimation.setAnimationListener(new Animation.AnimationListener() { // from class: com.taobao.android.live.plugin.atype.flexalocal.profile.BasePopupView.1
    ...
    public void setOnDismissListener(a aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("851f3472", new Object[]{this, aVar});
        } else {
