...
public class CirclePointLoadingView extends LinearLayout {
    ...
    public static /* synthetic */ CirclePointView access$000(CirclePointLoadingView circlePointLoadingView) {
        ...
        return ipChange instanceof IpChange ? (CirclePointView) ipChange.ipc$dispatch("5d6fbf0", new Object[]{circlePointLoadingView}) : circlePointLoadingView.mLeftCircle;
    }

    public static /* synthetic */ CirclePointView access$100(CirclePointLoadingView circlePointLoadingView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (CirclePointView) ipChange.ipc$dispatch("9213b14f", new Object[]{circlePointLoadingView}) : circlePointLoadingView.mMiddleCircle;
    }

    public static /* synthetic */ CirclePointView access$200(CirclePointLoadingView circlePointLoadingView) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (CirclePointView) ipChange.ipc$dispatch("1e5066ae", new Object[]{circlePointLoadingView}) : circlePointLoadingView.mRightCircle;
    }
    ...
    private void initAnim() {
        ...
        this.mAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.taobao.android.pissarro.remote.CirclePointLoadingView.1
            public static volatile transient /* synthetic */ IpChange $ipChange;
    ...
    private void initView() {
        ...
        setOrientation(0);
        int a2 = icg.a(getContext(), 4.0f);
        this.mLeftCircle = new CirclePointView(getContext());
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(a2, a2);
        layoutParams.rightMargin = icg.a(getContext(), 6.0f);
        ...
        addView(this.mRightCircle, new LinearLayout.LayoutParams(a2, a2));
    }
