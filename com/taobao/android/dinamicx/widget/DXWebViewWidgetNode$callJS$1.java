...
public final class DXWebViewWidgetNode$callJS$1 extends Lambda implements ruk<kotlin.t> {
    ...
    public DXWebViewWidgetNode$callJS$1(ah ahVar, String str, ValueCallback valueCallback) {
        super(0);
        this.this$0 = ahVar;
        this.$funcString = str;
    ...
    public final void mo2427invoke() {
        ...
        dXWebView.callJS(this.$funcString, this.$callback);
    }
}
