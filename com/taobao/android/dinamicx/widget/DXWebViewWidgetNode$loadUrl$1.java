...
public final class DXWebViewWidgetNode$loadUrl$1 extends Lambda implements ruk<kotlin.t> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public final /* synthetic */ String $url;
    public final /* synthetic */ ah this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DXWebViewWidgetNode$loadUrl$1(ah ahVar, String str) {
        super(0);
        this.this$0 = ahVar;
        this.$url = str;
    }
    ...
    public final void mo2427invoke() {
        ...
        if (ipChange instanceof IpChange) {
            ...
            dXWebView.loadUrl(ah.$ipChange);
        } else {
            ah ahVar3 = this.this$0;
            DXWebView dXWebView2 = ah.$ipChange;
            if (dXWebView2 != null) {
                dXWebView2.loadUrl(this.$url);
            }
            ah.b(this.this$0, this.$url);
        }
    }
}
