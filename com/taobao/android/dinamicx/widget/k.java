...
public class k extends j {
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        } else if (dXWidgetNode == null || !(dXWidgetNode instanceof k)) {
        } else {
            super.onClone(dXWidgetNode, z);
            k kVar = (k) dXWidgetNode;
            this.f12107a = kVar.f12107a;
            this.b = kVar.b;
        }
    }
    ...
    public int a() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("56c6c5b", new Object[]{this})).intValue() : this.f12107a;
    }
    ...
    public boolean supportReuse() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("562c49f0", new Object[]{this})).booleanValue() : getClass() == k.class;
    }
}
