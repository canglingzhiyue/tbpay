...
public class ie extends com.taobao.android.launcher.biz.task.j {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    public static /* synthetic */ Object ipc$super(ie ieVar, String str, Object... objArr) {
    ...
    public void a(Application application, HashMap<String, Object> hashMap) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            new PreInitWebviewTask().init(application, hashMap);
        }
    }
    ...
    public boolean intercept(com.taobao.android.job.core.task.c<String, Void> cVar) {
        ...
        if (intercept) {
            intercept = LauncherRuntime.k != 0 ? !guc.a(LauncherRuntime.g, "webviewOffline") : false;
        }
