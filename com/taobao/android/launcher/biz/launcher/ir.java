...
public class ir extends com.taobao.android.launcher.biz.task.g {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    public static /* synthetic */ Object ipc$super(ir irVar, String str, Object... objArr) {
    ...
    public boolean intercept(com.taobao.android.job.core.task.c<String, Void> cVar) {
        ...
        if (intercept) {
            intercept = io.f13054a ? false : guc.a(LauncherRuntime.g, "weexOpt");
        }
        if (intercept) {
            return intercept;
        }
