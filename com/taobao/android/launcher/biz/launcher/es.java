...
public class es extends com.taobao.android.launcher.biz.task.g {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    public static /* synthetic */ Object ipc$super(es esVar, String str, Object... objArr) {
    ...
    public boolean intercept(com.taobao.android.job.core.task.c<String, Void> cVar) {
        ...
        if (!super.intercept(cVar) || LauncherRuntime.k != 0) {
            return false;
        }
        return guc.a(LauncherRuntime.g, "orange_at_launched");
    }
}
