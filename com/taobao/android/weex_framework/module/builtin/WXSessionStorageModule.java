...
public final class WXSessionStorageModule extends WeexInnerModule {
    ...
    private void setItem(WeexValue[] weexValueArr) {
        ...
        a.a((Activity) getWeexInstance().getContext(), q.a(getWeexInstance(), getArg(weexValueArr, 0).toStringValueOrNull()), getArg(weexValueArr, 1).toStringValueOrNull());
    }
    ...
    private void removeItem(WeexValue[] weexValueArr) {
        ...
        a.b((Activity) getWeexInstance().getContext(), q.a(getWeexInstance(), getArg(weexValueArr, 0).toStringValueOrNull()));
    }
    ...
    private WeexValue getItem(WeexValue[] weexValueArr) {
        ...
        if (a2 != null) {
            return WeexValueImpl.ofString(a.a((Activity) getWeexInstance().getContext(), a2));
        }
        return null;
    }
}
