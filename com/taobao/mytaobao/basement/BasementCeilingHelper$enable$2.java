...
public final class BasementCeilingHelper$enable$2 extends Lambda implements ruk<Boolean> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public static final BasementCeilingHelper$enable$2 INSTANCE = new BasementCeilingHelper$enable$2();

    public BasementCeilingHelper$enable$2() {
        super(0);
    }
    ...
    public final Boolean mo2427invoke() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("7560cd03", new Object[]{this})).booleanValue() : mxi.a().a("ceilingSamplingV2", 0L);
    }
}
