...
public final class MtbGlobalEnv$disablePermEvo$2 extends Lambda implements ruk<Boolean> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public static final MtbGlobalEnv$disablePermEvo$2 INSTANCE = new MtbGlobalEnv$disablePermEvo$2();

    public MtbGlobalEnv$disablePermEvo$2() {
        super(0);
    }
    ...
    public final Boolean mo2427invoke() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("7560cd03", new Object[]{this})).booleanValue() : mxj.b("disablePermEvoV3", false);
    }
}
