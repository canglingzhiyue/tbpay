...
public final class MtbGlobalEnv$defaultV24$2 extends Lambda implements ruk<Boolean> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public static final MtbGlobalEnv$defaultV24$2 INSTANCE = new MtbGlobalEnv$defaultV24$2();

    public MtbGlobalEnv$defaultV24$2() {
        super(0);
    }
    ...
    public final Boolean mo2427invoke() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("7560cd03", new Object[]{this})).booleanValue() : mxj.b("defaultV24", false);
    }
}
