...
public final class MtbGlobalEnv$isPageV2$2 extends Lambda implements ruk<Boolean> {
    ...
    public final Boolean mo2427invoke() {
        ...
        if (ABGlobal.isFeatureOpened(Globals.getApplication(), "mtb24PageV2")) {
            return 1;
        }
        return (!mxj.b("mtbPageV2", false) || !q.a((Object) muh.a("mtbPageV2"), (Object) "true")) ? null : 1;
    }
}
