    ...
    */
    public static synchronized void removeAlias(android.content.Context r10, com.taobao.agoo.ICallback r11) {
        ...
        L19:
            ...
            boolean r7 = android.text.TextUtils.isEmpty(r6)     // Catch: java.lang.Throwable -> Lc9
            if (r7 != 0) goto L93
            boolean r7 = android.text.TextUtils.isEmpty(r1)     // Catch: java.lang.Throwable -> Lc9
            if (r7 != 0) goto L93
            if (r10 == 0) goto L93
            boolean r7 = android.text.TextUtils.isEmpty(r2)     // Catch: java.lang.Throwable -> Lc9
            if (r7 == 0) goto L44
            goto L93
        L44:
    ...
    */
    public static void removeAllAlias(android.content.Context r10, com.taobao.agoo.ICallback r11) {
        ...
        L15:
            ...
            if (r7 != 0) goto L84
            boolean r7 = android.text.TextUtils.isEmpty(r0)     // Catch: java.lang.Throwable -> Lab
            if (r7 != 0) goto L84
            if (r10 != 0) goto L38
            goto L84
        L38:
