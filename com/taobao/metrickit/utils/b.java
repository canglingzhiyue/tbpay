...
public class b {
    ...
    private static int b() {
        ...
        return (str.toLowerCase().startsWith("armeabi") || str.toLowerCase().startsWith(iju.ABI_ARM) || str.toLowerCase().startsWith("x86")) ? 32 : -1;
    }
    ...
    */
    private static int b(android.content.Context r4) {
        /*
            com.android.alibaba.ip.runtime.IpChange r0 = com.taobao.metrickit.utils.b.$ipChange
        ...
        L67:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.metrickit.utils.b.b(android.content.Context):int");
    }
}
