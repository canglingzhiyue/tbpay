    ...
    public static void asyncTraceBegin(String str, String str2, int i) {
        if (ENABLE_TRACE) {
            ...
            try {
                ...
                cTrace.getDeclaredMethod("asyncTraceBegin", Long.TYPE, String.class, Integer.TYPE).invoke(null, Long.valueOf((long) ConstantsAPI.AppSupportContentFlag.MMAPP_SUPPORT_PDF), str2, Integer.valueOf(i));
            } catch (Throwable unused) {
            }
        }
    }
    ...
    public static void asyncTraceEnd(String str, String str2, int i) {
        if (ENABLE_TRACE) {
            ...
            try {
                ...
                cTrace.getDeclaredMethod("asyncTraceEnd", Long.TYPE, String.class, Integer.TYPE).invoke(null, Long.valueOf((long) ConstantsAPI.AppSupportContentFlag.MMAPP_SUPPORT_PDF), str2, Integer.valueOf(i));
            } catch (Throwable unused) {
            }
        }
    }
