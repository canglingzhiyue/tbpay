...
public final class SimpleAllConversationService extends SimpleBaseConversationService {
    ...
    public SimpleAllConversationService(String mIdentifier, String mChannelType) {
    ...
    public List<String> getListConversationsChannelList() {
        ...
        return ipChange instanceof IpChange ? (List) ipChange.ipc$dispatch("f4c553bb", new Object[]{this}) : p.b("bc", "notice");
    }
}
