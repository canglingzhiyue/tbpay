...
public class MessageNavProcessorV2NodeUriFilterItem9 extends r {
    ...
    public boolean pathFilter(String str) {
        ...
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("ee8b1ad2", new Object[]{this, str})).booleanValue() : str.contains("/apps/market/msgrax/") || str.contains("/app/mpds/Container/pages/");
    }
