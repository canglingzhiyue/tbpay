...
public final class CompatMessageTabHost$downloadBundle$3 extends Lambda implements rul<Integer, t> {
    ...
    public final void invoke(int i) {
        ...
        RemoteLoadingView remoteLoadingView = CompatMessageTabHost.$ipChange;
