...
public class TBOldRefreshHeader extends TBRefreshHeader {
    ...
    private final int[] mDefaultRefreshTips;
    ...
    public static /* synthetic */ class AnonymousClass1 {
        public static final /* synthetic */ int[] $SwitchMap$com$taobao$uikit$extend$component$refresh$TBRefreshHeader$RefreshState = new int[TBRefreshHeader.RefreshState.values().length];
    ...
    public TBOldRefreshHeader(Context context) {
        super(context);
        this.mDefaultRefreshTips = new int[]{R.string.uik_pull_to_refresh, R.string.uik_release_to_refresh, R.string.uik_refreshing, R.string.uik_refresh_finished};
        ...
        this.mRefreshHeadView = new RefreshHeadView(context, R.string.uik_refresh_arrow, null, false);
    ...
    public void changeToState(TBRefreshHeader.RefreshState refreshState) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            if (i == 1) {
                ...
                textView.setText(strArr == null ? b.a(this.mDefaultRefreshTips[3]) : strArr[3]);
                this.mRefreshProgressView.stopLoadingAnimation();
                ...
                textView2.setText(strArr2 == null ? b.a(this.mDefaultRefreshTips[0]) : strArr2[0]);
                this.mRefreshHeadView.setVisibility(0);
            } else if (i == 3) {
                startArrowAnim();
                TextView textView3 = this.mRefreshTipView;
                String[] strArr3 = this.mRefreshTips;
                textView3.setText(strArr3 == null ? b.a(this.mDefaultRefreshTips[1]) : strArr3[1]);
                this.mRefreshHeadView.setVisibility(0);
            } else if (i != 4) {
                if (i != 5) {
                    return;
                ...
                textView4.setText(strArr4 == null ? b.a(this.mDefaultRefreshTips[2]) : strArr4[2]);
                this.mRefreshHeadView.setVisibility(0);
            }
        }
    }
