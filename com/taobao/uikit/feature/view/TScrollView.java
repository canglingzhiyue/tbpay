...
public class TScrollView extends ScrollView implements ViewGroupHelper, ViewHelper, IFeatureList<ScrollView> {
    ...
    public static /* synthetic */ List access$000(TScrollView tScrollView) {
        ...
        return ipChange instanceof IpChange ? (List) ipChange.ipc$dispatch("4a9541d2", new Object[]{tScrollView}) : tScrollView.mOnHierarchyChangeListeners;
    }
    ...
    public boolean isScrollable() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("4c7d2e7c", new Object[]{this})).booleanValue() : this.mScrollable;
    }
}
