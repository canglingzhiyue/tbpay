...
public class StabilityDataUploadClient extends AbsMtopRequestClient<StabilityDataUploadMtopParams, StabilityDataUploadResult> {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    private static final String TAG = "StabilityDataUploadClient";

    static {
        kge.a(2049576029);
    }

    public static /* synthetic */ Object ipc$super(StabilityDataUploadClient stabilityDataUploadClient, String str, Object... objArr) {
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        StabilityDataUploadResultOutDo stabilityDataUploadResultOutDo = baseOutDo != null ? (StabilityDataUploadResultOutDo) baseOutDo : null;
        a aVar = (a) this.mRequestListenerRef.get();
        if (aVar == null) {
            return;
        }
        try {
            if (stabilityDataUploadResultOutDo != null) {
                aVar.onSuccess(stabilityDataUploadResultOutDo.mo2429getData());
            } else {
                aVar.onSuccess(null);
            }
        } catch (Exception e) {
            ldf.d(TAG, "Call onSuccess exception" + e);
        }
    }
    ...
    public void sendRequest(RemoteBusiness remoteBusiness) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            remoteBusiness.startRequest(StabilityDataUploadResultOutDo.class);
        }
    }
}
