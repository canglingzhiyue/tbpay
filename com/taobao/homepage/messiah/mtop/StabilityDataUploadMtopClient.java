...
public class StabilityDataUploadMtopClient extends AbsMtopRequestClient<StabilityDataUploadMtopParams, StabilityDataUploadResult> {
    public static volatile transient /* synthetic */ IpChange $ipChange = null;
    private static final String TAG = "StabilityDataUploadMtopClient";

    static {
        kge.a(-1678756027);
    }

    public static /* synthetic */ Object ipc$super(StabilityDataUploadMtopClient stabilityDataUploadMtopClient, String str, Object... objArr) {
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        StabilityDataUploadResultOutDo_ stabilityDataUploadResultOutDo_ = baseOutDo != null ? (StabilityDataUploadResultOutDo_) baseOutDo : null;
        a aVar = (a) this.mRequestListenerRef.get();
        if (aVar == null) {
            return;
        }
        try {
            if (stabilityDataUploadResultOutDo_ != null) {
                aVar.onSuccess(stabilityDataUploadResultOutDo_.mo2429getData());
            } else {
                aVar.onSuccess(null);
            }
        } catch (Throwable th) {
    ...
    public void sendRequest(RemoteBusiness remoteBusiness) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            remoteBusiness.startRequest(StabilityDataUploadResultOutDo_.class);
        }
    }
}
