...
public abstract class AbstractRecyclerView extends RecyclerView implements mya, myb, myc {
    ...
    */
    ...
    public boolean isAccepted(int i) {
        int i2;
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("4c10e70f", new Object[]{this, new Integer(i)})).booleanValue() : isAttachedToWindow() && ((i2 = this.mDisabledDirection) == 0 || i2 * i < 0);
    }
