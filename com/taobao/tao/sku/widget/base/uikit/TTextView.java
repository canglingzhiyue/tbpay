...
import com.taobao.tao.sku.widget.base.uikit.utils.FeatureList;
...
public class TTextView extends TextView {
    ...
    public a<? super TextView> findFeature(Class<? extends a<? super TextView>> cls) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (a) ipChange.ipc$dispatch("e94377d0", new Object[]{this, cls}) : this.mFeatureList.findFeature(cls);
    }
    ...
    public boolean addFeature(a<? super TextView> aVar) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("a871978f", new Object[]{this, aVar})).booleanValue() : this.mFeatureList.addFeature(aVar);
    }
}
