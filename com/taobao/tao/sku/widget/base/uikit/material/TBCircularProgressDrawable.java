package com.taobao.tao.sku.widget.base.uikit.material;
...
public class TBCircularProgressDrawable extends Drawable implements Animatable {
    ...
    private Property<TBCircularProgressDrawable, Float> mAngleProperty = new Property<TBCircularProgressDrawable, Float>(Float.class, "angle") { // from class: com.taobao.tao.sku.widget.base.uikit.material.TBCircularProgressDrawable.1
        ...
        public Float a(TBCircularProgressDrawable tBCircularProgressDrawable) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? (Float) ipChange.ipc$dispatch("4a098e12", new Object[]{this, tBCircularProgressDrawable}) : Float.valueOf(tBCircularProgressDrawable.getCurrentGlobalAngle());
        }

        public void a(TBCircularProgressDrawable tBCircularProgressDrawable, Float f) {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                ipChange.ipc$dispatch("743b6330", new Object[]{this, tBCircularProgressDrawable, f});
            } else {
                tBCircularProgressDrawable.setCurrentGlobalAngle(f.floatValue());
            }
        }
    };
    private Property<TBCircularProgressDrawable, Float> mSweepProperty = new Property<TBCircularProgressDrawable, Float>(Float.class, "arc") { // from class: com.taobao.tao.sku.widget.base.uikit.material.TBCircularProgressDrawable.2
        public static volatile transient /* synthetic */ IpChange $ipChange;
        ...
        public Float a(TBCircularProgressDrawable tBCircularProgressDrawable) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? (Float) ipChange.ipc$dispatch("4a098e12", new Object[]{this, tBCircularProgressDrawable}) : Float.valueOf(tBCircularProgressDrawable.getCurrentSweepAngle());
        }
    ...
    public static /* synthetic */ void access$000(TBCircularProgressDrawable tBCircularProgressDrawable) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("38ce6818", new Object[]{tBCircularProgressDrawable});
        } else {
    ...
    private void setupAnimations() {
        ...
        this.mObjectAnimatorSweep.addListener(new Animator.AnimatorListener() { // from class: com.taobao.tao.sku.widget.base.uikit.material.TBCircularProgressDrawable.3
            public static volatile transient /* synthetic */ IpChange $ipChange;
