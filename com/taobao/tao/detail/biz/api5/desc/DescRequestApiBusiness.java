...
public class DescRequestApiBusiness extends AsynApiTask {
    ...
    public DescRequestApiBusiness(Context context) {
        super(context);
        tpc.a("com.taobao.tao.detail.biz.api5.desc.DescRequestApiBusiness");
    }

    @Override // com.taobao.tao.detail.biz.api5.common.AsynApiTask
    public Class<? extends BaseOutDo> a() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (Class) ipChange.ipc$dispatch("5d842d15", new Object[]{this}) : RequestApiResponse.class;
    }

    /* loaded from: classes8.dex */
    public static class RequestApiResponse extends BaseOutDo {
