...
public class Request extends BaseMessage {
    ...
    public byte[] bodyToProtocol() {
        ...
        njw.l lVar = this.body;
        return lVar != null ? njw.l.toByteArray(lVar) : new byte[0];
    }
    ...
    public Map<String, Object> toMap() {
        ...
        hashMap.put(a.COL_BTAG, this.body.d);
        hashMap.put("offset", Long.valueOf(this.body.f31520a));
