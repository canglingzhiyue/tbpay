...
public class h implements com.taobao.android.nav.e {
    ...
    public boolean process(Intent intent, com.taobao.android.nav.d dVar) {
        ...
        if (StringUtils.isEmpty(queryParameter) || StringUtils.isEmpty(queryParameter2) || StringUtils.isEmpty(queryParameter3) || StringUtils.isEmpty(queryParameter4) || StringUtils.isEmpty(queryParameter5) || StringUtils.isEmpty(queryParameter7)) {
