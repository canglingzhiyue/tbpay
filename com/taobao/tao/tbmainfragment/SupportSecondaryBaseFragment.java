...
public abstract class SupportSecondaryBaseFragment extends TBMainBaseFragment {
    ...
    private boolean checkSwitch() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("32fb98e7", new Object[]{this})).booleanValue() : (d.b(this.mActivity) || d.c(this.mActivity)) && d.d(this.mActivity);
    }
