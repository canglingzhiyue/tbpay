...
public class OrangeUtils {
    ...
    public static String get(String str, Object obj) {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("ae58c17d", new Object[]{str, obj}) : oec.a(com.taobao.tao.flexbox.layoutmanager.adapter.a.a().u().a(str, obj), String.valueOf(obj));
    }

    @FilterHandler(name = "bool")
    public static boolean bool(String str, Object obj) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("d159911b", new Object[]{str, obj})).booleanValue() : oec.a(com.taobao.tao.flexbox.layoutmanager.adapter.a.a().u().a(str, obj), oec.a(obj, false));
    }

    @FilterHandler(name = "int")
    public static int Int(String str, Object obj) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("88beecef", new Object[]{str, obj})).intValue() : oec.a(com.taobao.tao.flexbox.layoutmanager.adapter.a.a().u().a(str, obj), oec.a(obj, 0));
    }
    ...
    */
    public static java.lang.Object a(java.lang.String r6, java.util.List r7) {
        /*
            com.android.alibaba.ip.runtime.IpChange r0 = com.taobao.tao.flexbox.layoutmanager.filter.OrangeUtils.$ipChange
        ...
        L76:
            ...
            java.lang.String r0 = (java.lang.String) r0     // Catch: java.lang.Throwable -> L85
            java.lang.Object r7 = r7.get(r4)     // Catch: java.lang.Throwable -> L85
            java.lang.String r6 = get(r0, r7)     // Catch: java.lang.Throwable -> L85
            return r6
        L85:
            r7 = move-exception
            ...
            java.lang.String r7 = "config.filter"
            tb.ogg.a(r7, r6)
        La3:
            java.lang.String r6 = ""
            return r6
