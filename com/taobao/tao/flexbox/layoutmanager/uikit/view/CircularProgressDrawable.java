...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private Property<CircularProgressDrawable, Float> mAngleProperty = new Property<CircularProgressDrawable, Float>(Float.class, "angle") { // from class: com.taobao.tao.flexbox.layoutmanager.uikit.view.CircularProgressDrawable.1
        public static volatile transient /* synthetic */ IpChange $ipChange;

        /* JADX WARN: Type inference failed for: r4v4, types: [java.lang.Float, java.lang.Object] */
        @Override // android.util.Property
        public /* synthetic */ Float get(CircularProgressDrawable circularProgressDrawable) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? ipChange.ipc$dispatch("83ba8cd9", new Object[]{this, circularProgressDrawable}) : a(circularProgressDrawable);
        }

        @Override // android.util.Property
        public /* synthetic */ void set(CircularProgressDrawable circularProgressDrawable, Float f) {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                ipChange.ipc$dispatch("6f806021", new Object[]{this, circularProgressDrawable, f});
            } else {
                a(circularProgressDrawable, f);
            }
        }

        public Float a(CircularProgressDrawable circularProgressDrawable) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? (Float) ipChange.ipc$dispatch("5ba65e62", new Object[]{this, circularProgressDrawable}) : Float.valueOf(circularProgressDrawable.getCurrentGlobalAngle());
        }

        public void a(CircularProgressDrawable circularProgressDrawable, Float f) {
            IpChange ipChange = $ipChange;
            if (ipChange instanceof IpChange) {
                ipChange.ipc$dispatch("96389ce0", new Object[]{this, circularProgressDrawable, f});
            } else {
                circularProgressDrawable.setCurrentGlobalAngle(f.floatValue());
            }
        }
    };
    private Property<CircularProgressDrawable, Float> mSweepProperty = new Property<CircularProgressDrawable, Float>(Float.class, "arc") { // from class: com.taobao.tao.flexbox.layoutmanager.uikit.view.CircularProgressDrawable.2
        public static volatile transient /* synthetic */ IpChange $ipChange;
        ...
        public Float a(CircularProgressDrawable circularProgressDrawable) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? (Float) ipChange.ipc$dispatch("5ba65e62", new Object[]{this, circularProgressDrawable}) : Float.valueOf(circularProgressDrawable.getCurrentSweepAngle());
        }
    ...
    private void setupAnimations() {
        ...
        this.mObjectAnimatorSweep.addListener(new Animator.AnimatorListener() { // from class: com.taobao.tao.flexbox.layoutmanager.uikit.view.CircularProgressDrawable.3
            public static volatile transient /* synthetic */ IpChange $ipChange;
