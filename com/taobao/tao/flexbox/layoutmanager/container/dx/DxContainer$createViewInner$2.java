...
public final class DxContainer$createViewInner$2 extends Lambda implements ruk<t> {
    ...
    public DxContainer$createViewInner$2(a aVar, int i, int i2, DXTemplateItem dXTemplateItem, a.b bVar, rul rulVar, rva rvaVar) {
        super(0);
        this.this$0 = aVar;
        this.$height = i;
        this.$width = i2;
