...
public class RecommendEdgeClient extends AbsMtopRequestClient<RecommendEdgeParams, RecommendEdgeResult> {
    ...
    public String getApiName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("8523c6ca", new Object[]{this}) : "mtop.taobao.wireless.home.awesome.recommend.edge";
    }
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        RecommendEdgeResultOutDo_ recommendEdgeResultOutDo_ = baseOutDo != null ? (RecommendEdgeResultOutDo_) baseOutDo : null;
        ...
        try {
            if (recommendEdgeResultOutDo_ != null) {
                aVar.onSuccess(recommendEdgeResultOutDo_.mo2429getData());
            } else {
                aVar.onSuccess(null);
            }
        } catch (Throwable th) {
