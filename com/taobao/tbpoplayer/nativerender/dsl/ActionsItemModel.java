...
public class ActionsItemModel implements INativeModel {
    ...
    public boolean isValid() {
        ...
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("3fef87d", new Object[]{this})).booleanValue() : !TextUtils.isEmpty(this.type) && (list = this.content) != null && !list.isEmpty();
    }
}
