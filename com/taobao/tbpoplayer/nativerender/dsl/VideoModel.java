...
public class VideoModel extends ComponentBaseModel {
    ...
    public boolean isValid() {
        ...
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("3fef87d", new Object[]{this})).booleanValue() : !StringUtils.isEmpty(this.url) || !StringUtils.isEmpty(this.videoId);
    }
}
