...
public class DDShareActivity extends Activity implements IDDAPIEventHandler {
    ...
    public DDShareActivity() {
        f.a("com.taobao.clipboard_share", "com.taobao.taobao.ddshare.DDShareActivity");
    ...
    private void a() {
        ...
        ShareAppRegister.registerDingTalk(ShareBizAdapter.getInstance().getShareChannel().e());
    ...
    public void onResp(BaseResp baseResp) {
        ...
        if (i == -3) {
            ...
            AppMonitor.Alarm.commitFail("share", "Share", "SHARE_FAILED_DINGTALK", b.a(R.string.taobao_app_1010_1_18295));
        } else if (i == -2) {
