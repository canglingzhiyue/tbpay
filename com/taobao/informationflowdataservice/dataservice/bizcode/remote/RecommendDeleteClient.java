...
public class RecommendDeleteClient extends AbsMtopRequestClient<RecommendDeleteParams, RecommendDeleteResult> {
    ...
    public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
        ...
        RecommendDeleteResultOutDo_ recommendDeleteResultOutDo_ = baseOutDo != null ? (RecommendDeleteResultOutDo_) baseOutDo : null;
        ...
        try {
            if (recommendDeleteResultOutDo_ != null) {
                aVar.onSuccess(recommendDeleteResultOutDo_.mo2429getData());
            } else {
                aVar.onSuccess(null);
            }
        } catch (Throwable th) {
            lxl.a(TAG, "Call onSuccess exception", th);
        }
    }
