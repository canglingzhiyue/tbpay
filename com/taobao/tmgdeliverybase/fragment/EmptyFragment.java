...
public class EmptyFragment extends Fragment {
    ...
    public static /* synthetic */ a access$000(EmptyFragment emptyFragment) {
        ...
        return ipChange instanceof IpChange ? (a) ipChange.ipc$dispatch("d90b5c64", new Object[]{emptyFragment}) : emptyFragment.mRetryCallback;
    }
    ...
    public void updateErrorViewStatus(boolean z) {
        ...
        if (z) {
            ...
            this.mErrorView.setButton(TBErrorView.ButtonType.BUTTON_LEFT, "加载中", new View.OnClickListener() { // from class: com.taobao.tmgdeliverybase.fragment.EmptyFragment.1
                public static volatile transient /* synthetic */ IpChange $ipChange;
        ...
        this.mErrorView.setButton(TBErrorView.ButtonType.BUTTON_LEFT, "刷新", new View.OnClickListener() { // from class: com.taobao.tmgdeliverybase.fragment.EmptyFragment.2
            public static volatile transient /* synthetic */ IpChange $ipChange;
    ...
    public void setRetryCallback(a aVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("c7b54825", new Object[]{this, aVar});
        } else {
