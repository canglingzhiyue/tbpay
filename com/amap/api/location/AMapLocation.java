...
public class AMapLocation extends Location implements Parcelable, Cloneable {
    ...
    public static final Parcelable.Creator<AMapLocation> CREATOR = new Parcelable.Creator<AMapLocation>() { // from class: com.amap.api.location.AMapLocation.1
        private static AMapLocation a(Parcel parcel) {
            ...
            aMapLocation.f6377a = parcel.readString();
    ...
    public AMapLocation(Location location) {
        ...
        this.r = "";
        this.s = 0;
        this.t = mto.a.GEO_NOT_SUPPORT;
        this.u = mto.a.GEO_NOT_SUPPORT;
        this.v = mto.a.GEO_NOT_SUPPORT;
        this.w = 0.0f;
        this.x = 0.0f;
        Bundle bundle = null;
        this.y = null;
    ...
    public AMapLocation m612clone() {
        ...
        try {
            ...
            aMapLocation.setBuildingId(this.f6377a);
            ...
            if (this.c != null) {
                aMapLocation.setLocationQualityReport(this.c.m614clone());
            }
    ...
    public JSONObject toJson(int i) {
        try {
            ...
            if (i == 1) {
                ...
                jSONObject.put("poiid", this.f6377a);
                jSONObject.put(a.ATOM_EXT_floor, this.b);
    ...
    public String toString() {
        ...
        try {
            ...
            stringBuffer.append("poiid=" + this.f6377a + "#");
            stringBuffer.append("floor=" + this.b + "#");
            stringBuffer.append(ag.ARG_ERROR_CODE + this.p + "#");
