...
public class AMapLocationClientOption implements Parcelable, Cloneable {
    ...
    static /* synthetic */ class AnonymousClass2 {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final /* synthetic */ int[] f6380a = new int[AMapLocationPurpose.values().length];

        static {
            try {
                f6380a[AMapLocationPurpose.SignIn.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f6380a[AMapLocationPurpose.Transport.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f6380a[AMapLocationPurpose.Sport.ordinal()] = 3;
    ...
    /* renamed from: clone */
    public AMapLocationClientOption m613clone() {
        try {
            super.clone();
        } catch (Throwable th) {
            th.printStackTrace();
    ...
    public AMapLocationClientOption setLocationPurpose(AMapLocationPurpose aMapLocationPurpose) {
        ...
        if (aMapLocationPurpose != null) {
            int i = AnonymousClass2.f6380a[aMapLocationPurpose.ordinal()];
            if (i == 1) {
                this.o = AMapLocationMode.Hight_Accuracy;
                this.j = true;
                this.u = true;
