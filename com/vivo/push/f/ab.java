...
final class ab extends aa {
    ...
    protected final void a(com.vivo.push.v vVar) {
        ...
        int i = tVar.i();
        com.vivo.push.util.u.c("OnSetTagsTask", "doTask,删除成功的标签 = " + d + " 删除失败的= " + e + " 错误码= " + i);
        String h = tVar.h();
        if (d != null) {
            for (String str : d) {
        ...
        if (arrayList.size() > 0 || arrayList3.size() > 0) {
            com.vivo.push.util.u.c("OnSetTagsTask", "doTask1,订阅成功的标签 = " + arrayList + " 订阅失败的标签= " + arrayList3 + " 错误码= " + i);
            if (arrayList.size() > 0) {
                com.vivo.push.m.a();
        ...
        if (arrayList2.size() > 0 || arrayList4.size() > 0) {
            com.vivo.push.util.u.c("OnSetTagsTask", "doTask1,订阅成功的别名 = " + arrayList + " 订阅失败的别名= " + arrayList3 + " 错误码= " + i);
