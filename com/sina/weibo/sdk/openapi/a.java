...
public final class a implements IWBAPI {
    ...
    public final void authorizeCallback(Activity activity, int i, int i2, Intent intent) {
        ...
        if (aVar.d != null) {
            if (32973 != i) {
                aVar.d.onError(new UiError(-7, "request code is error", "requestCode is error"));
            } else if (i2 != -1) {
                if (i2 == 0) {
                    aVar.d.onCancel();
                } else {
                    aVar.d.onError(new UiError(-6, "result code is error", "result code is error"));
                }
            } else if (intent == null) {
            } else {
    ...
    public final void shareMessage(Activity activity, WeiboMultiMessage weiboMultiMessage, boolean z) {
        ...
        if (activity != null) {
            ...
            a.C0307a e = com.sina.weibo.sdk.b.a.e(activity);
            if (com.sina.weibo.sdk.a.a(activity) && e != null) {
                a.C0307a e2 = com.sina.weibo.sdk.b.a.e(activity);
                boolean z2 = false;
