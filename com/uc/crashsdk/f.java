...
public class f {
    ...
    static final /* synthetic */ boolean f23759a = !f.class.desiredAssertionStatus();
    ...
    private static String a(StringBuffer stringBuffer) {
        ...
        int indexOf = stringBuffer.indexOf(riy.ARRAY_START_STR);
        if (indexOf < 0) {
            str = "getProcessName: Can not found process name start!";
        } else {
            int i = indexOf + 1;
            int indexOf2 = stringBuffer.indexOf(riy.ARRAY_END_STR, i);
            if (indexOf2 < 0) {
        ...
        com.uc.crashsdk.a.a.a("crashsdk", str, null);
        return null;
    }
    ...
    public static void a(int i, int i2) {
        if (i2 != 0) {
            a(b.c(), new com.uc.crashsdk.a.e(IMediaPlayer.MEDIA_INFO_RTC_VIDEO_FIRST_FRAME_TIME, new Object[]{Integer.valueOf(i), Integer.valueOf(i2)}));
            return;
        }
    ...
    public static boolean a(String str, boolean z) {
        ...
        return a(str, new com.uc.crashsdk.a.e(IMediaPlayer.MEDIA_INFO_RTC_AUDIO_FIRST_PACKET_TIME, new Object[]{str}));
    }
    ...
    */
    public static void d(boolean r3) {
        ...
        L18:
            ...
            boolean r3 = com.uc.crashsdk.b.s()     // Catch: java.lang.Throwable -> L56
            if (r3 == 0) goto L2f
            r3 = 42
            a(r3, r2)     // Catch: java.lang.Throwable -> L56
        L2f:
            ...
            goto L48
        L31:
            boolean r1 = com.uc.crashsdk.b.u()     // Catch: java.lang.Throwable -> L56
            if (r1 == 0) goto L48
