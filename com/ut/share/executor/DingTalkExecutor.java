...
public class DingTalkExecutor implements IShareExecutor {
    ...
    public ShareDingTalkController getDingTalk() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (ShareDingTalkController) ipChange.ipc$dispatch("a83abc60", new Object[]{this}) : this.dingTalk;
    }
    ...
    public void share(Context context, ShareData shareData, ShareListener shareListener) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            shareResponse.errorMessage = b.a(R.string.taobao_app_1010_1_18103);
