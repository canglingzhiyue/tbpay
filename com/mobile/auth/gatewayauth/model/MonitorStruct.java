...
public class MonitorStruct implements e, Serializable {
    ...
    public void fromJson(JSONObject jSONObject) {
        try {
            ...
            setApiParams(a.a(jSONObject.optJSONObject("apiParams")));
        } catch (Throwable th) {
            try {
    ...
    public void setVendorKey(String str) {
        try {
            if (Constant.VENDOR_CUCC.equals(str)) {
                this.vendorKey = Constant.VENDOR_CUXZ;
            } else {
                this.vendorKey = str;
            }
        } catch (Throwable th) {
    ...
    public JSONObject toJson() {
        try {
            ...
            try {
                a2.put("apiParams", new JSONObject(this.apiParams));
