...
public class GetCertifyIdTopResponse implements e {
    ...
    public void fromJson(JSONObject jSONObject) {
        try {
            ...
            setResult((GetCertifyIdResult) a.a(jSONObject.optJSONObject("result"), (d<Object>) new d<GetCertifyIdResult>() { // from class: com.mobile.auth.gatewayauth.model.psc_certify_id.GetCertifyIdTopResponse.1
            }, (List<Field>) null));
        } catch (Throwable th) {
            try {
