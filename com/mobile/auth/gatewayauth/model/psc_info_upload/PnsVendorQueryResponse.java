...
public class PnsVendorQueryResponse implements e {
    ...
    public void fromJson(JSONObject jSONObject) {
        try {
            ...
            setResult((Result) a.a(jSONObject.optJSONObject("result"), (d<Object>) new d<Result>() { // from class: com.mobile.auth.gatewayauth.model.psc_info_upload.PnsVendorQueryResponse.1
            }, (List<Field>) null));
        } catch (Throwable th) {
            try {
