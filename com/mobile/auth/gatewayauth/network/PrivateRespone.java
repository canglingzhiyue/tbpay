...
public class PrivateRespone implements e {
    ...
    public void fromJson(JSONObject jSONObject) {
        try {
            ...
            setData((PrivateKeyRespone) a.a(jSONObject.optJSONObject("Data"), (d<Object>) new d<PrivateKeyRespone>() { // from class: com.mobile.auth.gatewayauth.network.PrivateRespone.1
            }, (List<Field>) null));
        } catch (Throwable th) {
            try {
