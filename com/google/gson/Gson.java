...
public final class Gson {
    ...
    public static class FutureTypeAdapter<T> extends TypeAdapter<T> {
        ...
        public T mo701read(JsonReader jsonReader) throws IOException {
            ...
            if (typeAdapter != null) {
                return typeAdapter.mo701read(jsonReader);
            }
    ...
    private static TypeAdapter<AtomicLong> atomicLongAdapter(final TypeAdapter<Number> typeAdapter) {
        return new TypeAdapter<AtomicLong>() { // from class: com.google.gson.Gson.6
            ...
            public AtomicLong mo701read(JsonReader jsonReader) throws IOException {
                return new AtomicLong(((Number) TypeAdapter.this.mo701read(jsonReader)).longValue());
            }
    ...
    private static TypeAdapter<AtomicLongArray> atomicLongArrayAdapter(final TypeAdapter<Number> typeAdapter) {
        return new TypeAdapter<AtomicLongArray>() { // from class: com.google.gson.Gson.7
            @Override // com.google.gson.TypeAdapter
            /* renamed from: read  reason: collision with other method in class */
            public AtomicLongArray mo701read(JsonReader jsonReader) throws IOException {
                ArrayList arrayList = new ArrayList();
                jsonReader.beginArray();
                while (jsonReader.hasNext()) {
                    arrayList.add(Long.valueOf(((Number) TypeAdapter.this.mo701read(jsonReader)).longValue()));
                }
                jsonReader.endArray();
    ...
    private TypeAdapter<Number> doubleAdapter(boolean z) {
        return z ? TypeAdapters.DOUBLE : new TypeAdapter<Number>() { // from class: com.google.gson.Gson.3
            @Override // com.google.gson.TypeAdapter
            /* renamed from: read */
            public Number mo701read(JsonReader jsonReader) throws IOException {
        ...
        try {
            try {
                try {
                    jsonReader.peek();
                    z = false;
                    T mo701read = getAdapter(TypeToken.get(type)).mo701read(jsonReader);
    ...
    public String toString() {
        return "{serializeNulls:" + this.serializeNulls + "factories:" + this.factories + ",instanceCreators:" + this.constructorConstructor + riy.BLOCK_END_STR;
    }
}
