...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
        ...
        public Map<K, V> mo701read(JsonReader jsonReader) throws IOException {
            ...
            if (peek == JsonToken.BEGIN_ARRAY) {
                ...
                while (jsonReader.hasNext()) {
                    jsonReader.beginArray();
                    K mo701read = this.keyTypeAdapter.mo701read(jsonReader);
                    if (construct.put(mo701read, this.valueTypeAdapter.mo701read(jsonReader)) != null) {
                        throw new JsonSyntaxException("duplicate key: " + mo701read);
                    }
                    jsonReader.endArray();
                }
                jsonReader.endArray();
                ...
                while (jsonReader.hasNext()) {
                    ...
                    K mo701read2 = this.keyTypeAdapter.mo701read(jsonReader);
                    if (construct.put(mo701read2, this.valueTypeAdapter.mo701read(jsonReader)) != null) {
                        throw new JsonSyntaxException("duplicate key: " + mo701read2);
                    }
                }
