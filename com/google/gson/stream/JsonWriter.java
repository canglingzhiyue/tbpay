...
public class JsonWriter implements Closeable, Flushable {
    ...
    */
    ...
    public JsonWriter beginArray() throws IOException {
        writeDeferredName();
        return open(1, riy.ARRAY_START_STR);
    }

    public JsonWriter beginObject() throws IOException {
        writeDeferredName();
        return open(3, riy.BLOCK_START_STR);
    }
    ...
    public JsonWriter endArray() throws IOException {
        return close(1, 2, riy.ARRAY_END_STR);
    }

    public JsonWriter endObject() throws IOException {
        return close(3, 5, riy.BLOCK_END_STR);
    }
    ...
    public final void setIndent(String str) {
        ...
        if (str.length() == 0) {
            ...
            this.indent = str;
            str2 = ResponseProtocolType.COMMENT;
        }
        this.separator = str2;
    }
    ...
    public JsonWriter value(Number number) throws IOException {
        ...
        if (this.lenient || (!obj.equals("-Infinity") && !obj.equals(a.ATOM_EXT_Infinity) && !obj.equals(a.ATOM_EXT_NaN))) {
            beforeValue();
