...
public final class gw {
    ...
    private static int f24511a = 5000;

    /* renamed from: a  reason: collision with other field name */
    private static Vector<String> f453a = new Vector<>();
    ...
    static {
        try {
            for (ClassLoader classLoader : m1996a()) {
                        ...
                        do {
                            if (eventType == 2) {
                                if (newPullParser.getName().equals("className")) {
                                    ...
                                    f24511a = a(newPullParser, f24511a);
                                } else if (newPullParser.getName().equals("keepAliveInterval")) {
                                    b = a(newPullParser, b);
                                } else if (newPullParser.getName().equals("mechName")) {
                                    f453a.add(newPullParser.nextText());
                                }
                            }
    ...
    /* renamed from: a  reason: collision with other method in class */
    private static ClassLoader[] m1996a() {
