...
public class ap extends Handler {
    ...
    public void dispatchMessage(Message message) {
        ...
        synchronized (af.class) {
            context = this.f24314a.f50a;
            if (af.a(context).m1643a(str)) {
                context2 = this.f24314a.f50a;
                if (af.a(context2).a(str) < 10) {
                    ...
                    if (au.DISABLE_PUSH.ordinal() == i) {
                        ...
                        if ("syncing".equals(af.a(context14).a(au.DISABLE_PUSH))) {
                            ...
                            context13 = this.f24314a.f50a;
                            af.a(context13).b(str);
                        }
                    }
                    if (au.ENABLE_PUSH.ordinal() == i) {
                        context12 = this.f24314a.f50a;
                    ...
                    if (au.UPLOAD_HUAWEI_TOKEN.ordinal() == i) {
                        context10 = this.f24314a.f50a;
                        if ("syncing".equals(af.a(context10).a(au.UPLOAD_HUAWEI_TOKEN))) {
                            context11 = this.f24314a.f50a;
                            m1684a = i.m1684a(context11, e.ASSEMBLE_PUSH_HUAWEI);
                            m1684a.put("third_sync_reason", str2);
                            aoVar = this.f24314a;
                            auVar = au.UPLOAD_HUAWEI_TOKEN;
                            aoVar.a(str, auVar, false, m1684a);
                            context13 = this.f24314a.f50a;
                            af.a(context13).b(str);
                        }
                    }
                    if (au.UPLOAD_FCM_TOKEN.ordinal() == i) {
                        context8 = this.f24314a.f50a;
                        if ("syncing".equals(af.a(context8).a(au.UPLOAD_FCM_TOKEN))) {
                            ao aoVar3 = this.f24314a;
                            au auVar3 = au.UPLOAD_FCM_TOKEN;
                            context9 = this.f24314a.f50a;
                            aoVar3.a(str, auVar3, false, i.m1684a(context9, e.ASSEMBLE_PUSH_FCM));
                            context13 = this.f24314a.f50a;
                            af.a(context13).b(str);
                        }
                    }
                    if (au.UPLOAD_COS_TOKEN.ordinal() == i) {
                        context6 = this.f24314a.f50a;
                        if ("syncing".equals(af.a(context6).a(au.UPLOAD_COS_TOKEN))) {
                            context7 = this.f24314a.f50a;
                            m1684a = i.m1684a(context7, e.ASSEMBLE_PUSH_COS);
                            m1684a.put("third_sync_reason", str2);
                            aoVar = this.f24314a;
                    ...
                    if (au.UPLOAD_FTOS_TOKEN.ordinal() == i) {
                        context4 = this.f24314a.f50a;
                        if ("syncing".equals(af.a(context4).a(au.UPLOAD_FTOS_TOKEN))) {
                            context5 = this.f24314a.f50a;
                            m1684a = i.m1684a(context5, e.ASSEMBLE_PUSH_FTOS);
                            m1684a.put("third_sync_reason", str2);
                            aoVar = this.f24314a;
