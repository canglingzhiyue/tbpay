...
public class k {
    ...
    public static String b(Context context, String str) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("1da50fb7", new Object[]{context, str}) : StringUtils.isEmpty(str) ? "" : context.getSharedPreferences("IMAGE_SEARCH_APP", 0).getString("COMMON_".concat(str), "");
    }
    ...
    public static int b(Context context, String str, int i) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("d49a9c0d", new Object[]{context, str, new Integer(i)})).intValue() : StringUtils.isEmpty(str) ? i : context.getSharedPreferences("IMAGE_SEARCH_APP", 0).getInt("COMMON_".concat(str), i);
    }
