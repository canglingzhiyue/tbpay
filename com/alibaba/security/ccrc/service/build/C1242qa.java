...
public class C1242qa implements OnRemoteSoLoadListener {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ OnRemoteSoLoadListener f3321a;
    public final /* synthetic */ WuKongNativeManager b;

    public C1242qa(WuKongNativeManager wuKongNativeManager, OnRemoteSoLoadListener onRemoteSoLoadListener) {
        this.b = wuKongNativeManager;
        this.f3321a = onRemoteSoLoadListener;
    }
    ...
    public void onResult(String str, boolean z, String str2) {
        ...
        if (!z) {
            Logging.w(WuKongNativeManager.f3341a, "load cro_python_kit so fail: " + str2);
            WuKongNativeManager.a(this.b, str, str2);
        } else {
            Logging.d(WuKongNativeManager.f3341a, "load cro_python_kit so success");
        }
        this.f3321a.onResult(str, z, str2);
    }
}
