...
public class j extends n {
    ...
    public String a() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("aff6e538", new Object[]{this}) : "$lt";
    }
    ...
    public boolean a(BigDecimal bigDecimal, BigDecimal bigDecimal2) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("aa6070f4", new Object[]{this, bigDecimal, bigDecimal2})).booleanValue() : a(bigDecimal.compareTo(bigDecimal2));
    }

    @Override // com.alibaba.ut.abtest.bucketing.expression.n
    public boolean a(BigInteger bigInteger, BigInteger bigInteger2) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("c55ec69a", new Object[]{this, bigInteger, bigInteger2})).booleanValue() : a(bigInteger.compareTo(bigInteger2));
    }
}
