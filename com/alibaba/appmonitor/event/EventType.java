...
public enum EventType {
    ALARM(65501, 30, "alarmData", 1000, "ap_alarm", btj.class),
    COUNTER(65502, 30, "counterData", 1000, "ap_counter", btk.class),
    STAT(65503, 30, jhb.KEY_STAT_DATA, 1000, "ap_stat", btl.class);
    ...
    public void setTriggerCount(int i) {
        String str = TAG;
        apr.b(str, "[setTriggerCount]", this.aggregateEventArgsKey, i + "");
        this.triggerCount = i;
    }
}
