...
public class bn<T> extends bt<T> {

    /* renamed from: a  reason: collision with root package name */
    public final FieldWriter f3046a;
    ...
    public bn(Class<T> cls, String str, String str2, long j, List<FieldWriter> list) {
        super(cls, str, str2, j, list);
        this.f3046a = list.get(0);
        this.b = list.get(1);
        this.c = list.get(2);
        this.d = list.get(3);
    }
    ...
    public void a(JSONWriter jSONWriter, Object obj, Object obj2, Type type, long j) {
        ...
        if (jSONWriter.e) {
            ...
            this.f3046a.b(jSONWriter, (JSONWriter) obj);
