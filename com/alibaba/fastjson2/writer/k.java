...
final class k<T> extends FieldWriter<T> {
    static {
        kge.a(2135077482);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public k(String str, int i, long j, String str2, String str3, Method method, Class cls) {
    ...
    public void a(JSONWriter jSONWriter, T t) {
        Character ch = (Character) a((k<T>) t);
        if (ch == null) {
            jSONWriter.n();
        } else {
            jSONWriter.b(ch.charValue());
        }
    }
