...
public class cw implements bu {

    /* renamed from: a  reason: collision with root package name */
    static final long f2978a;
    static final long b;

    static {
        kge.a(211466478);
        kge.a(438295340);
        f2978a = com.alibaba.fastjson2.util.c.b("declaringClass");
    ...
    private Field a(long j, String str, String str2) {
        if ((j & JSONReader.Feature.SupportClassForName.mask) != 0) {
            try {
                return TypeUtils.c(str2).getDeclaredField(str);
    ...
    public Object a(JSONReader jSONReader, Type type, Object obj, long j) {
        ...
        return a(j | jSONReader.f2934a.p, str, str2);
    }
    ...
    @Override // com.alibaba.fastjson2.reader.bu
    public Object c(JSONReader jSONReader, Type type, Object obj, long j) {
        if (jSONReader.t() == 2) {
            String az = jSONReader.az();
            return a(j | jSONReader.f2934a.p, jSONReader.az(), az);
        }
        throw new JSONException("not support input " + jSONReader.aR());
    }

    @Override // com.alibaba.fastjson2.reader.bu
    public Object d(JSONReader jSONReader, Type type, Object obj, long j) {
        if (!jSONReader.q()) {
            throw new JSONException("not support input " + jSONReader.aR());
        }
        String az = jSONReader.az();
        ...
        if (jSONReader.r()) {
            jSONReader.s();
            return a(jSONReader.f2934a.p | j, az2, az);
        }
        throw new JSONException("not support input " + jSONReader.aR());
    }
