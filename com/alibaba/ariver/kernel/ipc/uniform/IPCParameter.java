...
public class IPCParameter implements Parcelable {
    ...
    static {
        kge.a(529048010);
        kge.a(1630535278);
        CREATOR = new Parcelable.Creator<IPCParameter>() { // from class: com.alibaba.ariver.kernel.ipc.uniform.IPCParameter.1
            public static volatile transient /* synthetic */ IpChange $ipChange;

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public IPCParameter mo176createFromParcel(Parcel parcel) {
            ...
            public IPCParameter[] mo177newArray(int i) {
                IpChange ipChange = $ipChange;
