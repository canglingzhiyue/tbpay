...
public final class ShopLoftDXEngine$1$1 extends Lambda implements ruk<t> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public final /* synthetic */ DXTemplateItem $finishedTemplateItem;
    public final /* synthetic */ a this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ShopLoftDXEngine$1$1(a aVar, DXTemplateItem dXTemplateItem) {
        super(0);
        this.this$0 = aVar;
    ...
    public final void mo2427invoke() {
        ...
        a aVar = this.this$0;
        ruw ruwVar = (ruw) a.$ipChange.get(Integer.valueOf(((com.alibaba.triver.triver_shop.newShop.data.b) this.$finishedTemplateItem).a()));
        if (ruwVar == null) {
            return;
        }
