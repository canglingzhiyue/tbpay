...
public final class ShopWidgetContentRender$requestWidgetRenderInfo$2 extends Lambda implements ruw<Integer, String, t> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public final /* synthetic */ ruw<Integer, String, t> $failure;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public ShopWidgetContentRender$requestWidgetRenderInfo$2(ruw<? super Integer, ? super String, t> ruwVar) {
        super(2);
        this.$failure = ruwVar;
    }
