...
public final class IndexNavComponent$init$1$switchTabTo$1 extends Lambda implements ruk<t> {
    ...
    public IndexNavComponent$init$1$switchTabTo$1(com.alibaba.triver.triver_shop.newShop.data.d dVar, d dVar2, int i) {
        super(0);
        this.$shopData = dVar;
        this.this$0 = dVar2;
        this.$tab = i;
    ...
    public final void mo2427invoke() {
        ...
        d dVar2 = this.this$0;
        j.a(dVar, d.$ipChange, this.$tab, null, 8, null);
    }
}
