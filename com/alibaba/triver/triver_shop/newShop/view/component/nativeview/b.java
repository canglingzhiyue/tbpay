...
public final class b {
    ...
    public static final class a implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ FrameLayout f3950a;
        ...
        public final void run() {
            ...
            FrameLayout frameLayout = this.f3950a;
    ...
    /* renamed from: com.alibaba.triver.triver_shop.newShop.view.component.nativeview.b$b  reason: collision with other inner class name */
    /* loaded from: classes3.dex */
    public static final class C0145b implements ValueAnimator.AnimatorUpdateListener {
        public static volatile transient /* synthetic */ IpChange $ipChange;
        ...
        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            a3.setAlpha(f);
            if (z) {
                TUrlImageView e = bVar.e();
                if (e != null) {
                    e.setAlpha(0.0f);
                }
                TUrlImageView d = bVar.d();
                if (d != null) {
                    d.setAlpha(0.0f);
                }
            }
            View b = b.this.b();
            b bVar2 = b.this;
            b.setTranslationY((-(b.getHeight() + o.d((Number) 2))) * Math.min(floatValue * 2, 1.0f));
            bVar2.f().setTranslationY(b.getTranslationY());
    ...
    public static final class c extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (!b.b(b.this)) {
                ...
                TUrlImageView e = b.this.e();
                if (e != null) {
                    e.setAlpha(1.0f);
                }
                TUrlImageView d = b.this.d();
                if (d != null) {
                    d.setAlpha(1.0f);
                }
            } else {
                View c2 = b.c(b.this);
                if (c2 != null) {
                    c2.setOnClickListener(a.INSTANCE);
                }
                FrameLayout a3 = b.a(b.this);
                if (a3 == null) {
                    q.b("container");
                    throw null;
                }
            ...
            ViewParent parent2 = b.this.c().getParent();
            if (parent2 == null) {
                throw new NullPointerException("null cannot be cast to non-null type android.view.View");
            }
            o.b((View) parent2);
    ...
    public static final /* synthetic */ FrameLayout a(b bVar) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (FrameLayout) ipChange.ipc$dispatch("f54d486c", new Object[]{bVar}) : bVar.e;
    }

    public static final /* synthetic */ boolean b(b bVar) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("d67adf52", new Object[]{bVar})).booleanValue() : bVar.k;
    }

    public static final /* synthetic */ View c(b bVar) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (View) ipChange.ipc$dispatch("6fb408d1", new Object[]{bVar}) : bVar.l;
    }
    ...
    public final void b(View root) {
        ...
        if (layoutParams4 != null) {
            ...
            layoutParams5.width = o.d((Number) 58);
            layoutParams5.height = o.d((Number) 58);
            layoutParams5.topMargin = this.i;
            layoutParams5.leftMargin = o.d((Number) 4);
            t tVar2 = t.INSTANCE;
        ...
        if (layoutParams15 != null) {
            ...
            layoutParams16.width = o.d((Number) 58);
            layoutParams16.height = o.d((Number) 58);
            layoutParams16.topMargin = this.i;
            layoutParams16.rightMargin = o.d((Number) 12);
        ...
        if (layoutParams18 instanceof FrameLayout.LayoutParams) {
            layoutParams = (FrameLayout.LayoutParams) layoutParams18;
        }
        if (layoutParams != null) {
            layoutParams.gravity = 17;
            layoutParams.height = -1;
            layoutParams.width = -1;
            layoutParams.leftMargin = o.d((Number) 62);
            layoutParams.rightMargin = o.d((Number) 70);
        } else {
            FrameLayout.LayoutParams layoutParams19 = new FrameLayout.LayoutParams(-2, -2);
            layoutParams19.gravity = 17;
            layoutParams19.height = -1;
            layoutParams19.width = -1;
            layoutParams19.leftMargin = o.d((Number) 62);
            layoutParams19.rightMargin = o.d((Number) 70);
            t tVar16 = t.INSTANCE;
    ...
    public final void a(boolean z) {
        ...
        if (this.j == null) {
            ...
            ofFloat.addUpdateListener(new C0145b(z));
        ...
        if (z2 && (valueAnimator = this.j) != null) {
