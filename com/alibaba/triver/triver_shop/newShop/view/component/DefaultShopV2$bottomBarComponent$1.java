...
public final class DefaultShopV2$bottomBarComponent$1 extends Lambda implements rul<Integer, t> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public final /* synthetic */ c this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DefaultShopV2$bottomBarComponent$1(c cVar) {
        super(1);
        this.this$0 = cVar;
    }
    ...
    public final void invoke(int i) {
        ...
        c cVar = this.this$0;
        com.alibaba.triver.triver_shop.newShop.manager.d dVar = c.$ipChange;
        if (dVar != null) {
            dVar.a(i, false);
        } else {
