...
public final class NewMiniAppContentRender$PreloadCallback$onGetShopLogoAndName$1 extends Lambda implements ruk<t> {
    ...
    public static final class a implements Runnable {
        ...
        public final void run() {
            ...
            App a2 = this.f3894a.a();
            if (a2 != null) {
                a2.putStringValue("shopLogo", this.b);
            }
            App a3 = this.f3894a.a();
            if (a3 == null) {
                return;
            }
