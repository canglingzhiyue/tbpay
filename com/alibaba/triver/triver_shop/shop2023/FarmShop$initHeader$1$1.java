...
public /* synthetic */ class FarmShop$initHeader$1$1 extends FunctionReferenceImpl implements ruk<Boolean> {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    public FarmShop$initHeader$1$1(d dVar) {
        super(0, dVar, d.class, "canGoBack", "canGoBack()Z", 0);
    }
    ...
    public final Boolean mo2427invoke() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("7560cd03", new Object[]{this})).booleanValue() : ((d) this.receiver).z();
    }
}
