...
public final class WVShopApiBridge$foldBigCard$1 extends Lambda implements ruk<t> {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public final /* synthetic */ c $swipeBigCardComponent;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WVShopApiBridge$foldBigCard$1(c cVar) {
        super(0);
    ...
    public final void mo2427invoke() {
        ...
        ruk<t> h = this.$swipeBigCardComponent.h();
        if (h == null) {
            return;
        }
        h.mo2427invoke();
