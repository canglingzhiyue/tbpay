...
public abstract class JSON implements JSONAware, JSONStreamAware {
    ...
    static {
        ...
        DEFAULT_PARSER_FEATURE = Feature.UseBigDecimal.mask | 0 | Feature.SortFeidFastMatch.mask | Feature.IgnoreNotMatch.mask;
        DEFFAULT_DATE_FORMAT = "yyyy-MM-dd HH:mm:ss";
        DEFAULT_GENERATE_FEATURE = SerializerFeature.QuoteFieldNames.mask | 0 | SerializerFeature.SkipTransientField.mask | SerializerFeature.WriteEnumUsingToString.mask | SerializerFeature.SortField.mask;
    }
