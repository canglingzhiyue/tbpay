...
public final class ApkLoaderV25 implements ApkLoader {
    ...
    public final boolean loadDex(ClassLoader classLoader, File file, q qVar, boolean z, boolean z2) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("91cbc261", new Object[]{this, classLoader, file, qVar, new Boolean(z), new Boolean(z2)})).booleanValue() : ApkLoaderV21.injectDexElements(classLoader, file, qVar, z, new V24DexElementsMaker(), WeexZipModule.NAME, new JudgerFromExits(), z2);
    }
}
