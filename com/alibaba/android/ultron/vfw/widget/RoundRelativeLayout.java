        ...
        if (isSupportClipOutline()) {
            ...
            if (f == this.topRightRadius) {
                ...
                if (f == f2 && f2 == this.bottomRightRadius) {
                    final int i = (int) f;
                    setOutlineProvider(new ViewOutlineProvider() { // from class: com.alibaba.android.ultron.vfw.widget.RoundRelativeLayout.1
                        public static volatile transient /* synthetic */ IpChange $ipChange;
            ...
            if (f3 == this.topRightRadius && this.bottomLeftRadius == 0.0f && this.bottomRightRadius == 0.0f) {
                final int i2 = (int) f3;
                setOutlineProvider(new ViewOutlineProvider() { // from class: com.alibaba.android.ultron.vfw.widget.RoundRelativeLayout.2
                    public static volatile transient /* synthetic */ IpChange $ipChange;
            ...
            if (f4 == this.bottomRightRadius && this.topLeftRadius == 0.0f && this.topRightRadius == 0.0f) {
                final int i3 = (int) f4;
                setOutlineProvider(new ViewOutlineProvider() { // from class: com.alibaba.android.ultron.vfw.widget.RoundRelativeLayout.3
                    public static volatile transient /* synthetic */ IpChange $ipChange;
            ...
            if (f5 == this.bottomLeftRadius && this.topRightRadius == 0.0f && this.bottomRightRadius == 0.0f) {
                final int i4 = (int) f5;
                setOutlineProvider(new ViewOutlineProvider() { // from class: com.alibaba.android.ultron.vfw.widget.RoundRelativeLayout.4
                    public static volatile transient /* synthetic */ IpChange $ipChange;
            ...
            if (f6 == this.bottomRightRadius && this.topLeftRadius == 0.0f && this.bottomLeftRadius == 0.0f) {
                final int i5 = (int) f6;
                setOutlineProvider(new ViewOutlineProvider() { // from class: com.alibaba.android.ultron.vfw.widget.RoundRelativeLayout.5
                    public static volatile transient /* synthetic */ IpChange $ipChange;
