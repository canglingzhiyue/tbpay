...
public class c {
    ...
    public static void a(String str, String str2, String... strArr) {
        ...
        fVar.a(str, str2, "", "", 0, strArr);
    }

    public static void a(f fVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("dad52763", new Object[]{fVar});
        } else {
            f2616a = fVar;
        }
    }
    ...
    public static void a(e eVar) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("dad4b304", new Object[]{eVar});
        } else {
            b = eVar;
        }
    }
    ...
    public static void a(String str, String str2, String str3) {
        ...
        e eVar = b;
        if (eVar != null) {
            eVar.a("EventChain", str + "-onHandleEventChain", str2, str4, hashMap);
        }
    ...
    public static void a(String str, String str2, String str3, String str4) {
        ...
        e eVar = b;
        if (eVar != null) {
            eVar.a("EventChain", str + "-" + str2, str3, str5, hashMap);
        }
    ...
    private static void a(String str, String str2, String str3, String str4, String... strArr) {
        ...
        fVar.a(str, str2, str3, str4, 0, strArr);
    }
    ...
    public static java.lang.String a(java.lang.Throwable r3) {
        /*
            com.android.alibaba.ip.runtime.IpChange r0 = com.alibaba.android.ultron.ext.event.util.c.$ipChange
        ...
        L65:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alibaba.android.ultron.ext.event.util.c.a(java.lang.Throwable):java.lang.String");
    }
