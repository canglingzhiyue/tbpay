...
public class a extends c {
    ...
    protected void c(Notification.Builder builder, MessageV3 messageV3) {
        ...
        if (MinSdkChecker.isSupportNotificationBuild()) {
            ...
            if (messageV3.getNotificationStyle() == null || a() || StringUtils.isEmpty(messageV3.getNotificationStyle().getExpandableImageUrl()) || (a2 = a(messageV3.getNotificationStyle().getExpandableImageUrl())) == null) {
                return;
            }
