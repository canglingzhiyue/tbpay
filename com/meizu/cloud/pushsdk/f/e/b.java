...
public class b extends SQLiteOpenHelper {
    ...
    private static final String f7965a = "com.meizu.cloud.pushsdk.f.e.b";
    private static b b;
    ...
    public void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        String str = f7965a;
        com.meizu.cloud.pushsdk.f.g.c.a(str, "Upgrading database from version " + i + " to " + i2 + ". Destroying old data now..", new Object[0]);
