...
public class f extends com.meizu.cloud.pushsdk.handler.e.a<UnRegisterStatus> {
    ...
    public UnRegisterStatus f(Intent intent) {
        ...
        UnRegisterStatus e = !TextUtils.isEmpty(stringExtra) ? com.meizu.cloud.pushsdk.platform.message.a.e(stringExtra) : (UnRegisterStatus) intent.getSerializableExtra(PushConstants.EXTRA_APP_PUSH_UNREGISTER_STATUS);
