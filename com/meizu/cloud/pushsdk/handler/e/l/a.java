...
public class a extends com.meizu.cloud.pushsdk.handler.e.a<PushSwitchStatus> {
    ...
    public PushSwitchStatus f(Intent intent) {
        ...
        PushSwitchStatus a2 = !StringUtils.isEmpty(stringExtra) ? com.meizu.cloud.pushsdk.platform.message.a.a(stringExtra) : (PushSwitchStatus) intent.getSerializableExtra(PushConstants.EXTRA_APP_PUSH_SWITCH_STATUS);
