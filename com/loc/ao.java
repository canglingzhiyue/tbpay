...
public final class ao {
    ...
    private static byte[] a(byte[] bArr) {
        try {
            if (f7660a == null) {
                f7660a = x.c("YAAAAAAAAAAAAAAAAAAAAAA").getBytes();
            }
            IvParameterSpec ivParameterSpec = new IvParameterSpec(f7660a);
