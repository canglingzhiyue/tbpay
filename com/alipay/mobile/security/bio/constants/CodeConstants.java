...
public class CodeConstants {
    ...
    public static String SUCCESS = "Z5120";
    ...
    private static Map f5786a = new HashMap() { // from class: com.alipay.mobile.security.bio.constants.CodeConstants.1
        {
    ...
    public static String getMessage(String str) {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("f7d8193e", new Object[]{str}) : String.format("%s(%s)", f5786a.get(str), str);
    }
}
