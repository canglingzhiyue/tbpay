...
public class ZcodeConstants {
    ...
    private static Map f5787a = new HashMap() { // from class: com.alipay.mobile.security.bio.constants.ZcodeConstants.1
        {
    ...
    public static String getMessage(String str) {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("f7d8193e", new Object[]{str}) : String.format("%s(%s)", f5787a.get(str), str);
    }
}
