...
public interface BioDetector {
    ...
    public static final String EXT_KEY_THIN_PROTOCOL = "isThinProtocol";
    ...
    /* loaded from: classes3.dex */
    public enum BioDetectorState {
        DESTROYED,
        INITIALIZED,
        CREATED,
        STARTED;

        public boolean isAtLeast(BioDetectorState bioDetectorState) {
            return compareTo(bioDetectorState) >= 0;
        }
    }
