...
public class BioError {
    ...
    public static final int ERROR_FAILED_TO_READ_TOYGER_RESOURCE_CONFIG = 401;
    ...
    public static final int ERROR_TOYGER_RESOURCE_NOT_REALDY = 401;
    public static final int ERROR_USER_CANCELLED = 301;
    public static final int ERROR_USER_CHOOSE_OTHER_AUTH = 305;
