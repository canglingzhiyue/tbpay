...
public enum TransportConfigureItem implements ConfigureItem {
    ...
    AMNET_SWITCH("as", ils.ARCH_BIT64),
    ...
    AMNET_DOWNGRADE_RPC_TRIGGER_TIME("adrtt", AgooConstants.ACK_PACK_ERROR),
    ...
    DJG_SWITCH("djgswh", ils.ARCH_BIT64),
    NBNET_DL_SWITCH("nbdls4", "-1"),
    NBNET_DL_OVERSEA_SWITCH("nbdlos", ils.ARCH_BIT64),
    NBNET_UP_SWITCH("nbups4", ils.ARCH_BIT64),
    ...
    DOWNLOAD_DOWNGRADE("dwndg", ils.ARCH_BIT64),
    DOWNLOADERR_RETRY("dwerrty", ils.ARCH_BIT64),
    ...
    INIT_MERGE_CMD("imc", ils.ARCH_BIT64),
    ABTAG("ab_tag", ""),
    ...
    TCPINFO_LOG_UPLOAD("tlu", ils.ARCH_BIT64),
    ...
    DB_STORAGE_SWITCH("dbss", ils.ARCH_BIT64),
    ...
    LOGIN_INTERCEPTOR("loginter3", ils.ARCH_BIT64),
    LOGIN_REFRESH_SWITCH("lrs", ils.ARCH_BIT64),
    ...
    LOW_VERSION_ENABLE_SSL("lowenabletls", ils.ARCH_BIT64),
    USE_BIFROST("am_ub", ils.ARCH_BIT64),
    ...
    BIFROST_DISABLSE_RPC_DOWNGRADE("bdrd", ils.ARCH_BIT64),
    SUPPORT_ONLY_PUSH_SWITCH("sops", ils.ARCH_BIT64),
    SUPPORT_AUTO_UPGRADE_SWITCH("saus", ils.ARCH_BIT64),
    ...
    USE_IPV6("uipv6", ils.ARCH_BIT64),
    IPV6_TEST_RPC("ipv6test", "0"),
    MAINLINK_ALLOW_IPV6("mlaipv6", ils.ARCH_BIT64),
    TRANSPORT_LOCAL_AMNET("tla", ils.ARCH_BIT64),
    ...
    BIFROST_H2_MULTIPLEX_GW_DOMAIN_SWITCH("bhmgds", ils.ARCH_BIT64),
    CORRECT_CHECK_SIGN_TIMESTAMP_FAILURE("ccstf", ils.ARCH_BIT64),
    HTTPS_RETRY_RPC_SWITCH("sretrysw", ils.ARCH_BIT64),
