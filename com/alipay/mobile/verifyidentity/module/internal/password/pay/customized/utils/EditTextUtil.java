...
public class EditTextUtil {
    ...
    private Map<Integer, String> f5908a = new ConcurrentHashMap();
    ...
    public void OnTextChanged(int i, String str, int i2, int i3, int i4) {
        ...
        String str2 = this.f5908a.get(Integer.valueOf(i));
        if (str2 == null) {
            str2 = "";
        }
        try {
            ...
            Map<Integer, String> map = this.f5908a;
    ...
    public String getText(int i, String str, String str2, EncryptRandomType encryptRandomType) {
        ...
        String str4 = this.f5908a.get(Integer.valueOf(i));
        if (str4 == null) {
            return "";
        }
    ...
    public void clear(int i) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            this.f5908a.remove(Integer.valueOf(i));
        }
    }
}
