...
public class AuthenticatorManagerProxy implements ASProxy {
    ...
    public static /* synthetic */ SentryDelegate access$000(AuthenticatorManagerProxy authenticatorManagerProxy) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (SentryDelegate) ipChange.ipc$dispatch("aa76ac4a", new Object[]{authenticatorManagerProxy}) : authenticatorManagerProxy.delegate;
    }
    ...
    public static /* synthetic */ JSONObject access$100(AuthenticatorManagerProxy authenticatorManagerProxy, AuthenticatorResponse authenticatorResponse) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (JSONObject) ipChange.ipc$dispatch("60ff4a7d", new Object[]{authenticatorManagerProxy, authenticatorResponse}) : a(authenticatorResponse);
    }
