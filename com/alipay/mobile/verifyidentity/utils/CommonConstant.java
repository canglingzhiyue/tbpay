...
public class CommonConstant {
    ...
    public static final String CANCEL_SUB_BY_START_ACTIVITY_TIMEOUT = "1011";
    ...
    public static final String PPWFIRST = "ppwFirst";
    ...
    public static final String VI_SDK_VERSION = "3.2.15.205";
