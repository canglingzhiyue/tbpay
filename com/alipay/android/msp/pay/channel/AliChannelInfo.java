...
public class AliChannelInfo implements IChannelInfo {
    ...
    public String getApiName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("8523c6ca", new Object[]{this}) : "com.alipay.taobaopay";
    }

    @Override // com.alipay.android.msp.framework.constraints.IChannelInfo
    public String getAppKey() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("49079005", new Object[]{this}) : "2013120400002258";
    }
