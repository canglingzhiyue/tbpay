...
public final class Version {
    ...
    private static final int[] f4809a = {31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};
    private static final Version[] b = a();
    private final int c;
    private final int[] d;
    ...
    public final int getVersionNumber() {
        ...
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("7dcce585", new Object[]{this})).intValue() : this.c;
    }

    public final int[] getAlignmentPatternCenters() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (int[]) ipChange.ipc$dispatch("3e25c082", new Object[]{this}) : this.d;
    }

    public final int getTotalCodewords() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("2d92f468", new Object[]{this})).intValue() : this.f;
    }

    public final int getDimensionForVersion() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("c201f99", new Object[]{this})).intValue() : (this.c * 4) + 17;
    }

    public final ECBlocks getECBlocksForLevel(ErrorCorrectionLevel errorCorrectionLevel) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (ECBlocks) ipChange.ipc$dispatch("a2f64aea", new Object[]{this, errorCorrectionLevel}) : this.e[errorCorrectionLevel.ordinal()];
    }
    ...
    public static final class ECBlocks {
        ...
        public final int getECCodewordsPerBlock() {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("341ea2d2", new Object[]{this})).intValue() : this.f4811a;
        }
        ...
        public final int getTotalECCodewords() {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("73d9d80a", new Object[]{this})).intValue() : this.f4811a * getNumBlocks();
        }

        public final ECB[] getECBlocks() {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? (ECB[]) ipChange.ipc$dispatch("596f324c", new Object[]{this}) : this.b;
        }
    }
