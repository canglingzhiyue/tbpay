...
public class Commands {
    public static int COMMAND_BRACELET_AUTH = 4608;
    public static int COMMAND_BRACELET_AUTH_UPDATE = 5888;
    public static int COMMAND_BRACELET_DEREG = 4864;
    public static int COMMAND_BRACELET_REG = 4352;
    public static int COMMAND_BRACELET_USERSTATUS = 5120;
    ...
    public static int COMMAND_MASK_BRACELET = 65280;
