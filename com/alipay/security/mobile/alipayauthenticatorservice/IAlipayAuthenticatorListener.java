...
public interface IAlipayAuthenticatorListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAlipayAuthenticatorListener {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            int callback = callback(parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
        ...
        /* loaded from: classes3.dex */
        private static class Proxy implements IAlipayAuthenticatorListener {
