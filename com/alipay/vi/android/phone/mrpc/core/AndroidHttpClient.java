...
public final class AndroidHttpClient implements HttpClient {
    ...
    private static String[] f6194a = {"text/", "application/xml", "application/json"};
    private static final HttpRequestInterceptor b = new HttpRequestInterceptor() { // from class: com.alipay.vi.android.phone.mrpc.core.AndroidHttpClient.1
    ...
    public static /* synthetic */ LoggingConfiguration access$300(AndroidHttpClient androidHttpClient) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (LoggingConfiguration) ipChange.ipc$dispatch("9573a229", new Object[]{androidHttpClient}) : androidHttpClient.e;
    }
    ...
    private AndroidHttpClient(ClientConnectionManager clientConnectionManager, HttpParams httpParams) {
        this.c = new DefaultHttpClient(clientConnectionManager, httpParams) { // from class: com.alipay.vi.android.phone.mrpc.core.AndroidHttpClient.2
            public static volatile transient /* synthetic */ IpChange $ipChange;
            ...
            public RedirectHandler createRedirectHandler() {
                IpChange ipChange = $ipChange;
                return ipChange instanceof IpChange ? (RedirectHandler) ipChange.ipc$dispatch("e60fb571", new Object[]{this}) : new DefaultRedirectHandler() { // from class: com.alipay.vi.android.phone.mrpc.core.AndroidHttpClient.2.1
                    public static volatile transient /* synthetic */ IpChange $ipChange;
            ...
            public ConnectionKeepAliveStrategy createConnectionKeepAliveStrategy() {
                IpChange ipChange = $ipChange;
                return ipChange instanceof IpChange ? (ConnectionKeepAliveStrategy) ipChange.ipc$dispatch("aa827552", new Object[]{this}) : new ConnectionKeepAliveStrategy() { // from class: com.alipay.vi.android.phone.mrpc.core.AndroidHttpClient.2.2
                    public static volatile transient /* synthetic */ IpChange $ipChange;
    ...
    public static class LoggingConfiguration {
        ...
        public static /* synthetic */ boolean access$400(LoggingConfiguration loggingConfiguration) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? ((Boolean) ipChange.ipc$dispatch("3a5420f6", new Object[]{loggingConfiguration})).booleanValue() : Log.isLoggable(loggingConfiguration.f6195a, loggingConfiguration.b);
        }
    }
