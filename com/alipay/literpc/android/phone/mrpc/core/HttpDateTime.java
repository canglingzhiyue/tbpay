...
public final class HttpDateTime {
    ...
    private static final Pattern f5289a = Pattern.compile("([0-9]{1,2})[- ]([A-Za-z]{3,9})[- ]([0-9]{2,4})[ ]([0-9]{1,2}:[0-9][0-9]:[0-9][0-9])");
    ...
    public static long parse(String str) throws IllegalArgumentException {
        ...
        Matcher matcher = f5289a.matcher(str);
        if (matcher.find()) {
        ...
        time.set(timeOfDay.c, timeOfDay.b, timeOfDay.f5290a, i3, i4, i2);
    ...
    private static TimeOfDay d(String str) {
        ...
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (TimeOfDay) ipChange.ipc$dispatch("78b7c3c6", new Object[]{str});
        }
