...
public class BioLibFile implements BioDownloadItem {
    ...
    public String getArch() {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("2f51adad", new Object[]{this}) : this.arch;
    }

    public void setArch(String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("4f634869", new Object[]{this, str});
        } else {
            this.arch = str;
        }
    }
    ...
    public String toString() {
        ...
        return "BioLibFile{fileName='" + this.fileName + "', url='" + this.url + "', arch='" + this.arch + "', md5='" + this.md5 + "', version='" + this.version + "', savePath='" + this.savePath + "'}";
    }
}
