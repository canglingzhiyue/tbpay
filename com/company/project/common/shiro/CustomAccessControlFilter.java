...
import com.company.project.common.utils.HttpConStringUtils;
...
public class CustomAccessControlFilter extends AccessControlFilter {
    ...
    protected boolean onAccessDenied(ServletRequest servletRequest, ServletResponse servletResponse) throws IOException, ServletException {
        ...
        try {
            ...
            System.out.println(HttpConStringUtils.isAjaxRequest(request));
            ...
            if (HttpConStringUtils.isAjaxRequest(request)) {
