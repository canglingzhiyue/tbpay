...
import com.company.project.common.utils.SpringConStringUtils;
...
public class ScheduleJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) {
        ...
        //获取spring bean
        SysJobLogService scheduleJobLogService = (SysJobLogService) SpringConStringUtils.getBean("sysJobLogService");
        ...
        try {
            ...
            Object target = SpringConStringUtils.getBean(scheduleJob.getBeanName());
            assert target != null;
    ...
    public static DataResult judgeBean(String beanName) {
        ...
        Object target = SpringConStringUtils.getBean(beanName);
        if (target == null) {
