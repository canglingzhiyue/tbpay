...
public class e implements com.taobao.android.nav.e {
                ...
                try {
                    ...
                    for (int i = 0; i < parseArray.size(); i++) {
                        if (parseArray.getJSONObject(i).getBoolean("offSwitcher").booleanValue()) {
                            ...
                            if (!StringUtils.isEmpty(string2) && !StringUtils.isEmpty(string3) && (StringUtils.isEmpty(string4) || !a(string4, data.toString()))) {
                                String string6 = parseArray.getJSONObject(i).getString(string2);
                                if (StringUtils.isEmpty(string6)) {
                                    continue;
                                } else if ((!StringUtils.isEmpty(string5) ? Pattern.compile(string5).matcher(intent.getDataString()).find() : true) && a(string3, data.getHost(), data.getPath())) {
                                    StringBuffer stringBuffer = new StringBuffer();
                                    stringBuffer.append(string6);
                                    if (!StringUtils.isEmpty(data.getEncodedQuery())) {
    ...
    private static boolean a(String str, String str2, String str3) {
        ...
        if (!StringUtils.isEmpty(str2) && !StringUtils.isEmpty(str)) {
            ...
            String str4 = !StringUtils.isEmpty(str3) ? str2 + str3 : str2;
