...
public abstract class YogaNodeJNIBase extends YogaNode implements Cloneable {
    ...
    public YogaNodeJNIBase mo641cloneWithoutChildren() {
        try {
    ...
    public YogaNodeJNIBase mo642getChildAt(int i) {
        List<YogaNodeJNIBase> list = this.mChildren;
        if (list != null) {
            return list.get(i);
        }
    ...
    public YogaNodeJNIBase mo643getOwner() {
        return this.mOwner;
    }
    ...
    public YogaNodeJNIBase mo644getParent() {
        return mo643getOwner();
    }
    ...
    public YogaNodeJNIBase mo645removeChildAt(int i) {
        List<YogaNodeJNIBase> list = this.mChildren;
        if (list != null) {
