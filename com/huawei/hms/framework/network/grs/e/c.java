...
public class c {
    ...
    private final PLSharedPreferences f7419a;
    ...
    public c(Context context, String str) {
        ...
        if (map.containsKey(str + packageName)) {
            ...
            this.f7419a = map2.get(str + packageName);
        } else {
            this.f7419a = new PLSharedPreferences(context, str + packageName);
            Map<String, PLSharedPreferences> map3 = c;
            map3.put(str + packageName, this.f7419a);
        }
        a(context);
    }
    ...
    public String a(String str, String str2) {
        String string;
        PLSharedPreferences pLSharedPreferences = this.f7419a;
        if (pLSharedPreferences == null) {
            return str2;
        }
        synchronized (pLSharedPreferences) {
            string = this.f7419a.getString(str, str2);
        }
        return string;
    }
    ...
    public void b(String str, String str2) {
        ...
        synchronized (pLSharedPreferences) {
            this.f7419a.putString(str, str2);
        }
    }
}
