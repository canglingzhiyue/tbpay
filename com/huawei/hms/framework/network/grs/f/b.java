...
public class b {
    ...
    public String a(Context context, com.huawei.hms.framework.network.grs.e.a aVar, GrsBaseInfo grsBaseInfo, String str, String str2, boolean z) {
        synchronized (c) {
            ...
            Map<String, b> map = b;
            map.put(context.getPackageName() + grsBaseInfo.uniqueCode(), this);
            return this.f7421a.a(context, aVar, grsBaseInfo, str, str2, z);
        }
    }
    ...
    public Map<String, String> a(Context context, com.huawei.hms.framework.network.grs.e.a aVar, GrsBaseInfo grsBaseInfo, String str, boolean z) {
        synchronized (c) {
            Map<String, String> a2 = this.f7421a.a(context, aVar, grsBaseInfo, str, z);
            if ((a2 == null || a2.isEmpty()) && this.f7421a.d()) {
                a(context, true);
                a(grsBaseInfo);
                Map<String, b> map = b;
                map.put(context.getPackageName() + grsBaseInfo.uniqueCode(), this);
                return this.f7421a.a(context, aVar, grsBaseInfo, str, z);
            }
            return a2;
        }
    }
    ...
    public void a(Context context, boolean z) {
        ...
        if (!this.f7421a.e() && arrayList.contains("grs_sdk_global_route_config.json")) {
            this.f7421a = new c(context, z);
        }
        this.f7421a.a(context, arrayList);
    }

    public void a(GrsBaseInfo grsBaseInfo) {
        this.f7421a.a(grsBaseInfo);
    }
