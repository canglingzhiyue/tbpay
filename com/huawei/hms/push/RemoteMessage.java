...
public class RemoteMessage implements Parcelable {
    ...
    public static class Builder {
        ...
        public RemoteMessage build() {
            ...
            try {
                ...
                try {
                    ...
                    jSONObject3.put(RemoteMessageConst.COLLAPSE_KEY, this.f7516a.getString(RemoteMessageConst.COLLAPSE_KEY));
                    jSONObject3.put(RemoteMessageConst.TTL, this.f7516a.getInt(RemoteMessageConst.TTL));
                    jSONObject3.put(RemoteMessageConst.SEND_MODE, this.f7516a.getInt(RemoteMessageConst.SEND_MODE));
                    jSONObject3.put(RemoteMessageConst.RECEIPT_MODE, this.f7516a.getInt(RemoteMessageConst.RECEIPT_MODE));
                    JSONObject jSONObject4 = new JSONObject();
                    if (jSONObject.length() != 0) {
                        jSONObject4.put("data", jSONObject2);
                    }
                    jSONObject4.put(RemoteMessageConst.MSGID, this.f7516a.getString(RemoteMessageConst.MSGID));
                    jSONObject3.put(RemoteMessageConst.MessageBody.MSG_CONTENT, jSONObject4);
                    bundle.putByteArray(RemoteMessageConst.MSGBODY, jSONObject3.toString().getBytes(k.f7523a));
                    bundle.putString("to", this.f7516a.getString("to"));
                    bundle.putString("message_type", this.f7516a.getString("message_type"));
        ...
        public Builder setCollapseKey(String str) {
            this.f7516a.putString(RemoteMessageConst.COLLAPSE_KEY, str);
            return this;
        }
        ...
        public Builder setMessageId(String str) {
            this.f7516a.putString(RemoteMessageConst.MSGID, str);
            return this;
        }

        public Builder setMessageType(String str) {
            this.f7516a.putString("message_type", str);
            return this;
        }

        public Builder setReceiptMode(int i) {
            if (i == 1 || i == 0) {
                this.f7516a.putInt(RemoteMessageConst.RECEIPT_MODE, i);
                return this;
            }
        ...
        public Builder setSendMode(int i) {
            if (i == 0 || i == 1) {
                this.f7516a.putInt(RemoteMessageConst.SEND_MODE, i);
                return this;
            }
        ...
        public Builder setTtl(int i) {
            ...
            this.f7516a.putInt(RemoteMessageConst.TTL, i);
            return this;
        }
    }
    ...
    public static class Notification implements Serializable {
        ...
        private Notification(Bundle bundle) {
            this.f7517a = bundle.getString(RemoteMessageConst.Notification.NOTIFY_TITLE);
    ...
    public RemoteMessage(Bundle bundle) {
        this.f7515a = a(bundle);
    }

    public RemoteMessage(Parcel parcel) {
        this.f7515a = parcel.readBundle();
    ...
    public String getAnalyticInfo() {
        return this.f7515a.getString(RemoteMessageConst.ANALYTIC_INFO);
    }

    public Map<String, String> getAnalyticInfoMap() {
        HashMap hashMap = new HashMap();
        String string = this.f7515a.getString(RemoteMessageConst.ANALYTIC_INFO);
    ...
    public String getCollapseKey() {
        return this.f7515a.getString(RemoteMessageConst.COLLAPSE_KEY);
    }

    public String getData() {
        return this.f7515a.getString("data");
    }

    public Map<String, String> getDataOfMap() {
        HashMap hashMap = new HashMap();
        String string = this.f7515a.getString("data");
        if (string != null && !string.trim().isEmpty()) {
            try {
                JSONObject jSONObject = new JSONObject(string);
                Iterator<String> keys = jSONObject.keys();
    ...
    public String getFrom() {
        return this.f7515a.getString("from");
    }

    public String getMessageId() {
        return this.f7515a.getString(RemoteMessageConst.MSGID);
    }

    public String getMessageType() {
        return this.f7515a.getString("message_type");
    }

    public Notification getNotification() {
        Bundle bundle = this.f7515a.getBundle(RemoteMessageConst.NOTIFICATION);
    ...
    public int getOriginalUrgency() {
        int i2 = this.f7515a.getInt(RemoteMessageConst.ORI_URGENCY);
        if (i2 == 1 || i2 == 2) {
            return i2;
        }
        return 0;
    ...
    public int getReceiptMode() {
        return this.f7515a.getInt(RemoteMessageConst.RECEIPT_MODE);
    }

    public int getSendMode() {
        return this.f7515a.getInt(RemoteMessageConst.SEND_MODE);
    }
    ...
    public String getTo() {
        return this.f7515a.getString("to");
    }

    public String getToken() {
        return this.f7515a.getString(RemoteMessageConst.DEVICE_TOKEN);
    }

    public int getTtl() {
        return this.f7515a.getInt(RemoteMessageConst.TTL);
    }

    public int getUrgency() {
        int i2 = this.f7515a.getInt(RemoteMessageConst.URGENCY);
        if (i2 == 1 || i2 == 2) {
            return i2;
        }
        return 0;
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        parcel.writeBundle(this.f7515a);
