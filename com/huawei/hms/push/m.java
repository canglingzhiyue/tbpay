...
public class m {
    ...
    private JSONObject a(JSONObject jSONObject) throws JSONException {
        ...
        jSONObject2.put("group", this.f7525a);
    ...
    private void g(JSONObject jSONObject) {
        this.f7525a = jSONObject.optString("group");
        HMSLog.d("PushSelfShowLog", "NOTIFY_GROUP:" + this.f7525a);
    ...
    public byte[] o() {
        try {
            return a(a(b(v()), r())).toString().getBytes(k.f7523a);
        } catch (JSONException e) {
    ...
    public byte[] y() {
        return this.s.getBytes(k.f7523a);
    }
