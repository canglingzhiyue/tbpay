...
public final class ConnectionResult implements Parcelable {
    ...
    public static String getErrorString(int i) {
        if (i != -1) {
            ...
            switch (i) {
                ...
                default:
                    return "UNKNOWN_ERROR_CODE(" + i + riy.BRACKET_END_STR;
            }
        }
        return "UNKNOWN";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ConnectionResult) {
            try {
                if (this.apiVersion == ((ConnectionResult) obj).apiVersion && this.connectionErrorCode == ((ConnectionResult) obj).connectionErrorCode && this.connectionErrorMessage.equals(((ConnectionResult) obj).connectionErrorMessage)) {
