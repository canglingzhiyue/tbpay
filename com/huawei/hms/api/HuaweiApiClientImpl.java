...
public class HuaweiApiClientImpl extends HuaweiApiClient implements ServiceConnection, InnerApiClient {
    ...
    class c extends IAIDLCallback.Stub {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ ResultCallback f7354a;

        c(ResultCallback resultCallback) {
            this.f7354a = resultCallback;
        }
        ...
        public void call(DataBuffer dataBuffer) {
            if (dataBuffer == null) {
                ...
                this.f7354a.onResult(new BundleResult(-1, null));
                return;
            }
            ...
            this.f7354a.onResult(bundleResult);
        }
    }
    ...
    static class d extends PendingResultImpl<Status, IMessageEntity> {
        ...
        /* renamed from: a */
        public Status mo785onComplete(IMessageEntity iMessageEntity) {
            return new Status(0);
        }
    }
    ...
    public class e implements ResultCallback<ResolveResult<ConnectResp>> {
        ...
        public class a implements Runnable {
            ...
            /* renamed from: a  reason: collision with root package name */
            final /* synthetic */ ResolveResult f7356a;

            a(ResolveResult resolveResult) {
                this.f7356a = resolveResult;
            }

            @Override // java.lang.Runnable
            public void run() {
                HuaweiApiClientImpl.this.a(this.f7356a);
            }
        }
    ...
    public class f implements ResultCallback<ResolveResult<DisconnectResp>> {
        ...
        public class a implements Runnable {
            ...
            /* renamed from: a  reason: collision with root package name */
            final /* synthetic */ ResolveResult f7358a;

            a(ResolveResult resolveResult) {
                this.f7358a = resolveResult;
            }

            @Override // java.lang.Runnable
            public void run() {
                HuaweiApiClientImpl.this.b(this.f7358a);
            }
        }
    ...
    public void disableLifeCycleManagement(Activity activity) {
        if (this.f7351a >= 0) {
            AutoLifecycleFragment.getInstance(activity).stopAutoManage(this.f7351a);
            return;
        }
