...
public class ForegroundInnerHeader {
    ...
    public void fromJson(String str) {
        try {
            ...
            this.f7324a = JsonUtil.getIntValue(jSONObject, "apkVersion");
    ...
    public String toJson() {
        ...
        try {
            jSONObject.put("apkVersion", this.f7324a);
    ...
    public String toString() {
        return "apkVersion:" + this.f7324a + ", action:" + this.b + ", responseCallbackKey:" + this.c;
    }
}
