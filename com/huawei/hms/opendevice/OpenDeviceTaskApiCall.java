...
public class OpenDeviceTaskApiCall extends TaskApiCall<OpenDeviceHmsClient, OdidResult> {
    ...
    public void doExecute(OpenDeviceHmsClient openDeviceHmsClient, ResponseErrorCode responseErrorCode, String str, cxs<OdidResult> cxsVar) {
        if (responseErrorCode == null) {
            cxsVar.a(new ApiException(new Status(1)));
            return;
        }
        ...
        cxsVar.a((cxs<OdidResult>) odidResult);
    }
