...
public class p1 {
    ...
    public static boolean a(String str, String str2, int i) {
        ...
        if (TextUtils.isEmpty(a2) || TextUtils.isEmpty(str2)) {
            ...
            if (!TextUtils.isEmpty(a3)) {
                if (str2.equals(cye.a(a2))) {
                    return true;
                }
                if (!str2.equals(cye.a(a3))) {
                    return false;
                }
                try {
    ...
    public static boolean b(String str) {
        if (p.f7479a.booleanValue()) {
            return true;
        }
        for (String str2 : f7482a) {
            if (a(str, str2, 2)) {
                return true;
            }
        }
