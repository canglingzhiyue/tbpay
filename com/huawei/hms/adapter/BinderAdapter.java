...
public class BinderAdapter implements ServiceConnection {
    ...
    private void a() {
        ...
        synchronized (this.f) {
            if (this.f7333a.bindService(intent, this, 1)) {
                g();
                return;
            }
            this.g = true;
    ...
    private void d() {
        ...
        this.i = handler;
        handler.sendEmptyMessageDelayed(getMsgDelayDisconnect(), b.DEFAULT_SMALL_MAX_AGE);
    }

    private void e() {
        HMSLog.e("BinderAdapter", "In connect, bind core service fail");
        try {
            ComponentName componentName = new ComponentName(this.f7333a.getApplicationInfo().packageName, "com.huawei.hms.activity.BridgeActivity");
    ...
    public void unBind() {
        Util.unBindServiceCatchException(this.f7333a, this);
    }
    ...
    public void updateDelayTask() {
        ...
        synchronized (BinderAdapter.class) {
            ...
            if (handler != null) {
                handler.removeMessages(getMsgDelayDisconnect());
                this.i.sendEmptyMessageDelayed(getMsgDelayDisconnect(), b.DEFAULT_SMALL_MAX_AGE);
            }
        }
    }
}
