...
public abstract class BaseHmsClient implements AidlApiClient {
    ...
    public static final class ConnectionResultWrapper {
        ...
        /* renamed from: a  reason: collision with root package name */
        private HuaweiApi.RequestHandler f7391a;
    ...
    private void a(int i2, boolean z) {
        ...
        if (z || !(i3 == 3 || i3 == 5)) {
            ...
            if (this.f7386a.getPackageName().equals(this.c.getInnerHmsPkg())) {
                HMSLog.i("BaseHmsClient", "service packageName is same, bind core service return");
                a();
            } else if (!Util.isAvailableLibExist(this.f7386a)) {
                int isHuaweiMobileServicesAvailable = HuaweiApiAvailability.getInstance().isHuaweiMobileServicesAvailable(this.f7386a, i2);
                ...
                int isHuaweiMobileServicesAvailable2 = availableAdapter.isHuaweiMobileServicesAvailable(this.f7386a);
    ...
    private void a(AvailableAdapter availableAdapter, int i2) {
        ...
        if (!getClientSettings().isHasActivity()) {
            ...
            a(new ConnectionResult(26, HuaweiApiAvailability.getInstance().getErrPendingIntent(this.f7386a, i2, 0)));
            return;
        }
    ...
    private void a(String str, String str2) {
        if (this.c.isUseInnerHms()) {
            m = InnerBinderAdapter.getInstance(this.f7386a, str2, str);
            if (!isConnected()) {
                b(5);
                m.binder(c());
                return;
        ...
        l = OuterBinderAdapter.getInstance(this.f7386a, str2, str);
        if (!isConnected()) {
            b(5);
            l.binder(c());
            return;
        ...
        return new BinderAdapter.BinderCallBack() { // from class: com.huawei.hms.common.internal.BaseHmsClient.1
            ...
            public void onBinderFailed(int i2, Intent intent) {
                ...
                if (activeActivity == null) {
                    ...
                    BaseHmsClient.this.a(new ConnectionResult(10, a.a(BaseHmsClient.this.f7386a, 11, intent, 67108864)));
                    BaseHmsClient.this.d = null;
                    return;
                }
    ...
    void b(int i2) {
        (this.c.isUseInnerHms() ? k : j).set(i2);
    }
    ...
    public String getServiceAction() {
        HMSPackageManager hMSPackageManager = HMSPackageManager.getInstance(this.f7386a);
