    ...
    private static class a implements BaseAdapter.BaseCallBack {
        ...
        private void a(String str, String str2) {
            ...
            if (!responseHeader.fromJson(str)) {
                this.f7396a.onCallback(new ResponseHeader(1, CommonCode.ErrorCode.ARGUMENTS_INVALID, "response header json error"), new JSONObject().toString());
                return;
            }
            HMSLog.i("HmsClient", "receive msg " + responseHeader);
            a(responseHeader.getSessionId());
            this.f7396a.onCallback(responseHeader, str2);
        }
        ...
        public void onError(String str) {
            ...
            a(responseHeader.getSessionId());
            this.f7396a.onCallback(responseHeader, responseWrap.getBody());
        }
    }
