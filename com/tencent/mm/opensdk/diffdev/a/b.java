...
public class b extends AsyncTask<Void, Void, a> {
            ...
            if (bArr != null && bArr.length != 0) {
                ...
                try {
                    ...
                    if (i != 0) {
                        ...
                        aVar.f23667a = OAuthErrCode.WechatAuth_Err_NormalErr;
                    ...
                    if (string == null || string.length() == 0) {
                        ...
                        aVar.f23667a = OAuthErrCode.WechatAuth_Err_JsonDecodeErr;
                        return aVar;
                    }
                    ...
                    aVar.f23667a = OAuthErrCode.WechatAuth_Err_OK;
                    aVar.e = decode;
    ...
    protected a doInBackground(Void[] voidArr) {
        ...
        String format = String.format("https://open.weixin.qq.com/connect/sdk/qrconnect?appid=%s&noncestr=%s&timestamp=%s&scope=%s&signature=%s", this.f23666a, this.c, this.d, this.b, this.e);
