...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    public BaseWXApiImplV10(Context context, String str, boolean z, int i) {
        ...
        this.launchMode = i;
        b.f23672a = context.getApplicationContext();
    ...
    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        if (b.b(queryParameter)) {
            ...
            String queryParameter2 = parse.getQueryParameter(a.RESULT_KEY);
            if (queryParameter2 != null && queryParameter2.length() > 0) {
                resp.errCode = b.a(queryParameter2, 0);
            }
            resp.openId = parse.getQueryParameter("openid");
            resp.templateID = parse.getQueryParameter(y.TEMPLATE_ID);
            ...
            String queryParameter3 = parse.getQueryParameter(a.RESULT_KEY);
            ...
            String queryParameter4 = parse.getQueryParameter(a.RESULT_KEY);
            ...
            String queryParameter5 = parse.getQueryParameter(a.RESULT_KEY);
            ...
            String queryParameter6 = parse.getQueryParameter(a.RESULT_KEY);
    ...
    private void launchWXUsingPendingIntent() {
        if (!this.detached) {
            ...
            try {
                ...
                com.android.taobao.aop.a.a(this.context, 1, launchIntentForPackage, i).send(this.context, 2, null, new PendingIntent.OnFinished() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.3
    ...
    public boolean handleIntent(Intent intent, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        if (!WXApiImplComm.isIntentFromWx(intent, ConstantsAPI.Token.WX_TOKEN_VALUE_MSG)) {
            ...
            if (stringExtra2 == null || stringExtra2.length() == 0) {
                ...
                return false;
            } else if (!checkSumConsistent(intent.getByteArrayExtra(ConstantsAPI.CHECK_SUM), com.tencent.mm.opensdk.channel.a.a.a(stringExtra, intExtra, stringExtra2))) {
                        ...
                        if (str != null && str.contains("openbusinesswebview")) {
                            try {
                                ...
                                if (parse != null && "openbusinesswebview".equals(parse.getHost())) {
                                    ...
                                    String queryParameter = parse.getQueryParameter(a.RESULT_KEY);
    ...
    public boolean registerApp(String str, long j) {
        if (!this.detached) {
            ...
            c1024a.f23662a = "com.tencent.mm";
            c1024a.b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
            c1024a.c = "weixin://registerapp?appid=" + this.appId;
            c1024a.d = j;
            return com.tencent.mm.opensdk.channel.a.a.a(this.context, c1024a);
        }
    ...
    public void unregisterApp() {
        if (!this.detached) {
            ...
            a.C1024a c1024a = new a.C1024a();
            c1024a.f23662a = "com.tencent.mm";
            c1024a.b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
            c1024a.c = "weixin://unregisterapp?appid=" + this.appId;
            com.tencent.mm.opensdk.channel.a.a.a(this.context, c1024a);
            return;
        }
