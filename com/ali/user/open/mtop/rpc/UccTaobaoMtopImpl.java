...
public class UccTaobaoMtopImpl implements c {
    ...
    public void login(final i iVar, boolean z) {
        ...
        try {
            Class.forName("com.ali.user.open.ucc.util.MtopRemoteLogin").getMethod("login", Class.forName("com.ali.user.open.callback.LoginCallback")).invoke(null, "taobao", loginCallback);
        } catch (Throwable th) {
            th.printStackTrace();
