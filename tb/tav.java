...
public class tav extends af {
    ...
    public static /* synthetic */ Object ipc$super(tav tavVar, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -1775895211:
    ...
    static {
        kge.a(900611405);
        long a2 = fxa.a(DetailXRichTextViewConstructor.VIEW_TAG);
        DX_EVENT_ID = a2;
        f34001a = a2;
    ...
    public static class a implements ak {
        ...
        public DXWidgetNode build(Object obj) {
            ...
            return ipChange instanceof IpChange ? (DXWidgetNode) ipChange.ipc$dispatch("966917b0", new Object[]{this, obj}) : new tav();
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        if (dXWidgetNode == null || !(dXWidgetNode instanceof tav)) {
            return;
        }
        tav tavVar = (tav) dXWidgetNode;
        this.h = tavVar.h;
        this.g = tavVar.g;
        this.f = tavVar.f;
        this.i = tavVar.i;
    ...
    public void onSetStringAttribute(long j, String str) {
        ...
        this.f = f.a(Integer.parseInt(str));
    }
    ...
    public void a(final XRichTextViewV3 xRichTextViewV3, String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("21b2f3f3", new Object[]{this, xRichTextViewV3, str});
