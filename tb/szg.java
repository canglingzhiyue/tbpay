...
public class szg extends RecyclerView.ItemDecoration {
    ...
    public static /* synthetic */ Object ipc$super(szg szgVar, String str, Object... objArr) {
    ...
    public void onDrawOver(Canvas canvas, RecyclerView recyclerView, RecyclerView.State state) {
        ...
        paint.setColor(this.f33970a.getResources().getColor(R.color.tt_detail_d));
