...
public class ebf extends j {
    ...
    public static /* synthetic */ Object ipc$super(ebf ebfVar, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -1775895211:
    ...
    public ebf() {
        emu.a("com.taobao.android.detail.core.detail.kit.view.holder.main.dinamic3.widget.XQInteractAvatarAnimationViewWidgetNode");
    }
    ...
    public static class a implements ak {
        ...
        public DXWidgetNode build(Object obj) {
            ...
            return ipChange instanceof IpChange ? (DXWidgetNode) ipChange.ipc$dispatch("966917b0", new Object[]{this, obj}) : new ebf();
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        } else if (dXWidgetNode == null || !(dXWidgetNode instanceof ebf)) {
        } else {
            super.onClone(dXWidgetNode, z);
            ebf ebfVar = (ebf) dXWidgetNode;
            this.f27162a = ebfVar.f27162a;
            this.b = ebfVar.b;
            this.c = ebfVar.c;
            this.d = ebfVar.d;
            this.e = ebfVar.e;
    ...
    public void onRenderView(Context context, View view) {
        ...
        this.f.setData(this.f27162a, this.b, this.c, this.d, this.e);
    }
