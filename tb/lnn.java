...
public class lnn extends a {
    ...
    public static /* synthetic */ Object ipc$super(lnn lnnVar, String str, Object... objArr) {
        str.hashCode();
    ...
    private void b(View view, String str, Object obj, Object obj2, Object obj3) {
        ...
        ldf.d("HTapEventHandler", "分给老架构处理");
        if (this.f30747a == null) {
            this.f30747a = new gmo();
        }
        this.f30747a.a(view, str, obj, obj2, obj3);
    }
    ...
    private void c(View view, String str, Object obj, Object obj2, Object obj3) {
        ...
        ldf.d("HTapEventHandler", "分给新架构处理");
        if (this.b == null) {
            this.b = new lee();
        }
