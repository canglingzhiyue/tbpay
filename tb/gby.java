...
public class gby {
    ...
    public static int a(int i, byte[] bArr, int i2) {
        ...
        if (ipChange instanceof IpChange) {
            return ((Number) ipChange.ipc$dispatch("9e109994", new Object[]{new Integer(i), bArr, new Integer(i2)})).intValue();
        }
        if (i == 1) {
            return a(bArr, i2);
        }
    ...
    public static int b(byte[] bArr, int i) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("8ef51e86", new Object[]{bArr, new Integer(i)})).intValue() : (bArr[i + 1] & 255) | ((bArr[i] & 255) << 8);
    }

    public static int c(byte[] bArr, int i) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("f6d64b65", new Object[]{bArr, new Integer(i)})).intValue() : (bArr[i + 2] & 255) | ((bArr[i] & 255) << 16) | ((bArr[i + 1] & 255) << 8);
    }

    public static int d(byte[] bArr, int i) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? ((Number) ipChange.ipc$dispatch("5eb77844", new Object[]{bArr, new Integer(i)})).intValue() : (bArr[i + 3] & 255) | ((bArr[i] & 255) << 24) | ((bArr[i + 1] & 255) << 16) | ((bArr[i + 2] & 255) << 8);
    }
