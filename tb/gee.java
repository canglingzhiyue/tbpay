...
public class gee extends ggw {
    ...
    public String getDxFunctionName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("bc5916ec", new Object[]{this}) : "asciiLength";
    }
    ...
    public gfx execute(DXRuntimeContext dXRuntimeContext, gfx gfxVar, int i, gfx[] gfxVarArr, Map map) throws DXExprFunctionError {
        ...
        try {
            return gfx.a(gfxVar.i().getBytes("gbk").length);
        } catch (Exception e) {
