...
public class aph {
    ...
    public static final /* synthetic */ boolean f25499a;
    ...
    static {
        kge.a(1305792215);
        f25499a = !aph.class.desiredAssertionStatus();
    }

    public static byte[] a(byte[] bArr, int i) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (byte[]) ipChange.ipc$dispatch("bb6a45a9", new Object[]{bArr, new Integer(i)}) : a(bArr, 0, bArr.length, i);
    }

    public static byte[] a(byte[] bArr, int i, int i2, int i3) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (byte[]) ipChange.ipc$dispatch("8ba9ee49", new Object[]{bArr, new Integer(i), new Integer(i2), new Integer(i3)});
        }
        b bVar = new b(i3, new byte[(i2 * 3) / 4]);
        if (!bVar.a(bArr, i, i2, true)) {
            throw new IllegalArgumentException("bad base-64");
        }
        if (bVar.b == bVar.f25500a.length) {
            return bVar.f25500a;
        }
        byte[] bArr2 = new byte[bVar.b];
        System.arraycopy(bVar.f25500a, 0, bArr2, 0, bVar.b);
        return bArr2;
    }
    ...
    public static String b(byte[] bArr, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (String) ipChange.ipc$dispatch("db296e6d", new Object[]{bArr, new Integer(i)});
        }
        try {
            return new String(c(bArr, i), EncodingUtils.US_ASCII);
    ...
    public static byte[] c(byte[] bArr, int i) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (byte[]) ipChange.ipc$dispatch("e3f323ab", new Object[]{bArr, new Integer(i)}) : b(bArr, 0, bArr.length, i);
    }
    ...
    public static byte[] b(byte[] bArr, int i, int i2, int i3) {
        ...
        cVar.f25500a = new byte[i5];
        cVar.a(bArr, i, i2, true);
        if (!f25499a && cVar.b != i5) {
    ...
    public static class c extends a {
        ...
        static {
            kge.a(1874097199);
            g = !aph.class.desiredAssertionStatus();
        ...
        */
        public boolean a(byte[] r19, int r20, int r21, boolean r22) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: tb.aph.c.a(byte[], int, int, boolean):boolean");
        }
    }
