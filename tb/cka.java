...
public final class cka {
    ...
    private static String f26326a = "idnjfhncnsfuobcnt847y929o449u474w7j3h22aoddc98euk#%&&)*&^%#";
    ...
    public static String a() {
        ...
        for (int i = 0; i < f26326a.length() - 1; i += 4) {
            str = str + f26326a.charAt(i);
        }
        return str;
    }
    ...
    private static PBEKeySpec a(String str) {
        Class<?> cls = Class.forName(new String(cjy.a("amF2YS5zZWN1cml0eS5TZWN1cmVSYW5kb20=")));
