...
public class sqa extends h {
    ...
    public void handleEvent(DXEvent dXEvent, Object[] objArr, DXRuntimeContext dXRuntimeContext) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            DXWidgetNode queryWidgetNodeByUserId = dXRuntimeContext.s().getExpandWidgetNode().queryWidgetNodeByUserId((String) objArr[2]);
    ...
    private void a(final DXRootView dXRootView, final int i, boolean z, final String str) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            ofInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: tb.sqa.1
