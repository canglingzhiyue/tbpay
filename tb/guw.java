...
public class guw extends gtk implements f {
    ...
    public void a(Context context) {
        ...
        e<String, Void> b_ = b_("s-a");
        this.f28443a.u(j.a((e) b_));
        b(b_, new gtl<String, Void>() { // from class: tb.guw.1
            public static volatile transient /* synthetic */ IpChange $ipChange;
