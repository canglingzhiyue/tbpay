...
public class iem extends bxj {

    /* renamed from: a  reason: collision with root package name */
    private double[] f28972a;
    private double[][] b;
    private double c;

    public iem(double[] dArr, double[][] dArr2) {
        this.c = Double.NaN;
    ...
    public void a(double d, double[] dArr) {
        ...
        int i4 = 0;
        while (i4 < i3) {
            if (d == this.f28972a[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    dArr[i5] = this.b[i4][i5];
                }
            }
            double[] dArr3 = this.f28972a;
            int i6 = i4 + 1;
            if (d < dArr3[i6]) {
