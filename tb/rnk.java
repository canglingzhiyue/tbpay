...
public final class rnk implements X509TrustManager {

    /* renamed from: a  reason: collision with root package name */
    private X509TrustManager f33239a;
    ...
    public rnk(String str) {
        ...
        if (trustManagers.length != 0) {
            this.f33239a = (X509TrustManager) trustManagers[0];
            if (Build.VERSION.SDK_INT <= 23) {
                return;
            }
            this.b = new X509TrustManagerExtensions(this.f33239a);
            return;
        }
    ...
    public final void checkClientTrusted(X509Certificate[] x509CertificateArr, String str) {
        X509TrustManager x509TrustManager = this.f33239a;
    ...
    public final X509Certificate[] getAcceptedIssuers() {
        return this.f33239a.getAcceptedIssuers();
    }
}
