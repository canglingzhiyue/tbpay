...
public class dmb extends dmg<ObjectAnimator, ObjectAnimator> {
    ...
    public ObjectAnimator a(View view) {
        ...
        this.f26845a = new float[]{hsy.b(view.getContext(), iArr[1] + translationY), hsy.b(view.getContext(), iArr[1] + translationY2)};
    ...
    public ObjectAnimator b(View view) {
        ...
        this.b = new float[]{hsy.b(view.getContext(), iArr[1] + translationY), hsy.b(view.getContext(), iArr[1] + translationY2)};
        return ObjectAnimator.ofFloat(view, "translationY", translationY, translationY2);
    }
}
