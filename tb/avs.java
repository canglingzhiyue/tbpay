...
public final class avs implements atd {
    ...
    public void a(RecyclerView.ViewHolder viewHolder, int i, AURARenderComponent aURARenderComponent) {
        ...
        avx avxVar = this.f25640a;
        if (avxVar == null) {
            arc.a().c("AURAAsyncModuleLifecycleExtension", "onAppear", "mAsyncModuleDispatcher is null");
        } else {
            avxVar.a(aURARenderComponent);
        }
    }
    ...
    public void onDataChanged(AURAFlowData aURAFlowData, AURAGlobalData aURAGlobalData, aqs aqsVar) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            this.f25640a = (avx) aURAGlobalData.get("asyncModuleDispatcher", avx.class);
        }
    }
}
