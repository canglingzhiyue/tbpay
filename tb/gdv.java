...
public class gdv extends ggw {
    ...
    public String getDxFunctionName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("bc5916ec", new Object[]{this}) : "min";
    }
    ...
    public gfx execute(DXRuntimeContext dXRuntimeContext, gfx gfxVar, int i, gfx[] gfxVarArr, Map map) throws DXExprFunctionError {
        ...
        try {
            ...
            if (gfxVar2.z() && gfxVar3.z()) {
                return gfx.a(Math.min(gfxVar2.A(), gfxVar3.A()));
            }
            if (gfxVar2.z()) {
                return gfx.a(Math.min(gfxVar2.A(), gfxVar3.w()));
            }
            if (gfxVar3.z()) {
                return gfx.a(Math.min(gfxVar2.w(), gfxVar3.A()));
            }
            return gfx.a(Math.min(gfxVar2.w(), gfxVar3.w()));
        } catch (Exception e) {
