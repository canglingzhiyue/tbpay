...
public class bft implements bfu {
    ...
    private Map<String, Object> f25861a;
    ...
    public void a(AttachedResponse attachedResponse) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            UnifyLog.a("NextRpc_AttachedQueue", "queue attachedStat=" + this.f25861a + ",isAllAttachedResponse=" + this.d + ",seqNum=" + attachedResponse.getSeqNum() + ",bizName=" + attachedResponse.getBizName(), new Object[0]);
        }
    }
    ...
    public void a(StreamRemoteMainResponse streamRemoteMainResponse) {
        ...
        if (innerMap != null) {
            this.f25861a = innerMap;
        }
        for (AttachedResponse attachedResponse : this.c) {
            b(attachedResponse);
        }
        UnifyLog.a("NextRpc_AttachedQueue", "onMainResponse attachedStat=" + this.f25861a + ",isAllAttachedResponse=" + this.d + ",attachResponses=" + this.c, new Object[0]);
    }
    ...
    private void b(AttachedResponse attachedResponse) {
        ...
        } else if (attachedResponse == null || this.f25861a == null) {
        } else {
