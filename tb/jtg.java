...
public final class jtg implements ath {
    ...
    public RecyclerView getContainerView(Context context) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (RecyclerView) ipChange.ipc$dispatch("a859cf93", new Object[]{this, context}) : a();
    }
    ...
    private RecyclerView a() {
        ...
        q qVar = this.f29756a;
        if (qVar != null) {
            return (RecyclerView) qVar.a(USER_CONTEXT_CONTAINER, RecyclerView.class);
        }
        return null;
    }
