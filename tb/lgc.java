...
public class lgc extends af {
    ...
    public static /* synthetic */ Object ipc$super(lgc lgcVar, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -1133248269:
    ...
    private void a(final RIconTextView rIconTextView, String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("1cc175c", new Object[]{this, rIconTextView, str});
            return;
        }
        ...
        lfw.a(str, rIconTextView.getContext(), new lfw.a() { // from class: tb.lgc.1
    ...
    private void a(RIconTextView rIconTextView, int i) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("cdea731", new Object[]{this, rIconTextView, new Integer(i)});
        } else {
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        if (!(dXWidgetNode instanceof lgc)) {
            return;
        }
        lgc lgcVar = (lgc) dXWidgetNode;
        this.b = lgcVar.b;
        this.f30555a = lgcVar.f30555a;
    }
    ...
    public static class a implements ak {
        ...
        public DXWidgetNode build(Object obj) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? (DXWidgetNode) ipChange.ipc$dispatch("966917b0", new Object[]{this, obj}) : new lgc();
        }
    }
