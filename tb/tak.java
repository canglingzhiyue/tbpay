...
public class tak extends fuf {
    public static volatile transient /* synthetic */ IpChange $ipChange;
    public static final long DX_PARSER_ID;

    public static /* synthetic */ Object ipc$super(tak takVar, String str, Object... objArr) {
        str.hashCode();
    ...
    private SpannableString a(JSONArray jSONArray, DinamicXEngine dinamicXEngine) {
        ...
        ArrayList<tag.a> arrayList = new ArrayList();
            ...
            if (jSONObject != null) {
                if ("image".equals(jSONObject.getString("type"))) {
                    ...
                    if (!StringUtils.isEmpty(string)) {
                        str = str + string;
                        tag.a a2 = tal.a(jSONObject.getJSONObject("style"), str, string, dinamicXEngine);
                        if (a2 != null) {
                            arrayList.add(a2);
                        }
                    }
                    ...
                    if (!StringUtils.isEmpty(string2)) {
                        str = str + string2;
                        tag.a a3 = tam.a(jSONObject.getJSONObject("style"), str, string2, dinamicXEngine);
                        if (a3 != null) {
                            arrayList.add(a3);
                        }
                    }
