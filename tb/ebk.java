...
public class ebk extends af {
    ...
    public static class a implements ak {
        ...
        public DXWidgetNode build(Object obj) {
            ...
            return ipChange instanceof IpChange ? (DXWidgetNode) ipChange.ipc$dispatch("966917b0", new Object[]{this, obj}) : new ebk();
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        if (!(dXWidgetNode instanceof ebk)) {
            return;
        }
        ebk ebkVar = (ebk) dXWidgetNode;
        this.d = ebkVar.d;
        this.e = ebkVar.e;
        JSONArray jSONArray = ebkVar.c;
        if (z && jSONArray != null) {
    ...
    public void onSetStringAttribute(long j, String str) {
        ...
        if (2897545864002613241L == j) {
            try {
                this.d = epo.b(Integer.parseInt(str));
            } catch (Exception e) {
                e.printStackTrace();
                return;
            }
        ...
        this.e = epo.b(Integer.parseInt(str));
    }
    ...
    public void a(TextView textView, JSONArray jSONArray) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                dzv.a(str2, xSimpleRichTextViewV3.getContext(), new c.a() { // from class: tb.ebk.1
                    public static volatile transient /* synthetic */ IpChange $ipChange;
