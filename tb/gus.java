...
public class gus extends gtk implements f {
    ...
    public void e() {
        ...
        e<String, Void> b_ = b_("c-a");
        this.f28443a.v(j.a((e) b_));
        b(b_, new gtl<String, Void>() { // from class: tb.gus.1
            public static volatile transient /* synthetic */ IpChange $ipChange;
    ...
    public void a(Context context) {
        ...
        e<String, Void> b_ = b_("c-create");
        this.f28443a.E(j.a((e) b_));
        b(b_, new gtl<String, Void>() { // from class: tb.gus.2
            public static volatile transient /* synthetic */ IpChange $ipChange;
