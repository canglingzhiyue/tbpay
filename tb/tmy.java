...
public class tmy extends LruCache<String, ozn> {
    ...
    public final ozn a(String str) {
        IpChange ipChange = $ipChange;
        return ipChange instanceof IpChange ? (ozn) ipChange.ipc$dispatch("7c739a91", new Object[]{this, str}) : tmz.g().a(str);
    }
