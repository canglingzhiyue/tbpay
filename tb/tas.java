...
public class tas extends af {
    ...
    static {
        kge.a(1328781932);
        long a2 = fxa.a(DetailAdaptiveTextViewConstructor.VIEW_TAG);
        DX_EVENT_ID = a2;
        f33996a = a2;
    }
    ...
    public static class a implements ak {
        ...
        public DXWidgetNode build(Object obj) {
            ...
            return ipChange instanceof IpChange ? (DXWidgetNode) ipChange.ipc$dispatch("966917b0", new Object[]{this, obj}) : new tas();
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        if (!(dXWidgetNode instanceof tas)) {
            return;
        }
        tas tasVar = (tas) dXWidgetNode;
        this.d = tasVar.d;
        this.e = tasVar.e;
        this.f = tasVar.f;
        this.g = tasVar.g;
        this.c = tasVar.c;
        JSONArray jSONArray = tasVar.b;
        if (z && jSONArray != null) {
    ...
    private void a(XAdaptiveTextViewV3 xAdaptiveTextViewV3) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("38c6a23b", new Object[]{this, xAdaptiveTextViewV3});
