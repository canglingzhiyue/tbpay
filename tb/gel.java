...
public class gel extends ggw {
    ...
    public String getDxFunctionName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("bc5916ec", new Object[]{this}) : "reversed";
    }
    ...
    public gfx execute(DXRuntimeContext dXRuntimeContext, gfx gfxVar, int i, gfx[] gfxVarArr, Map map) throws DXExprFunctionError {
        ...
        try {
            return gfx.a(new StringBuilder(gfxVar.i()).reverse().toString());
        } catch (Exception e) {
