...
public class guy extends gtk implements f, gte.a {
    ...
    public b<String, Void> h() {
        ...
        int a2 = gsm.a(mto.a.GEO_NOT_SUPPORT);
        return new b<>(gtg.a("launcher", a2, a2, 5, this));
    }
    ...
    public void a(Context context) {
        ...
        e<String, Void> b_ = b_("u-a");
        this.f28443a.x(j.a((e) b_));
        b(b_, new gtl<String, Void>() { // from class: tb.guy.1
            public static volatile transient /* synthetic */ IpChange $ipChange;
