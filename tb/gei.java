...
public class gei extends ggw {
    ...
    public String getDxFunctionName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("bc5916ec", new Object[]{this}) : "isNullOrEmpty";
    }
    ...
    public gfx execute(DXRuntimeContext dXRuntimeContext, gfx gfxVar, int i, gfx[] gfxVarArr, Map map) throws DXExprFunctionError {
        ...
        if (gfxVarArr == null || gfxVar == null || gfxVar.f()) {
            return gfx.a(true);
        }
        String i2 = gfxVar.i();
