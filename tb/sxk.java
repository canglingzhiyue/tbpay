...
public class sxk extends a {
    ...
    public static /* synthetic */ Object ipc$super(sxk sxkVar, String str, Object... objArr) {
    ...
    public String b() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("367c9fd7", new Object[]{this}) : "TMSSDK.init";
    }
    ...
    public void b(Application application, HashMap<String, Object> hashMap) {
        ...
        try {
            Class.forName("com.taobao.themis.taobao.impl.TBTMSSDK").getDeclaredMethod("initTBTMSNew", Context.class).invoke(null, application.getApplicationContext());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
