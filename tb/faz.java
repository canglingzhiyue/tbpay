...
public class faz extends dzk {
    ...
    public class a extends RecyclerView.ViewHolder {
        ...
        public a(View view) {
            ...
            this.f27729a = (TextView) view.findViewById(R.id.tv_desc_size_chart_item);
    ...
    public static /* synthetic */ Object ipc$super(faz fazVar, String str, Object... objArr) {
    ...
    public faz(Context context, SizeChartItemModel sizeChartItemModel) {
        super(context);
        this.e = 0;
        this.f = 1;
        this.h = 0;
        this.i = fas.DEFAULT_WIDTH;
        this.k = -1;
        ...
        emu.a("com.taobao.android.detail.wrapper.ext.component.desc.viewholder.adapter.SizeChartViewColumnAdapter");
    }
    ...
    public RecyclerView.ViewHolder mo1596onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 0) {
            return new b(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.x_detail_desc_measures_title_item, (ViewGroup) null));
        }
        return new a(View.inflate(viewGroup.getContext(), R.layout.x_detail_include_desc_size_chart_title_column, null));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (viewHolder instanceof a) {
            ...
            if (this.k == i) {
                ...
                aVar.itemView.setBackgroundResource(R.drawable.x_detail_size_chart_recommend_line_bg);
    ...
    public int a() {
        ...
        try {
            return (this.g.maxLength * fas.DEFAULT_TEXT_SIZE) + fas.DEFAULT_TEXT_PADDING + fas.DEFAULT_TEXT_PADDING;
