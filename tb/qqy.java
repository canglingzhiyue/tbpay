...
public class qqy {
    ...
    public static final String SKU_MSG_DEPRESS_SHOW_H5_SKU;
    public static final String SKU_MSG_DEPRESS_SHOW_REDIRECT_SKU;
    public static final String SKU_MSG_INVALID_INPUT = "无法获取商品信息，请稍后重试!";
    public static final String SKU_MSG_JS_CRASHED = "非常抱歉运行异常，请稍后重试!";
    public static final String SKU_MSG_MTOP_INIT_FAILED = "数据异常，请稍后重试!";
    public static final String SKU_MSG_NOT_SUPPORT = "非常抱歉服务异常，请稍后重试!";
    public static final String SKU_MSG_QUERYDATA_FAILED;
    ...
    public static final int SKU_RESULT_BIZ_REQUIRED_SKIP = 18;
    ...
    static {
        kge.a(1962786057);
        SKU_MSG_QUERYDATA_FAILED = b.a(R.string.sku_failed_to_request);
        SKU_MSG_DEPRESS_SHOW_H5_SKU = b.a(R.string.sku_action_not_supported);
        SKU_MSG_DEPRESS_SHOW_REDIRECT_SKU = b.a(R.string.sku_item_cant_be_added);
    }
}
