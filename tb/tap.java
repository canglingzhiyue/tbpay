...
public class tap extends m {
    ...
    public static /* synthetic */ Object ipc$super(tap tapVar, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -1814733277:
    ...
    static {
        kge.a(-109464707);
        long a2 = fxa.a("DetailFlowLayout");
        DX_EVENT_ID = a2;
        VIEW_IDENTITY = a2;
    }
    ...
    public static class a implements ak {
        ...
        public DXWidgetNode build(Object obj) {
            ...
            return ipChange instanceof IpChange ? (DXWidgetNode) ipChange.ipc$dispatch("966917b0", new Object[]{this, obj}) : new tap();
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        } else if (dXWidgetNode == null || !(dXWidgetNode instanceof tap)) {
        } else {
            super.onClone(dXWidgetNode, z);
            tap tapVar = (tap) dXWidgetNode;
            this.f33991a = tapVar.f33991a;
            this.b = tapVar.b;
            this.c = tapVar.c;
        }
    }
