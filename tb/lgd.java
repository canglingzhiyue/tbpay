...
public class lgd extends af {
    ...
    public static /* synthetic */ Object ipc$super(lgd lgdVar, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -740240234:
    ...
    private SpannableString a() {
        ...
        if ("alistyle".equals(this.f30557a)) {
            int i3 = this.c;
            i = (int) (i3 * 0.762f);
            i2 = (int) (i3 * 0.571f);
        } else {
        ...
        if ("normal".equals(this.f30557a)) {
            styleSpan = new StyleSpan(0);
        } else if ("bold".equals(this.f30557a)) {
            styleSpan = new StyleSpan(1);
        } else if ("italic".equals(this.f30557a)) {
            styleSpan = new StyleSpan(2);
        } else if ("bold_italic".equals(this.f30557a)) {
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        if (!(dXWidgetNode instanceof lgd)) {
            return;
        }
        lgd lgdVar = (lgd) dXWidgetNode;
        this.f30557a = lgdVar.f30557a;
        this.b = lgdVar.b;
        this.c = lgdVar.c;
    }
    ...
    public static class a implements ak {
        ...
        public DXWidgetNode build(Object obj) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? (DXWidgetNode) ipChange.ipc$dispatch("966917b0", new Object[]{this, obj}) : new lgd();
        }
    }
