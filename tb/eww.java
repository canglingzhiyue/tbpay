...
public class eww {
    ...
    static {
        kge.a(-706788340);
        tpc.a("com.taobao.android.detail.sdk.utils.sku.PpathUtils");
    }
    ...
    public static String a(List<String> list) {
        ...
        Collections.sort(list, new Comparator<String>() { // from class: tb.eww.1
            public static volatile transient /* synthetic */ IpChange $ipChange;
            ...
            public int a(String str, String str2) {
                IpChange ipChange2 = $ipChange;
                return ipChange2 instanceof IpChange ? ((Number) ipChange2.ipc$dispatch("d9378d6f", new Object[]{this, str, str2})).intValue() : eww.b(str) - eww.b(str2);
            }
        });
    ...
    public static List<String> a(String str, List<SkuBaseNode.SkuIdPropPath> list) {
        ...
        if (!TextUtils.isEmpty(str) && list != null) {
            for (SkuBaseNode.SkuIdPropPath skuIdPropPath : list) {
                if (ewu.a(skuIdPropPath.skuId, str)) {
