...
public class sbv {
    ...
    public static final /* synthetic */ boolean f33464a = !sbv.class.desiredAssertionStatus();
    ...
    public static class a extends FilterOutputStream {
        ...
        public a(OutputStream outputStream, int i) {
            ...
            boolean z = true;
            this.f = (i & 8) != 0;
            this.f33465a = (i & 1) == 0 ? false : z;
            this.d = this.f33465a ? 3 : 4;
        ...
        public void write(int i) throws IOException {
            ...
            if (ipChange instanceof IpChange) {
                ...
                this.out.write(sbv.a(this.g, this.c, this.d, this.i));
                this.e += 4;
                if (this.f && this.e >= 76) {
                    this.out.write(10);
                    this.e = 0;
                ...
                if (bArr2[i3] > -5) {
                    ...
                    this.out.write(this.g, 0, sbv.a(bArr3, 0, this.g, 0, this.i));
                    this.b = 0;
                } else if (bArr2[i3] != -5) {
        ...
        public void a() throws IOException {
            ...
            if (ipChange instanceof IpChange) {
                ...
                if (this.f33465a) {
                    this.out.write(sbv.a(this.g, this.c, this.b, this.i));
                    this.b = 0;
                    return;
                }
