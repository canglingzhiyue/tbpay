...
public class bsd implements brz {
    ...
    private TranslateAnimation f26089a;
    ...
    private void a(Animation.AnimationListener animationListener) {
        ...
        if (this.f26089a == null) {
            this.f26089a = new TranslateAnimation(1, 0.0f, 1, 0.0f, 1, 1.0f, 1, 0.0f);
            this.f26089a.setDuration(300L);
            this.f26089a.setFillAfter(true);
        }
        this.f26089a.setAnimationListener(animationListener);
        if (this.b != null) {
            return;
        }
    ...
    public void a(View view, final bsa bsaVar) {
        ...
        a(new Animation.AnimationListener() { // from class: tb.bsd.1
            public static volatile transient /* synthetic */ IpChange $ipChange;
        ...
        animationSet.addAnimation(this.f26089a);
    ...
    public void b(View view, final bsa bsaVar) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            b(new Animation.AnimationListener() { // from class: tb.bsd.2
                public static volatile transient /* synthetic */ IpChange $ipChange;
