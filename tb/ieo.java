...
public class ieo extends bxj {

    /* renamed from: a  reason: collision with root package name */
    private double[] f28975a;
    private double[][] b;
    private double[][] c;

    public ieo(double[] dArr, double[][] dArr2) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            for (int i6 = 0; i6 < length2; i6++) {
                if (dArr3[i5][i6] == mto.a.GEO_NOT_SUPPORT) {
                    dArr4[i5][i6] = 0.0d;
                    dArr4[i5 + 1][i6] = 0.0d;
                } else {
    ...
    public void a(double d, double[] dArr) {
        ...
        int i4 = 0;
        while (i4 < i3) {
            if (d == this.f28975a[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    dArr[i5] = this.b[i4][i5];
                }
            }
            double[] dArr3 = this.f28975a;
            int i6 = i4 + 1;
            if (d < dArr3[i6]) {
