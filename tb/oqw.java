...
public class oqw extends tcq {
    ...
    public static /* synthetic */ Object ipc$super(oqw oqwVar, String str, Object... objArr) {
        str.hashCode();
    ...
    public AwesomeGetContainerParams a(ope opeVar, JSONObject jSONObject) {
        ...
        HomeInfoFlowDataService a2 = a(this.f32314a);
        if (a2 == null) {
            return null;
        }
        ldf.d("SubContainerProcessProvider", "新架构 getRequestParams");
    ...
    public void a(JSONObject jSONObject) {
        ...
        if (jSONObject != null) {
            jSONObject.put("requestStartTime", (Object) Long.valueOf(SystemClock.uptimeMillis()));
        }
    ...
    public void c(ope opeVar, JSONObject jSONObject) {
        ...
        ldf.d("SubContainerProcessProvider", "新架构 customDataProcess");
    ...
    public void d(ope opeVar, JSONObject jSONObject) {
        ...
        ldf.d("SubContainerProcessProvider", "新架构 uiRefresh");
