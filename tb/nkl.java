...
public class nkl extends GridLayoutManager.SpanSizeLookup {
    public static volatile transient /* synthetic */ IpChange $ipChange;

    /* renamed from: a  reason: collision with root package name */
    private WeakReference<PtrRecyclerView> f31534a;
    ...
    public static /* synthetic */ Object ipc$super(nkl nklVar, String str, Object... objArr) {
    ...
    public nkl(PtrRecyclerView ptrRecyclerView, GridLayoutManager gridLayoutManager, GridLayoutManager.SpanSizeLookup spanSizeLookup) {
        this.f31534a = new WeakReference<>(ptrRecyclerView);
    ...
    public int getSpanSize(int i) {
        ...
        WeakReference<PtrRecyclerView> weakReference2 = this.f31534a;
        if (weakReference2 != null && weakReference2.get() != null && (weakReference = this.b) != null && weakReference.get() != null) {
            PtrRecyclerView ptrRecyclerView = this.f31534a.get();
            RecyclerView.Adapter adapter = this.f31534a.get().getAdapter();
