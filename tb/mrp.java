...
public class mrp extends mrn {
    ...
    public static /* synthetic */ Object ipc$super(mrp mrpVar, String str, Object... objArr) {
    ...
    public List<FluidTaskConfig> a() {
        ...
        a2.add(new FluidTaskConfig(c.TAG, 2000L, "main"));
        a2.add(new FluidTaskConfig("dynamic_h5_sdk", 2000L, "main"));
        return a2;
    }
}
