...
public class gcd extends ggw {
    ...
    public String getDxFunctionName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("bc5916ec", new Object[]{this}) : "get";
    }
    ...
    public gfx execute(DXRuntimeContext dXRuntimeContext, gfx gfxVar, int i, gfx[] gfxVarArr, Map map) throws DXExprFunctionError {
        ...
        StringTokenizer stringTokenizer = new StringTokenizer(gfxVarArr[0].toString(), dmp.DELIMITER, false);
        Object J = gfxVar.J();
