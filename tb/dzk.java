...
public abstract class dzk extends RecyclerView.Adapter {
    ...
    public dzk(Context context) {
        ...
        this.c = this.f27134a.getResources().getColor(R.color.detail_desc_normal_background);
        this.b = this.f27134a.getResources().getColor(R.color.detail_desc_measure_background_color);
    }
