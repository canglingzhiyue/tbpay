...
public class pfs extends DXWidgetNode {
    ...
    public static class a implements ak {
        ...
        public DXWidgetNode build(Object obj) {
            ...
            return ipChange instanceof IpChange ? (DXWidgetNode) ipChange.ipc$dispatch("966917b0", new Object[]{this, obj}) : new pfs();
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        } else if (dXWidgetNode == null || !(dXWidgetNode instanceof pfs)) {
        } else {
            super.onClone(dXWidgetNode, z);
            this.f32605a = ((pfs) dXWidgetNode).f32605a;
        }
    }
    ...
    public View onCreateView(Context context) {
        ...
        return new pfu(context, this.f32605a, aVar).f32610a;
    }
