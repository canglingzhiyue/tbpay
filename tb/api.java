...
public class api {
    ...
    public static final /* synthetic */ boolean f25501a;
    ...
    static {
        kge.a(735871178);
        f25501a = !api.class.desiredAssertionStatus();
    ...
    public static class a extends FilterOutputStream {
        ...
        public a(OutputStream outputStream, int i) {
            ...
            boolean z = true;
            this.f = (i & 8) != 0;
            this.f25502a = (i & 1) == 0 ? false : z;
            this.d = this.f25502a ? 3 : 4;
        ...
        public void write(int i) throws IOException {
            ...
            if (ipChange instanceof IpChange) {
                ...
                this.out.write(api.a(this.g, this.c, this.d, this.i));
                this.e += 4;
                if (this.f && this.e >= 76) {
                    this.out.write(10);
                    this.e = 0;
                ...
                if (bArr2[i3] > -5) {
                    ...
                    this.out.write(this.g, 0, api.a(bArr3, 0, this.g, 0, this.i));
                    this.b = 0;
                } else if (bArr2[i3] != -5) {
        ...
        public void a() throws IOException {
            ...
            if (ipChange instanceof IpChange) {
                ...
                if (this.f25502a) {
                    this.out.write(api.a(this.g, this.c, this.b, this.i));
                    this.b = 0;
                    return;
                }
