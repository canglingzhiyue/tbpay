...
public final class tnw implements d {
    ...
    public tnw(f instance) {
        q.d(instance, "instance");
        this.f34235a = instance;
    }
    ...
    public String a() {
        ...
        if (this.f34235a.w() == null) {
            return null;
        }
        TMSMetaInfoWrapper w = this.f34235a.w();
        q.a(w);
        return w.q();
    }
    ...
    public String c() {
        ...
        if (this.f34235a.v() == null) {
            return null;
        }
        TMSMetaInfoWrapper v = this.f34235a.v();
        q.a(v);
        return v.r();
    }
    ...
    private final JSONObject b(TMSMetaInfoWrapper tMSMetaInfoWrapper) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (JSONObject) ipChange.ipc$dispatch("385d0592", new Object[]{this, tMSMetaInfoWrapper});
        }
        q.a(tMSMetaInfoWrapper);
        JSONObject m = tMSMetaInfoWrapper.m();
        if (m != null) {
            return m.getJSONObject("byteCacheInfo");
        }
        return null;
    }
