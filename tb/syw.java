...
public class syw {
    ...
    private static Pattern f33965a;

    static {
        kge.a(585450737);
        f33965a = Pattern.compile("\\$\\{[a-zA-Z()\\. _\\-\\[\\]0-9]*(?!\\$\\{[a-zA-Z()\\. \\_\\-\\[\\]0-9]*\\})[a-zA-Z()\\. \\_\\-\\[\\]0-9]*\\}");
    ...
    public static Object a(Object obj, String str) {
        ...
        for (Matcher matcher = f33965a.matcher(sb); matcher.find(); matcher = f33965a.matcher(sb)) {
    ...
    private static a a(String str, Object obj, Object obj2) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return (a) ipChange.ipc$dispatch("9b6f118e", new Object[]{str, obj, obj2});
        }
        a aVar = new a();
    ...
    private static void a(Object obj, Object obj2, a aVar) {
        ...
        boolean z = true;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("2dd3f382", new Object[]{obj, obj2, aVar});
            return;
        }
