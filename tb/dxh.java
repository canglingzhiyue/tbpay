...
public class dxh extends fuf {
    ...
    public static /* synthetic */ Object ipc$super(dxh dxhVar, String str, Object... objArr) {
        str.hashCode();
        throw new InstantReloadException(String.format("String switch could not find '%s'", str));
    }

    public dxh() {
        emu.a("com.taobao.android.detail.core.aura.extension.event.title.DXDataParserCanShowInSingleLine");
    }
    ...
    private int a(Object[] objArr) {
        ...
        try {
            ...
            i.a("DXDataParserCanShowInSingleLine", "getComponentWidth fail", e);
            return 0;
        }
    }
            ...
            if (jSONObject != null) {
                if ("image".equals(jSONObject.getString("type"))) {
                    ...
                    if (!TextUtils.isEmpty(string)) {
                        str = str + string;
                        a a2 = dxi.a(jSONObject.getJSONObject("style"), str, string, dinamicXEngine);
                        if (a2 != null) {
                            arrayList.add(a2);
                        }
                    }
                    ...
                    if (!TextUtils.isEmpty(string2)) {
                        str = str + string2;
                        a a3 = dxj.a(jSONObject.getJSONObject("style"), str, string2, dinamicXEngine);
                        if (a3 != null) {
                            arrayList.add(a3);
                        }
                    }
