...
public class gux extends gtk implements f {
    ...
    public void a(Context context) {
        ...
        e<String, Void> b_ = b_("st-a");
        this.f28443a.w(j.a((e) b_));
        b(b_, new gtl<String, Void>() { // from class: tb.gux.1
            public static volatile transient /* synthetic */ IpChange $ipChange;
    ...
    public b<String, Void> h() {
        ...
        int i = b;
        return new b<>(gtg.a("launcher", i, i, 5));
    }
}
