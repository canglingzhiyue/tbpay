...
public class xne extends af {
    ...
    public static /* synthetic */ Object ipc$super(xne xneVar, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -740240234:
    ...
    private SpannableString a() {
        ...
        if ("alistyle".equals(this.f34396a)) {
            int i3 = this.c;
            i = (int) (i3 * 0.762f);
            i2 = (int) (i3 * 0.571f);
        } else {
        ...
        if ("normal".equals(this.f34396a)) {
            styleSpan = new StyleSpan(0);
        } else if ("bold".equals(this.f34396a)) {
            styleSpan = new StyleSpan(1);
        } else if ("italic".equals(this.f34396a)) {
            styleSpan = new StyleSpan(2);
        } else if ("bold_italic".equals(this.f34396a)) {
        ...
        if ("alistyle".equals(this.f34396a)) {
            ...
            if (typeface != null) {
                if (this.e == null) {
                    this.e = new lfu(typeface);
                }
                spannableString.setSpan(this.e, length, i5, 33);
            }
            if (length != 0) {
                spannableString.setSpan(new lft(0.3f), 0, length, 33);
            }
        }
    ...
    private static void b() {
        ...
        if (ipChange instanceof IpChange) {
            ...
            d = Typeface.createFromAsset(DinamicXEngine.i().getAssets(), e.ALI_SANS_TYPEFACE_ASSET_PATH);
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        if (!(dXWidgetNode instanceof xne)) {
            return;
        }
        xne xneVar = (xne) dXWidgetNode;
        this.f34396a = xneVar.f34396a;
        this.b = xneVar.b;
        this.c = xneVar.c;
    }
    ...
    public static class a implements ak {
        ...
        public DXWidgetNode build(Object obj) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? (DXWidgetNode) ipChange.ipc$dispatch("966917b0", new Object[]{this, obj}) : new xne();
        }
    }
