...
public class gdp extends ggw {
    ...
    public String getDxFunctionName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("bc5916ec", new Object[]{this}) : a.ATOM_EXT_cos;
    }
    ...
    public gfx execute(DXRuntimeContext dXRuntimeContext, gfx gfxVar, int i, gfx[] gfxVarArr, Map map) throws DXExprFunctionError {
        ...
        try {
            return gfx.a(Math.cos(gfxVarArr[0].A()));
        } catch (Exception e) {
