...
public class omt implements omv {
    ...
    public void a(Map<String, Object> map, b<BaseMessage> bVar) {
        ...
        if (ipChange instanceof IpChange) {
        ...
        } else if (bVar.f20780a.msgType == 8) {
            map.put("api", "mtop.taobao.powermsg.bc.msg.subscribe");
        } else if (bVar.f20780a.msgType == 10) {
            map.put("api", "mtop.taobao.powermsg.bc.msg.unsubscribe");
            ...
            map.put("api", "mtop.taobao.powermsg.bc.msg.pullnativemsg");
