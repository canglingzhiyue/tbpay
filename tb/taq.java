...
public class taq extends as {
    ...
    private tba h = new tba();

    public static /* synthetic */ Object ipc$super(taq taqVar, String str, Object... objArr) {
        str.hashCode();
        throw new InstantReloadException(String.format("String switch could not find '%s'", str));
    }

    public static /* synthetic */ void a(taq taqVar, View view, String str) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            ipChange.ipc$dispatch("69755e8", new Object[]{taqVar, view, str});
        } else {
            taqVar.a(view, str);
        }
    }

    public static /* synthetic */ boolean a(taq taqVar, boolean z) {
        IpChange ipChange = $ipChange;
        if (ipChange instanceof IpChange) {
            return ((Boolean) ipChange.ipc$dispatch("239eca4", new Object[]{taqVar, new Boolean(z)})).booleanValue();
        }
        taqVar.g = z;
        return z;
    }
    ...
    static {
        kge.a(24076572);
        long a2 = fxa.a("TBDetailRichText");
        DX_EVENT_ID = a2;
        DETAIL_WIDGET_ID = a2;
    }
    ...
    public static class a implements ak {
        ...
        public DXWidgetNode build(Object obj) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? (DXWidgetNode) ipChange.ipc$dispatch("966917b0", new Object[]{this, obj}) : new taq();
        }
    }
    ...
    public View onCreateView(Context context) {
        ...
        if (richTextViewImpl instanceof TextView) {
            richTextViewImpl.setMovementMethod(tay.a());
        }
    ...
    public void onRenderView(Context context, final View view) {
        ...
        for (final as.b bVar : this.i) {
            if (!bVar.b && !bVar.c) {
                try {
                    bVar.b = true;
                    k.a().a(getDXRuntimeContext().m()).a(bVar.f).b(new i<l>() { // from class: tb.taq.2
                        public static volatile transient /* synthetic */ IpChange $ipChange;
                        ...
                        public boolean a(l lVar) {
                            ...
                            if (lVar != null && (a2 = lVar.a()) != null) {
                                ...
                                taq.this.e.setSpan(new c(a2, bVar.e), bVar.f12062a.f12063a, bVar.f12062a.b, bVar.f12062a.c);
                                View view2 = view;
                                if (view2 instanceof TextView) {
                                    ((TextView) view2).setText(taq.this.e);
                                }
                                bVar.c = true;
                            }
                            return false;
                        }
                    }).a(new i<g>() { // from class: tb.taq.1
                        public static volatile transient /* synthetic */ IpChange $ipChange;
    ...
    */
    public android.text.SpannableString a(com.alibaba.fastjson.JSONArray r16, int r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: tb.taq.a(com.alibaba.fastjson.JSONArray, int):android.text.SpannableString");
    }
    ...
    public class b extends ClickableSpan {
        ...
        public void onClick(View view) {
            ...
            try {
                if (StringUtils.isEmpty(this.f33995a)) {
                    return;
                }
                if (this.f33995a.contains("detailOpenFullFloat=true")) {
                    taq.a(taq.this, view, this.f33995a);
                } else {
                    com.taobao.android.detail.ttdetail.utils.l.a(y.a(view), this.f33995a);
                }
    ...
    private void a(View view, String str) {
        ...
        if (ipChange instanceof IpChange) {
            ...
            ar.a(y.a(view), view, "stdPop", m.API_H5, jSONObject, new alo() { // from class: tb.taq.3
                public static volatile transient /* synthetic */ IpChange $ipChange;
            ...
            com.taobao.android.detail.ttdetail.utils.m.b(2101, "Page_Detail_Button-WordExplain", null);
        }
    }
}
