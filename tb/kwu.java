...
public class kwu extends af {
    ...
    public static /* synthetic */ Object ipc$super(kwu kwuVar, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -740240234:
    ...
    private SpannableString a() {
        ...
        if ("alistyle".equals(this.f30359a)) {
            int i3 = this.c;
            i = (int) (i3 * 0.762f);
            i2 = (int) (i3 * 0.571f);
        } else {
        ...
        if ("normal".equals(this.f30359a)) {
            styleSpan = new StyleSpan(0);
        } else if ("bold".equals(this.f30359a)) {
            styleSpan = new StyleSpan(1);
        } else if ("italic".equals(this.f30359a)) {
            styleSpan = new StyleSpan(2);
        } else if ("bold_italic".equals(this.f30359a)) {
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        if (!(dXWidgetNode instanceof kwu)) {
            return;
        }
        kwu kwuVar = (kwu) dXWidgetNode;
        this.f30359a = kwuVar.f30359a;
        this.b = kwuVar.b;
        this.c = kwuVar.c;
    }
    ...
    public static class a implements ak {
        ...
        public DXWidgetNode build(Object obj) {
            IpChange ipChange = $ipChange;
            return ipChange instanceof IpChange ? (DXWidgetNode) ipChange.ipc$dispatch("966917b0", new Object[]{this, obj}) : new kwu();
        }
    }
