...
@AURAExtensionImpl(code = "industryDetail.impl.event.picGalleryExpand.onExpand")
/* loaded from: classes4.dex */
public final class etk implements ejz {
    ...
    public etk() {
        emu.a("com.taobao.android.detail.industry.adapter.event.FrameExpendEvent");
    }
    ...
    public void a(RecyclerView recyclerView, View view, int i, int i2) {
        ...
        if (tag instanceof bag) {
            ((bag) tag).a(DIConstants.WEXX_EVENT_MODULE, DIConstants.EVENT_NAME_LIFE_CYCLE, "onExpend");
            a.a("FrameExpendEvent", "onPicGalleryExpand weexInstance");
            return;
        }
        ...
        if (tag2 instanceof TRWidgetInstance) {
            ...
            a.a("FrameExpendEvent", "onPicGalleryExpand widgetInstance: " + c + "," + c2);
            return;
        }
        a.b("FrameExpendEvent", "no implement");
    }
}
