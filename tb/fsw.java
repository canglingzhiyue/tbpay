...
public class fsw extends fuf {
    ...
    public String getDxFunctionName() {
        ...
        return ipChange instanceof IpChange ? (String) ipChange.ipc$dispatch("bc5916ec", new Object[]{this}) : "platform";
    }
    ...
    public gfx execute(DXRuntimeContext dXRuntimeContext, gfx gfxVar, int i, gfx[] gfxVarArr, Map map) throws DXExprFunctionError {
        ...
        if (gfxVarArr == null || gfxVarArr.length != 1) {
            return gfx.e();
        }
        ...
        return gfx.a(gfxVar2.i().equalsIgnoreCase("android"));
    }
}
